...
const Ee = () => /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
), ge = (e) => e.replace(
...
function xe(e, t, n, i) {
  ...
  const f = o - l;
  return {
    x1: n + Math.cos(Math.PI * P / 180) * c,
    y1: i - Math.sin(Math.PI * P / 180) * c,
    x2: n + Math.cos(Math.PI * f / 180) * c,
    y2: i - Math.sin(Math.PI * f / 180) * c
  };
}
function fe(e, t, n) {
  let i, s;
...
function Ke(e, t) {
  ce(e), t.children ? t.children.push(e) : t.children = [e];
}
function Ue(e, t) {
  ce(e);
...
te.prototype.destory = function(e) {
...
const T = document, M = "http://www.w3.org/2000/svg", $e = function(e) {
  const t = T.createElementNS(M, "path");
  ...
  const t = T.createElementNS(M, "svg");
  ...
  const s = T.createElementNS(M, "line");
  ...
  const n = T.createElementNS(M, "g"), i = T.createElementNS(M, "path"), s = T.createElementNS(M, "path");
  ...
  const i = T.createElementNS(M, "svg"), s = T.createElementNS(M, "g"), r = T.createElementNS(M, "rect");
  ...
  const o = T.createElementNS(M, "rect");
  return o.setAttribute("width", "6"), o.setAttribute("height", "6"), o.setAttribute("stroke", "#2ebdff"), o.setAttribute("stroke-width", "2"), o.setAttribute("fill", "white"), o.setAttribute("x", (e - 3).toString()), o.setAttribute("y", (t - 3).toString()), o.setAttribute("class", "resize"), s.appendChild(o), i.appendChild(s), i.style.width = n.clientWidth + 5 + "px", i.style.height = n.clientHeight + 5 + "px", o.onpointerdown = function(c) {
    const l = Number(r.getAttribute("width")), P = Number(r.getAttribute("height"));
    let f = c.clientX, w = c.clientY;
    a(c.pageX, c.pageY);
    function a(b, y) {
      const H = l + b - f, D = P + y - w;
      r.setAttribute("width", H.toString()), r.setAttribute("height", D.toString()), o.setAttribute("x", (H - 3).toString()), o.setAttribute("y", (D - 3).toString()), i.style.width = H + 5 + "px", i.style.height = D + 5 + "px", n.style.width = H + "px", n.style.height = D + "px";
    }
    function v(b) {
      a(b.pageX, b.pageY);
    }
    o.onpointermove = v, o.onpointerup = function(b) {
      o.onpointermove = null, o.onpointerup = null, o.releasePointerCapture(b.pointerId);
    }, c.stopPropagation(), c.preventDefault(), o.setPointerCapture(c.pointerId);
  }, o.ondragstart = function() {
    return !1;
  }, i;
}, L = document, O = (e, t) => (t ? t.mindElixirBox : L).querySelector(`[data-nodeid=me${e}]`);
function be(e, t, n) {
  e.onpointerdown = (i) => {
...
const J = function(e, t) {
  ...
  if (t.icons) {
    ...
    r.className = "icons", typeof t.icons == "string" && (r.innerHTML = t.icons), e.appendChild(r);
  }
  ...
  }), t.image && t.image.forEach((o) => {
    const c = L.createElement("img");
    c.className = "image", c.src = o.url, c.style.width = o.width + "px", c.style.height = o.height + "px", c.style.display = "block", e.appendChild(c);
  }), t.tags) {
    const r = L.createElement("div");
    r.className = "tags", r.innerHTML = t.tags.filter((o) => o !== "").map((o) => `<span>${ae(o)}</span>`).join(""), e.appendChild(r);
  }
};
function Xe(e) {
...
const it = function(e, t) {
  ...
  if (n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(Q(e.expanded)), e.expanded !== !1)) {
  ...
  return n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(Q(e.expanded)), e.expanded !== !1 && this.createChildren(e.children)), { smy: n, top: i };
}, rt = function(e) {
  const t = L.createElement("t"), n = this.createTopic(e);
  return J.call(this, n, e), t.appendChild(n), t;
}, ot = function(e) {
...
function lt(e) {
  ...
  e.appendChild(t), t.id = "input-box", t.contentEditable = "true", t.spellcheck = !1, t.textContent = n, t.draggable = !1, e.nodeObj.image && e.nodeObj.image.forEach((w) => {
    const a = L.createElement("img");
    a.src = w.url, a.style.width = w.width + "px", a.style.display = "block", t.appendChild(a);
    const v = nt(a.clientWidth, a.clientHeight, a);
    t.insertBefore(v, a);
  }), t.style.cssText = `min-width:${e.offsetWidth - 22}px;min-height:${e.clientHeight - 16}px`, (s = (i = e.nodeObj) == null ? void 0 : i.style) != null && s.width && (t.style.width = "auto"), (((o = (r = e.nodeObj) == null ? void 0 : r.style) == null ? void 0 : o.color) === "#ffffff" || ((c = e.nodeObj) == null ? void 0 : c.id) === "root" && !((P = (l = e.nodeObj) == null ? void 0 : l.style) != null && P.color)) && (t.style.color = "#2c3e50"), this.direction === 0 && (t.style.right = "0"), t.focus(), ct(t), this.inputDiv = t, this.bus.fire("operation", {
    name: "beginEdit",
    obj: e.nodeObj
    ...
    if (w === "Enter" || w === "Tab") {
      if (f.shiftKey)
        return;
      f.preventDefault(), this.inputDiv.blur(), this.map.focus();
    }
  }), t.addEventListener("blur", () => {
    var y, H;
    if (!t)
      return;
    const f = e.nodeObj, w = t.textContent.trim(), a = (H = (y = f.image) == null ? void 0 : y.length) != null ? H : 0;
    if (f.image = [], t.childNodes.forEach((D) => {
      D.nodeName === "IMG" && f.image.push({
        url: D.src,
        width: D.width,
        height: D.height
      });
    }), w === "" && f.image.length === 0 ? f.topic = n : f.topic = w, t.remove(), this.inputDiv = t = null, w === n && a === f.image.length && a === 0)
      return;
    f.image.length === 0 && delete f.image, e.childNodes[0].textContent = f.topic;
    const v = e.querySelector("widthControllRight"), b = e.querySelector("widthControllRight");
    f.style || (f.style = {}), f.style.controllWidth = v.style.height = b.style.height = e.clientHeight.toString() + "px", delete f.style.width, this.shapeTpc(e, f), this.linkDiv(), Oe.call(this, this.nodeData, f.id, f.topic), this.bus.fire("operation", {
      name: "finishEdit",
      obj: f,
      origin: n
    });
...
function dt(e, t, n) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if ((o == null ? void 0 : o.type) === "summary") {
      const { smy: P } = this.createSummary(o);
      if (o.children && o.children.length > 0 && o.expanded !== !1) {
        const [f, w] = this.createChildren(o.children);
        P.appendChild(f), w && w.forEach((a) => {
          P.appendChild(a);
        });
      }
      s.push(P);
    ...
    const c = L.createElement("GRP");
    n === 0 ? c.className = "lhs" : n === 1 ? c.className = "rhs" : n === 2 && (o.direction === 0 ? c.className = "lhs" : o.direction === 1 && (c.className = "rhs"));
    const l = this.createTop(o);
    if (o.children && o.children.length > 0) {
      if (l.appendChild(Q(o.expanded)), c.appendChild(l), o.expanded !== !1) {
        const [P, f] = this.createChildren(o.children);
        c.appendChild(P), f && f.forEach((w) => {
          var a;
          (a = c.children) != null && a[2] || c.appendChild(L.createElement("smychildren")), c.children[2].appendChild(w);
        });
      }
    } else
      c.appendChild(l);
...
function at() {
  ...
  J.call(this, e, this.nodeData), e.draggable = !1, this.root.appendChild(e);
  const t = this.nodeData.children;
  if (!(!t || t.length === 0)) {
    if (this.direction === 2) {
      let n = 0, i = 0;
      t.map((s) => {
        s.direction === void 0 ? n <= i ? (s.direction = 0, n += 1) : (s.direction = 1, i += 1) : s.direction === 0 ? n += 1 : i += 1;
      });
    }
    this.createChildren(this.nodeData.children, this.box, this.direction), console.timeEnd("layout");
  }
}
let ne = document, j = 1e4, E = 1e4, B = 1e4, q = 1e4, k = 40, ft = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
function Ne() {
  j = 1e4, E = 1e4, B = 1e4, q = 1e4, k = 40;
}
function je() {
  Ne();
  let e = ne.querySelectorAll(".mindbox > grp, root"), t = "";
  for (let r = 0; r < e.length; r++) {
    let o = e[r], c = o.getBoundingClientRect(), l = o.offsetTop, P = l + c.height, f = o.offsetLeft, w = f + c.width;
    l < j && (j = l), P > E && (E = P), f < B && (B = f), w > q && (q = w), t += Be(o);
  }
  console.log(j, E, B, q), t += Pt();
  let n = E - j + k * 2, i = q - B + k * 2, s = vt(n, i);
...
function ut() {
  ...
  for (let s = 0; s < e.length; s++) {
    let r = e[s], o = r.getBoundingClientRect(), c = r.offsetTop, l = c + o.height, P = r.offsetLeft, f = P + o.width;
    c < j && (j = c), l > E && (E = l), P < B && (B = P), f > q && (q = f), t += Be(r);
  }
  console.log(j, E, B, q);
  let n = E - j, i = q - B;
...
function Pt() {
  let e = document.querySelector("root"), t = document.querySelector("root > tpc"), n = t.getBoundingClientRect(), i = getComputedStyle(t), s = t.parentNode, r = 0, o = 0, c = document.querySelector("root > tpc").nodeObj, l = getComputedStyle(s), P = e.offsetTop - j, f = e.offsetLeft - B, w = o + parseInt(l.paddingLeft) + parseInt(n.paddingLeft), a = r + parseInt(l.paddingTop) + parseInt(n.paddingTop) + parseInt(n.fontSize);
  r + parseInt(l.paddingTop) + parseInt(n.paddingTop);
  let v = document.querySelector(".svg2nd"), b = "";
  if (c.tags && c.tags.length) {
    let h = t.querySelectorAll(".tags > span");
    for (let p = 0; p < h.length; p++) {
      let z = h[p], m = z.getBoundingClientRect();
      b += `<rect x="${w}" y="${a + 4}" rx="5px" ry="5px" width="${m.width}" height="${m.height}" style="fill: #d6f0f8;"></rect>
        <foreignObject x="${w}" y="${a + 4}" rx="5px" ry="5px" width="${m.width}" height="${m.height}" > 
          <div sytle="font-size:12px">${z.innerHTML}</div>
        </foreignObject>
      `;
    }
  }
  ...
  if (c.icons && c.icons.length) {
    let h = t.querySelectorAll(".icons > span");
    for (let p = 0; p < h.length; p++) {
      let z = h[p];
      z.getBoundingClientRect(), y += `
      <tspan>${z.innerHTML}</tspan>`;
    }
  }
  let H = "";
  if (c.image && c.image.length) {
    let h = tpc.querySelectorAll(".image");
    for (let p = 0; p < h.length; p++) {
      let z = h[p];
      z.getBoundingClientRect(), H += `${z.outerHTML}`;
    }
  }
  let D = `<g transform="translate(${k - B}, ${k - j})">${v.innerHTML}</g>`;
  D += `<g id="root" transform="translate(${f + k}, ${P + k})">
  ...
  let A = ne.querySelector(".topiclinks");
  return A && (D += `<g transform="translate(${k - B}, ${k - j})">${A.innerHTML}</g>`), D;
}
function Be(e) {
  let t = e.querySelectorAll("tpc"), n = e.offsetTop - j, i = e.offsetLeft - B, s = "", r = e.querySelector(".svg3rd");
  s += `<g transform="translate(${i + k}, ${n + k})">`, s += r ? r.innerHTML : "";
  for (let o = 0; o < t.length; o++) {
    let c = t[o], l = c.parentNode, P = c.nodeObj;
    if (P.root)
      continue;
    let f = c.getBoundingClientRect(), w = l.offsetTop, a = l.offsetLeft, v = getComputedStyle(c), b = getComputedStyle(l), y = a + parseInt(b.paddingLeft) + parseInt(v.paddingLeft), H = w + parseInt(b.paddingTop) + parseInt(v.paddingTop) + parseInt(v.fontSize), D = w + parseInt(b.paddingTop) + parseInt(v.paddingTop), A = "";
    v.borderWidth != "0px" && (A = `<rect x="${a + 15}" y="${w}" rx="5px" ry="5px" width="${f.width}" height="${f.height}" style="fill: rgba(0,0,0,0); stroke:#444;stroke-width:1px;"></rect>`);
    let h = "";
    v.backgroundColor != "rgba(0, 0, 0, 0)" && (h = `<rect x="${a + 15}" y="${w}" rx="5px" ry="5px" width="${f.width}" height="${f.height}" style="fill: ${v.backgroundColor};"></rect>`);
    let p = "";
    if (P.tags && P.tags.length) {
      let u = c.querySelectorAll(".tags > span");
      for (let g = 0; g < u.length; g++) {
        let d = u[g], x = d.getBoundingClientRect();
        p += `<rect x="${y}" y="${H + 4}" rx="5px" ry="5px" width="${x.width}" height="${x.height}" style="fill: #d6f0f8;"></rect>
          <foreignObject x="${y}" y="${H + 4}" rx="5px" ry="5px" width="${x.width}" height="${x.height}" > 
    ...
    if (P.icons && P.icons.length) {
      let u = c.querySelectorAll(".icons > span");
      for (let g = 0; g < u.length; g++) {
        let d = u[g];
        d.getBoundingClientRect(), z += `
        <tspan>${d.innerHTML}</tspan>`;
      }
    }
    let m = "";
    if (P.image && P.image.length) {
      let u = c.querySelectorAll(".image");
      for (let g = 0; g < u.length; g++) {
        let d = u[g];
        d.getBoundingClientRect(), m += `${d.outerHTML}`;
      }
    }
    s += `<g id="${P.id}">
      ${A}
      ${h}
      <foreignObject  x="${y}" y="${D}" width="${v.width}" height="${v.height}">
...
let ht = function() {
  let e = je(), t = URL.createObjectURL(
    new Blob([ft + e.outerHTML.replace(/&nbsp;/g, " ")])
  ), n = document.createElement("a");
  n.href = t, n.download = "me-mindmap.svg", n.click();
}, pt = function(e = this, t = "default") {
  return ne = e.container, je();
};
function le(e) {
...
const yt = function() {
  ...
  return he(t.nodeData, 0, e), JSON.parse(
...
const Mt = function() {
  ...
  ((e = this.nodeData) == null ? void 0 : e.children.length) > 0 ? this.container.scrollTo(
    1e4 - Nt(this.container) / 2 - 10,
    1e4 - jt(this.container) / 2 - Tt(this.container) - 5
  ) : this.container.scrollTo(
    1e4 - this.container.offsetWidth / 2,
    1e4 - this.container.offsetHeight / 2
  );
  ...
  const n = e.nodeObj;
  typeof t == "boolean" ? n.expanded = t : n.expanded !== !1 ? n.expanded = !1 : (n.expanded = !0, pe(n)), this.layout(), this.linkDiv(), this.bus.fire("expandNode", n);
}, St = function() {
...
const U = document, Wt = function(e) {
  if (!e.style)
    return;
  const t = O(e.id, this), n = {
    color: t.style.color && ge(t.style.color),
    background: t.style.background && ge(t.style.background),
  ...
  const i = O(e.id);
  J.call(this, i, e), this.linkDiv(), this.bus.fire("operation", {
    name: "editTags",
    obj: e,
    origin: n
  });
  ...
  e.linkJump = (r = e.linkJump) == null ? void 0 : r.filter((l) => !!i.find((P) => P === l.title)), ((o = e.linkJump) == null ? void 0 : o.length) === 0 && delete e.linkJump, e.hyperLink = i.filter((l) => {
    var P;
    return l !== "" && !((P = e.linkJump) != null && P.find((f) => f.title === l));
  }), ((c = e.hyperLink) == null ? void 0 : c.length) === 0 && delete e.hyperLink;
  const s = O(e.id);
  J.call(this, s, e), this.linkDiv(), this.bus.fire("operation", {
    name: "editHyperLink",
    obj: e,
    origin: n
  });
  ...
  const P = U.createElement("children");
  P.appendChild(r), c.insertAdjacentElement("afterend", P), l.className === "mindbox" ? (o.className = r.className, r.className = "", r.querySelector(".svg3rd").remove(), this.linkDiv()) : this.linkDiv(o.offsetParent), t || this.createInputDiv(c.children[0]), this.selectNode(c.children[0], !0), console.timeEnd("insertParent_DOM"), this.bus.fire("operation", {
    name: "insertParent",
    obj: s
  });
}, $t = function(e, t) {
  ...
  if (!e)
    return;
  const n = e.nodeObj;
  n.expanded === !1 && (this.expandNode(e, !0), e = O(n.id));
  const i = t || this.generateNewObj();
  n.children ? n.children.push(i) : n.children = [i], C(this.nodeData);
  const s = e.parentElement, { grp: r, top: o } = this.createGroup(i);
  if (s.tagName === "T") {
    if (s.children[1])
      s.nextSibling.appendChild(r);
    else {
      const c = U.createElement("children");
      c.appendChild(r), s.appendChild(Q(!0)), s.insertAdjacentElement("afterend", c);
    }
  ...
  this.container.querySelectorAll("tpc.selected").forEach((s) => {
    ...
    if (this.currentSummaryNodeArr = s, !r || ((f = (P = (l = r == null ? void 0 : r.parentElement) == null ? void 0 : l.parentElement) == null ? void 0 : P.parentElement) == null ? void 0 : f.className) == "mindbox")
      return;
    const { newTop: o, newNodeObj: c } = $t.call(this, r, t);
  ...
  if (!n)
    return;
  const { newTop: i, newNodeObj: s } = Te.call(this, n, t);
  ...
  ye(n);
  const { newNodeObj: i } = Te.call(this, t, n);
  ...
  const i = n.parent.children.findIndex((l) => l === n), s = n.parent.children[i + 1], r = s && s.id, o = ce(n), c = t.parentNode;
  if (c.tagName !== "ROOT") {
    if (o === 0) {
    ...
    for (const l in this.linkData) {
      const P = this.linkData[l];
      (P.from === c.firstChild || P.to === c.firstChild) && this.removeLink(
  ...
  if (i.expanded === !1 && (this.expandNode(t, !0), e = O(n.id), t = O(i.id)), !Se(n, i)) {
    console.warn("Invalid move");
    return;
  }
  console.time("moveNode"), Ke(n, i), C(this.nodeData);
  ...
  if (o.className === "mindbox" ? r.parentNode.lastChild.remove() : r.parentNode.className === "mindbox" && (r.style.cssText = ""), c.tagName === "T")
    if (o.className === "mindbox" && (r.parentNode.className = ""), c.children[1])
      ...
      const l = U.createElement("children");
      l.appendChild(r.parentNode), c.appendChild(Q(!0)), c.parentElement.insertBefore(l, c.nextSibling);
    }
  else
...
function fn(e, t) {
  if (this.direction === 0)
    ...
    const n = U.querySelectorAll(".lhs").length, i = U.querySelectorAll(".rhs").length;
...
const un = function(e, t, n, i) {
  ...
  if (!e || !t)
    return;
  const r = e.getBoundingClientRect(), o = t.getBoundingClientRect(), c = (r.x + r.width / 2 - s.x) / this.scaleVal, l = (r.y + r.height / 2 - s.y) / this.scaleVal, P = (o.x + o.width / 2 - s.x) / this.scaleVal, f = (o.y + o.height / 2 - s.y) / this.scaleVal;
  let w, a, v, b;
  n ? (w = c + i.delta1.x, a = l + i.delta1.y, v = P + i.delta2.x, b = f + i.delta2.y) : (l + f) / 2 - l <= r.height / 2 ? (w = (r.x + r.width - s.x) / this.scaleVal + 100, a = l, v = (o.x + o.width - s.x) / this.scaleVal + 100, b = f) : (w = (c + P) / 2, a = (l + f) / 2, v = (c + P) / 2, b = (l + f) / 2);
  const y = {
    cx: c,
    cy: l,
    w: r.width,
    ...
    w: o.width,
    h: o.height
  }, D = fe(y, w, a), A = D.x, h = D.y, p = ue(H, v, b), z = p.x, m = p.y, u = xe(v, b, z, m), g = tt(
    `M ${A} ${h} C ${w} ${a} ${v} ${b} ${z} ${m}`,
    `M ${u.x1} ${u.y1} L ${z} ${m} L ${u.x2} ${u.y2}`
  );
  let d;
  n ? (d = {
    id: i.id,
  ...
  }, this.linkData[i.id] = d, g.linkObj = d, g.dataset.linkid = i.id) : (d = {
    id: ie(),
    label: "",
    from: e,
    to: t,
  ...
  }, this.linkData[d.id] = d, g.linkObj = d, g.dataset.linkid = d.id, this.currentLink = g), this.linkSvgGroup.appendChild(g), n || this.showLinkController(w, a, v, b, d, y, H);
}, vn = function(e) {
  let t;
  ...
  this.currentLink = e;
  const t = e.linkObj, n = t.from, i = t.to, s = this.map.getBoundingClientRect(), r = n.getBoundingClientRect(), o = i.getBoundingClientRect(), c = (r.x + r.width / 2 - s.x) / this.scaleVal, l = (r.y + r.height / 2 - s.y) / this.scaleVal, P = (o.x + o.width / 2 - s.x) / this.scaleVal, f = (o.y + o.height / 2 - s.y) / this.scaleVal, w = {
    cx: c,
    cy: l,
    w: r.width,
    h: r.height
    ...
    w: o.width,
    h: o.height
  }, v = c + t.delta1.x, b = l + t.delta1.y, y = P + t.delta2.x, H = f + t.delta2.y;
  this.showLinkController(v, b, y, H, t, w, a);
}, hn = function() {
  this.linkController.style.display = "none", this.P2.style.display = "none", this.P3.style.display = "none";
}, pn = function(e, t, n, i, s, r, o) {
  this.linkController.style.display = "initial", this.P2.style.display = "initial", this.P3.style.display = "initial";
  const c = fe(r, e, t);
  let l = c.x, P = c.y;
  const f = ue(o, n, i);
  let w = f.x, a = f.y;
  this.P2.style.cssText = `top:${t}px;left:${e}px;`, this.P3.style.cssText = `top:${i}px;left:${n}px;`, this.line1.setAttribute("x1", l), this.line1.setAttribute("y1", P), this.line1.setAttribute("x2", e), this.line1.setAttribute("y2", t), this.line2.setAttribute("x1", n), this.line2.setAttribute("y1", i), this.line2.setAttribute("x2", w), this.line2.setAttribute("y2", a), this.helper1 && (this.helper1.destory(this.map), this.helper2.destory(this.map)), this.helper1 = new te(this.P2), this.helper2 = new te(this.P3), this.helper1.init(this.map, (v, b) => {
    e = e - v / this.scaleVal, t = t - b / this.scaleVal;
    const y = fe(r, e, t);
    l = y.x, P = y.y, this.P2.style.top = t + "px", this.P2.style.left = e + "px", this.currentLink.children[0].setAttribute(
      "d",
      `M ${l} ${P} C ${e} ${t} ${n} ${i} ${w} ${a}`
    ), this.line1.setAttribute("x1", l), this.line1.setAttribute("y1", P), this.line1.setAttribute("x2", e), this.line1.setAttribute("y2", t), s.delta1.x = e - r.cx, s.delta1.y = t - r.cy;
  }), this.helper2.init(this.map, (v, b) => {
    n = n - v / this.scaleVal, i = i - b / this.scaleVal;
    const y = ue(o, n, i);
    w = y.x, a = y.y;
    const H = xe(n, i, w, a);
    this.P3.style.top = i + "px", this.P3.style.left = n + "px", this.currentLink.children[0].setAttribute(
      ...
      "d",
      `M ${H.x1} ${H.y1} L ${w} ${a} L ${H.x2} ${H.y2}`
    ), this.line2.setAttribute("x1", n), this.line2.setAttribute("y1", i), this.line2.setAttribute("x2", w), this.line2.setAttribute("y2", a), s.delta2.x = n - o.cx, s.delta2.y = i - o.cy;
  });
};
function wn(e) {
  var H, D;
  ...
  let r = 0, o, c = 0, l = 0, P = 0, f = 0, w = 0, a;
  if (this.direction === 2) {
    let A = 0, h = 0, p = 0, z = 0;
    for (let m = 0; m < s.length; m++) {
      const u = s[m];
      u.className === "lhs" ? (f += u.offsetHeight + n, p += u.offsetHeight, A += 1) : (w += u.offsetHeight + n, z += u.offsetHeight, h += 1);
    }
    f > w ? (a = 1e4 - Math.max(f) / 2, o = "r", c = (f - z) / (h - 1)) : (a = 1e4 - Math.max(w) / 2, o = "l", c = (w - p) / (A - 1));
  } else {
    for (let A = 0; A < s.length; A++)
      r += s[A].offsetHeight + n;
    a = 1e4 - r / 2;
  }
  let v = "";
  const b = 1e4 - i.offsetWidth / 2 - t + 60, y = 1e4 + i.offsetWidth / 2 + t - 60;
  for (let A = 0; A < s.length; A++) {
    let h, p;
    const z = s[A], m = z.offsetHeight;
    let u = i.offsetLeft - 10;
    if (z.className === "lhs") {
      z.style.top = a + l + "px", z.style.left = b - z.offsetWidth + "px", h = b - 15, p = a + l + m / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 - i.offsetWidth / 6), p < 1e4 ? v += `M ${d} 10000 V ${p + 20} C ${d} ${p} ${d} ${p} ${d - 20} ${p} H ${h}` : v += `M ${d} 10000 V ${p - 20} C ${d} ${p} ${d} ${p} ${d - 20} ${p} H ${h}`) : v += `M 10000 10000 H ${u} V ${p} H ${h}`, o === "l" ? l += m + c : l += m + n;
    } else {
      u = i.offsetLeft + i.offsetWidth + 10, z.style.top = a + P + "px", z.style.left = y + "px", h = y + 15, p = a + P + m / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 + i.offsetWidth / 6), p < 1e4 ? v += `M ${d} 10000 V ${p + 20} C ${d} ${p} ${d} ${p} ${d + 20} ${p} H ${h}` : v += `M ${d} 10000 V ${p - 20} C ${d} ${p} ${d} ${p} ${d + 20} ${p} H ${h}`) : v += `M 10000 10000 H ${u} V ${p} H ${h}`, o === "r" ? P += m + c : P += m + n;
    }
    const g = z.children[0].children[1];
    g && (g.style.top = (g.parentNode.offsetHeight - g.offsetHeight) / 2 + "px", z.className === "lhs" ? g.style.left = -10 + "px" : g.style.left = g.parentNode.offsetWidth - 10 + "px");
  }
  this.svg2nd.appendChild($e(v));
  for (let A = 0; A < s.length; A++) {
    const h = s[A];
    if (!(e && e !== s[A]) && h.childElementCount) {
      const p = ee("svg3rd"), z = ee("svg3rd");
      h.querySelectorAll(".svg3rd").forEach((g) => {
        g.remove();
      }), h.appendChild(p);
      const m = h.children[0];
      let u;
      ((D = (H = h.children) == null ? void 0 : H[2]) == null ? void 0 : D.tagName) === "SMYCHILDREN" ? u = [...h.children[1].children, ...h.children[2].children] : u = h.children[1].children, R = "", oe = "", Me(u, m, this.nodeData.children[A], !0), p.appendChild(et(R)), oe.length > 0 && (h.appendChild(z), z.appendChild(_e(oe)));
    }
  }
  this.linkSvgGroup.innerHTML = "";
  for (const A in this.linkData) {
    const h = this.linkData[A];
    typeof h.from == "string" ? this.createLink(O(h.from), O(h.to), !0, h) : this.createLink(
      O(h.from.nodeObj.id),
      O(h.to.nodeObj.id),
      !0,
      h
...
function Me(e, t, n, i) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    if ((v == null ? void 0 : v.tagName) === "SMY") {
      let d = e[0], x = e[a - 1];
      const W = {};
      n.children[a].summary.range.forEach((Y) => {
        W[Y] = !0;
      });
      let $ = !0;
      for (let Y = 0; Y < a; Y++) {
        const Ve = e[Y].children[0].children[0].getAttribute("data-nodeid").slice(2);
        W[Ve] && ($ && ($ = !1, d = e[Y]), x = e[Y]);
      }
      const _ = d.offsetLeft + d.offsetWidth + 8, Z = d.offsetTop + 15, se = x.offsetTop + x.offsetHeight - 5, Ce = x.offsetLeft + x.offsetWidth + 8, Ze = v.offsetTop + v.children[0].offsetTop + v.children[0].offsetHeight;
      let re = (P = v.style.top) != null ? P : 0;
      typeof re == "string" && (re = Number(re.replace("px", ""))), v.style.top = re + (se + Z + 20) / 2 - Ze + "px", oe += `M ${_} ${Z} H ${_ + 10} V ${se} H${Ce}`;
    }
    const b = v.children[0];
    let y = b.offsetTop, H = b.offsetHeight;
    l && (y += b.offsetParent.offsetTop);
    let D;
    i || l ? D = s + c / 2 : D = s + c;
    const A = y + H;
    let h, p, z;
    const m = v.offsetParent.className || v.offsetParent.offsetParent.className;
    m === "lhs" && (v == null ? void 0 : v.tagName) !== "SMY" ? (h = r + 15, z = r, p = r - b.offsetWidth, y + H < s + c / 2 + 50 && y + H > s + c / 2 - 50 ? R += `M ${h} ${D} H ${z} V ${A} H ${p}` : y + H >= s + c / 2 ? R += `M ${h} ${D} H ${z} V ${A} H ${p}` : R += `M ${h} ${D} H ${z} V ${A} H ${p}`) : m === "rhs" && (v == null ? void 0 : v.tagName) !== "SMY" && (h = r + o - 15, l && (h += 15), z = r + o, p = r + o + b.offsetWidth, y + H < s + c / 2 + 50 && y + H > s + c / 2 - 50 ? R += `M ${h} ${D} H ${z} V ${A} H ${p}` : y + H >= s + c / 2 ? R += `M ${h} ${D} H ${z} V ${A} H ${p}` : R += `M ${h} ${D} H ${z} V ${A} H ${p}`);
    const u = b.children[1];
    if (u) {
      if (u.style.top = (b.offsetHeight - u.offsetHeight) / 2 + "px", m === "lhs" ? u.style.left = -10 + "px" : m === "rhs" && (u.style.left = b.offsetWidth - 10 + "px"), !u.expanded)
        continue;
    } else
      continue;
    let g;
    ((w = (f = v.children) == null ? void 0 : f[2]) == null ? void 0 : w.tagName) === "SMYCHILDREN" ? g = [...v.children[1].children, ...v.children[2].children] : g = [...v.children[1].children], g.length > 0 && Me(g, b, n.children[a]);
  }
}
function gn(e) {
  e.map.addEventListener("click", (t) => {
    ...
    if (!e.nodeDraggable && t && t.target.className === "selected") {
      G.clear(), t.target.draggable = !1;
      return;
    }
    t.target.contentEditable !== "true" && G.onMove(t, e.container);
  }), e.map.addEventListener("mousedown", (t) => {
    t.target.contentEditable !== "true" && (G.afterMoving = !1, G.mousedown = !0);
...
function Hn(e, t) {
  const n = (h) => {
    ...
    return p.innerText = h, p.style.cssText = "position:absolute;bottom:20px;left:50%;transform:translateX(-50%);", p;
  }, i = (h, p, z) => {
    const m = document.createElement("li");
    return m.id = h, m.innerHTML = `<span>${ae(p)}</span><span>${ae(z)}</span>`, m;
  }, s = X[e.locale] ? e.locale : "en", r = i("cm-add_child", X[s].addChild, "tab"), o = i("cm-add_parent", X[s].addParent, ""), c = i("cm-add_sibling", X[s].addSibling, "enter"), l = i(
    "cm-remove_child",
    X[s].removeNode,
    "delete"
  ), P = i("cm-fucus", X[s].focus, ""), f = i("cm-unfucus", X[s].cancelFocus, ""), w = i("cm-up", X[s].moveUp, "PgUp"), a = i("cm-down", X[s].moveDown, "Pgdn"), v = i("cm-link", X[s].link, ""), b = i("cm-nodelink", X[s].nodeLink, ""), y = i("cm-summary", X[s].summary, ""), H = document.createElement("ul");
  if (H.className = "menu-list", H.appendChild(r), H.appendChild(o), H.appendChild(c), H.appendChild(l), (!t || t.focus) && (H.appendChild(P), H.appendChild(f)), H.appendChild(w), H.appendChild(a), (!t || t.link) && (H.appendChild(v), H.appendChild(b)), H.appendChild(y), t && t.extend)
    for (let h = 0; h < t.extend.length; h++) {
      const p = t.extend[h], z = i(p.name, p.name, p.key || "");
      H.appendChild(z), z.onclick = (m) => {
        p.onclick(m);
      };
    }
  const D = document.createElement("cmenu");
  D.appendChild(H), D.hidden = !0, e.container.append(D);
  let A = !0;
  e.container.oncontextmenu = function(h) {
    if (h.preventDefault(), !e.editable)
      return;
    const p = h.target;
    if (p.tagName === "TPC") {
      p.parentElement.tagName === "ROOT" ? A = !0 : A = !1, A ? (P.className = "disabled", w.className = "disabled", a.className = "disabled", c.className = "disabled", l.className = "disabled") : (P.className = "", w.className = "", a.className = "", c.className = "", l.className = ""), e.selectNode(p), D.hidden = !1;
      const z = H.offsetHeight, m = H.offsetWidth;
      z + h.clientY > window.innerHeight ? (H.style.top = "", H.style.bottom = "0px") : (H.style.bottom = "", H.style.top = h.clientY + 15 + "px"), m + h.clientX > window.innerWidth ? (H.style.left = "", H.style.right = "0px") : (H.style.right = "", H.style.left = h.clientX + 10 + "px");
    }
  }, D.onclick = (h) => {
    h.target === D && (D.hidden = !0);
  }, r.onclick = (h) => {
    e.addChild(), D.hidden = !0;
  }, y.onclick = (h) => {
    e.addSummary(), D.hidden = !0;
  }, o.onclick = (h) => {
    e.insertParent(), D.hidden = !0;
  }, c.onclick = (h) => {
    A || (e.insertSibling(), D.hidden = !0);
  }, l.onclick = (h) => {
    A || (e.removeNode(), D.hidden = !0);
  }, P.onclick = (h) => {
    A || (e.focusNode(e.currentNode), D.hidden = !0);
  }, f.onclick = (h) => {
    e.cancelFocus(), D.hidden = !0;
  }, w.onclick = (h) => {
    A || (e.moveUpNode(), D.hidden = !0);
  }, a.onclick = (h) => {
    A || (e.moveDownNode(), D.hidden = !0);
  }, v.onclick = (h) => {
    D.hidden = !0;
    const p = e.currentNode, z = n(X[s].clickTips);
    e.container.appendChild(z), e.map.addEventListener(
      "click",
      (m) => {
        if (m.preventDefault(), z.remove(), m.target.parentElement.nodeName === "T" || m.target.parentElement.nodeName === "ROOT") {
          const u = e.currentNode;
          e.createLink(p, u);
        } else
          console.log("\u53D6\u6D88\u8FDE\u63A5");
      },
      ...
      (m) => {
        if (m.preventDefault(), z.remove(), m.target.parentElement.nodeName === "T" || m.target.parentElement.nodeName === "ROOT") {
          ...
          p.nodeObj.linkJump || (p.nodeObj.linkJump = []), p.nodeObj.linkJump.push(
            {
              toId: u.nodeObj.id,
              title: u.nodeObj.topic
            }
          ), e.shapeTpc(p, p.nodeObj), e.linkDiv();
        } else
          console.log("\u53D6\u6D88\u8FDE\u63A5");
      },
      {
...
function Dn(e, t) {
  return function() {
    const n = arguments;
    de && clearTimeout(de), de = setTimeout(function() {
      e.apply(this, n);
    }, t);
  };
}
function mn(e) {
  var f;
  const t = document.createElement("toolbar"), n = F("fullscreen", "full"), i = F("toCenter", "living"), s = F("zoomout", "move"), r = F("zoomin", "add"), o = document.createElement("input");
  o.className = "numberSelection", o.type = "number", o.min = "2", o.max = "100", o.step = "1", o.value = ((f = e == null ? void 0 : e.expandDeep) == null ? void 0 : f.toString()) || "2", o.oninput = Dn(() => {
    const w = e.getAllDataWithAutoHide();
    pe(w == null ? void 0 : w.nodeData), e.layout(), e.linkDiv();
  }, 300);
  ...
  const l = e.scrollContainer, P = window.innerWidth - (l == null ? void 0 : l.getBoundingClientRect().right) + parseInt(l && getComputedStyle(l).paddingRight);
  return l == null || l.addEventListener("scroll", (w) => {
    const v = l.scrollTop + l.clientHeight, b = e.mindElixirBox.offsetTop, y = e.mindElixirBox.offsetTop + e.mindElixirBox.clientHeight, H = e.mindElixirBox.clientHeight;
    v < b + t.clientHeight + 40 ? (t.style.position = "absolute", t.style.bottom = H - 20 - t.clientHeight + "px") : v <= y ? (t.style.position = "fixed", t.style.bottom = "20px", t.style.right = P + 20 + "px") : v > y && (t.style.position = "absolute", t.style.bottom = "20px");
  }), t;
}
function An(e) {
  const t = document.createElement("toolbar"), n = F("sidebar", "menu"), i = F("tbltl", "left"), s = F("tbltr", "right"), r = F("tblts", "side");
  ...
  const o = e.scrollContainer, c = (o == null ? void 0 : o.getBoundingClientRect().left) + parseInt(o && getComputedStyle(o).paddingLeft);
  return o == null || o.addEventListener(
    "scroll",
    (l) => {
      const P = o.scrollTop, f = e.mindElixirBox.offsetTop, w = e.mindElixirBox.clientHeight, a = f + w - t.clientHeight - 40;
      P > a ? (t.style.position = "absolute", t.style.top = a - f + 20 + "px") : P >= f ? (t.style.position = "fixed", t.style.top = "20px", t.style.left = c + 20 + "px") : P < f && (t.style.position = "absolute", t.style.top = "20px");
    }
  ), t;
}
function yn(e) {
...
function di(e) {
  const t = X[e.locale] ? e.locale : "en";
  let n;
  ...
  <use xlink:href="#icon-B"></use>
      ...
      <div class="nm-fontcolor-container">
        ${li.map((u) => {
    let g = u;
    return u === "#f6f6f6" && (g = ""), `<div class="split6"><div class="palette" data-color="${g}" style="background-color: ${u};"></div></div>`;
  }).join("")}
      </div>
      <div class="bof">
      <span class="font">${X[t].font}</span>
      <span class="background">${X[t].background}</span>
      </div>
  `, s.innerHTML = `${X[t].tag}<textarea class="nm-tag" tabindex="-1" placeholder="${X[t].tagsSeparate}" /><br>`, r.innerHTML = `${X[t].icon}<div class="nm-icon" contenteditable="true" spellcheck="false" placeholder="${X[t].iconsSeparate}" ></div>`, o.innerHTML = `${X[t].hyperlink}<textarea class="nm-link" tabindex="-1" placeholder="${X[t].linkSeparate}" /><br>`, c.innerHTML = `${X[t].remark}<textarea class="nm-remark" tabindex="-1" placeholder="${X[t].reamrkSeparate}" /><br>`;
  const l = V();
  l.className = "picker", l.style.display = "none", l.innerHTML = '<div class="header"></div><div class="list"></div>', ["\u5168\u90E8", "\u65D7\u6746", "\u6570\u5B57", "\u5176\u4ED6", "\u4EBA\u50CF", "\u661F\u661F"].forEach((u, g) => {
    const d = V();
    d.className = "box", g === 0 && (d.className = "box active"), d.innerText = u, l.children[0].appendChild(d);
  });
  const f = {
    flag: 4,
    number: 8,
  ...
  Object.keys(f).forEach((u) => {
    for (let g = 1; g <= f[u]; g++) {
      const d = document.createElement("img"), x = V();
      x.className = "item", d.style.width = "100%", d.style.height = "100%", d.src = new URL((/* @__PURE__ */ Object.assign({ "../iconfont/icon/flag/flag1.webp": Ln, "../iconfont/icon/flag/flag2.webp": On, "../iconfont/icon/flag/flag3.webp": Nn, "../iconfont/icon/flag/flag4.webp": jn, "../iconfont/icon/number/number1.webp": Bn, "../iconfont/icon/number/number2.webp": Tn, "../iconfont/icon/number/number3.webp": Mn, "../iconfont/icon/number/number4.webp": kn, "../iconfont/icon/number/number5.webp": Cn, "../iconfont/icon/number/number6.webp": Zn, "../iconfont/icon/number/number7.webp": Vn, "../iconfont/icon/number/number8.webp": En, "../iconfont/icon/other/other1.webp": qn, "../iconfont/icon/other/other10.webp": Fn, "../iconfont/icon/other/other11.webp": Rn, "../iconfont/icon/other/other12.webp": Sn, "../iconfont/icon/other/other13.webp": Wn, "../iconfont/icon/other/other14.webp": Yn, "../iconfont/icon/other/other15.webp": Gn, "../iconfont/icon/other/other16.webp": Jn, "../iconfont/icon/other/other17.webp": In, "../iconfont/icon/other/other2.webp": Kn, "../iconfont/icon/other/other3.webp": Un, "../iconfont/icon/other/other4.webp": Qn, "../iconfont/icon/other/other5.webp": $n, "../iconfont/icon/other/other6.webp": _n, "../iconfont/icon/other/other7.webp": ei, "../iconfont/icon/other/other8.webp": ti, "../iconfont/icon/other/other9.webp": ni, "../iconfont/icon/portrait/portrait1.webp": ii, "../iconfont/icon/portrait/portrait2.webp": si, "../iconfont/icon/star/star1.webp": ri, "../iconfont/icon/star/star2.webp": oi, "../iconfont/icon/star/star3.webp": ci }))[`../iconfont/icon/${u}/${u + g}.webp`], self.location).href, x.appendChild(d), l.children[1].appendChild(x);
    }
    l.children[1].onclick = (g) => {
      if (g.target.nodeName === "IMG") {
        const d = V();
        d.className = "divItem", d.appendChild(g.target.cloneNode()), h.appendChild(d), e.updateNodeIcons(e.currentNode.nodeObj, h.innerHTML), g.stopPropagation();
      }
      console.log(g);
    };
  }), r.appendChild(l);
  function w(u) {
    u.ondblclick = (g) => {
      const d = document.createElement("textarea"), x = u.children[0], W = e.container.offsetHeight - u.offsetTop - 60, $ = 30, _ = (Z) => Z < $ ? $ : Z > W ? W : Z;
      d.value = x.value, d.style.position = "absolute", d.style.left = x.offsetLeft + "px", d.style.top = x.offsetTop - 10 + "px", d.style.height = _(x.scrollHeight) + "px", d.style.width = x.offsetWidth + "px", d.oninput = (Z) => {
        let se = Z.target.scrollHeight;
        d.style.height = _(se) + "px";
      }, d.onblur = (Z) => {
        x.value = d.value, x.dispatchEvent(new CustomEvent("change")), d.remove();
      }, u.appendChild(d), d.focus();
    };
  }
  w(s), w(o), w(c);
  ...
  `, a.appendChild(i), a.appendChild(s), a.appendChild(r), a.appendChild(o), a.appendChild(c), a.hidden = !0;
  function v(u, g) {
    var d = e.container.querySelectorAll(u);
    [].forEach.call(d, function(x) {
      x.classList.remove(g);
    });
  }
  e.container.append(a);
  const b = a.querySelectorAll(".size"), y = a.querySelector(".bold"), H = a.querySelector(".button-container"), D = a.querySelector(".font"), A = e.container.querySelector(".nm-tag"), h = e.container.querySelector(".nm-icon"), p = e.container.querySelector(".nm-link"), z = e.container.querySelector(".nm-remark");
  a.onclick = (u) => {
    if (!e.currentNode)
      return;
    const g = e.currentNode.nodeObj, d = u.target;
    d.className === "palette" ? (g.style || (g.style = {}), v(".palette", "nmenu-selected"), d.className = "palette nmenu-selected", n === "font" ? g.style.color = d.dataset.color : n === "background" && (g.style.background = d.dataset.color), e.updateNodeStyle(g)) : d.className === "background" ? (v(".palette", "nmenu-selected"), n = "background", d.className = "background selected", d.previousElementSibling.className = "font", g.style && g.style.background && (a.querySelector(
      '.palette[data-color="' + g.style.background + '"]'
    ).className = "palette nmenu-selected")) : d.className === "font" && (v(".palette", "nmenu-selected"), n = "font", d.className = "font selected", d.nextElementSibling.className = "background", g.style && g.style.color && (a.querySelector(
      '.palette[data-color="' + g.style.color + '"]'
    ).className = "palette nmenu-selected")), d.className !== "picker" && d.className !== "header" && d.className !== "item" && d.className !== "list" && d.className !== "box" && (l.style.display = "none");
  }, Array.from(b).map(
    (u) => {
      u.onclick = (g) => {
        e.currentNode.nodeObj.style || (e.currentNode.nodeObj.style = {}), v(".size", "size-selected");
        const d = g.currentTarget;
        e.currentNode.nodeObj.style.fontSize = d.dataset.size, d.className = "size size-selected", e.updateNodeStyle(e.currentNode.nodeObj);
      };
    }
  ), y.onclick = (u) => {
    e.currentNode.nodeObj.style || (e.currentNode.nodeObj.style = {}), e.currentNode.nodeObj.style.fontWeight === "bold" ? (delete e.currentNode.nodeObj.style.fontWeight, u.currentTarget.className = "bold", e.updateNodeStyle(e.currentNode.nodeObj)) : (e.currentNode.nodeObj.style.fontWeight = "bold", u.currentTarget.className = "bold size-selected", e.updateNodeStyle(e.currentNode.nodeObj));
  }, A.onchange = (u) => {
    if (!!e.currentNode && (u.target.value !== null || u.target.value !== void 0)) {
      let g;
      u.target.value === "" ? g = [] : g = u.target.value.split(","), e.updateNodeTags(e.currentNode.nodeObj, g);
    }
  }, h.addEventListener("input", (u) => {
    if (!!e.currentNode && (u.target.innerText !== null || u.target.innerText !== void 0)) {
      const g = u.target.innerText.split(",");
      e.updateNodeIcons(e.currentNode.nodeObj, g);
    }
  }), h.onclick = (u) => {
    l.style.display = "", u.stopPropagation();
  }, p.onchange = (u) => {
    if (!!e.currentNode && (u.target.value !== null || u.target.value !== void 0)) {
      const g = u.target.value;
      e.updateNodeHyperLink(e.currentNode.nodeObj, g);
    }
  }, z.onchange = (u) => {
    if (!!e.currentNode && (u.target.value !== null || u.target.value !== void 0)) {
      const g = u.target.value;
      e.updateNodeRemark(e.currentNode.nodeObj, g);
    }
  };
  let m = "open";
  H.onclick = (u) => {
    m === "open" ? (m = "close", a.className = "close", H.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-menu"></use></svg>') : (m = "open", a.className = "", H.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-close"></use></svg>');
  }, e.bus.addListener("unselectNode", function() {
    a.hidden = !0;
  }), e.bus.addListener("selectNode", function(u, g) {
    if (!!g) {
      if (a.hidden = !1, v(".palette", "nmenu-selected"), v(".size", "size-selected"), v(".bold", "size-selected"), n = "font", D.className = "font selected", D.nextElementSibling.className = "background", u.style) {
        if (u.style.fontSize) {
          const d = a.querySelector(
            '.size[data-size="' + u.style.fontSize + '"]'
          );
          d && (d.className = "size size-selected");
        }
        if (u.style.fontWeight) {
          const d = a.querySelector(".bold");
          d && (d.className = "bold size-selected");
        }
        if (u.style.color) {
          const d = a.querySelector(
            '.palette[data-color="' + u.style.color + '"]'
          );
          d && (d.className = "palette nmenu-selected");
        }
      }
      u.tags ? A.value = u.tags.join(",") : A.value = "", u.icons ? h.innerHTML = u.icons : h.innerText = "", p.value = "", u.hyperLink && (p.value = u.hyperLink), u.linkJump && (p.value.length > 0 && (p.value += ","), p.value += u.linkJump.map((d) => d.title).reduce((d, x, W) => d + (W ? "," : "") + x, "")), u.remark ? z.value = u.remark : z.value = "", l.style.display = "none";
    }
  });
}
const ve = document, ai = function(e, t) {
  if (!t)
    return Pe(e), e;
...
function fi(e) {
  ...
  e.map.addEventListener("dragstart", function(r) {
    t = r.target, t.parentNode.parentNode.style.opacity = "0.5", G.clear();
  }), e.map.addEventListener("dragend", async function(r) {
    r.target.style.opacity = "", Pe(i);
    const o = t.nodeObj;
    switch (n) {
      case "before":
        e.moveNodeBefore(t, i), e.selectNode(O(o.id));
        break;
      case "after":
        e.moveNodeAfter(t, i), e.selectNode(O(o.id));
        break;
      case "in":
        e.moveNode(t, i);
        break;
  ...
  }), e.map.addEventListener("dragover", qe(function(r) {
    Pe(i);
    const o = ve.elementFromPoint(
      r.clientX,
      r.clientY - 12
    );
    if (me(o, t)) {
...
function vi(e, t) {
  const n = (a, v) => {
    ...
    return b.id = a, b.innerHTML = `<svg class="icon" aria-hidden="true">
    <use xlink:href="#icon-${v}"></use>
  </svg>`, b;
  }, i = n("cm-add_child", "zijiedian"), s = n("cm-add_sibling", "tongjijiedian-"), r = n("cm-remove_child", "shanchu2"), o = n("cm-up", "rising"), c = n("cm-down", "falling"), l = n("cm-edit", "edit"), P = document.createElement("ul");
  if (P.className = "menu-list", t && t.extend)
    for (let a = 0; a < t.extend.length; a++) {
      const v = t.extend[a], b = n(v.name, v.name);
      P.appendChild(b), b.onclick = (y) => {
        v.onclick(y);
      };
    }
  const f = document.createElement("mmenu");
  f.appendChild(i), f.appendChild(s), f.appendChild(r), f.appendChild(o), f.appendChild(c), f.appendChild(l), f.hidden = !0, e.container.append(f);
  let w = !0;
  e.bus.addListener("unselectNode", function() {
    f.hidden = !0;
  }), e.bus.addListener("selectNode", function(a) {
    f.hidden = !1, a.root ? w = !0 : w = !1;
  }), f.onclick = (a) => {
    a.target === f && (f.hidden = !0);
  }, i.onclick = (a) => {
    e.addChild();
  }, s.onclick = (a) => {
    w || e.insertSibling();
...
(function(e) {
  ...
  t = function() {
    var f, w, a, v;
    (v = document.createElement("div")).innerHTML = c, c = null, (a = v.getElementsByTagName("svg")[0]) && (a.setAttribute("aria-hidden", "true"), a.style.position = "absolute", a.style.width = 0, a.style.height = 0, a.style.overflow = "hidden", f = a, (w = document.body).firstChild ? (v = f, (a = w.firstChild).parentNode.insertBefore(v, a)) : w.appendChild(f));
    ...
    s.readyState == "complete" && (s.onreadystatechange = null, P());
  });
})(window);
const I = O, K = document;
function S({
  el: e,
  data: t,
  direction: n,
  ...
  primaryLinkStyle: b,
  overflowHidden: y,
  primaryNodeHorizontalGap: H,
  primaryNodeVerticalGap: D,
  mobileMenu: A,
  closeButton: h,
  widthControll: p,
  uploadButton: z,
  ...
  !g || (this.mindElixirBox = g, this.before = w || {}, this.nodeData = t.nodeData, this.linkData = t.linkData || {}, this.expandDeep = t == null ? void 0 : t.expandDeep, this.locale = i, this.contextMenuOption = c, this.contextMenu = o === void 0 ? !0 : o, this.toolBar = l === void 0 ? !0 : l, this.nodeMenu = P === void 0 ? !0 : P, this.keypress = f === void 0 ? !0 : f, this.closeButton = h === void 0 ? !1 : h, this.widthControll = p === void 0 ? !0 : p, this.mobileMenu = A, this.direction = t.direction !== void 0 ? t.direction : typeof n == "number" ? n : 1, this.draggable = s === void 0 ? !0 : s, this.newTopicName = a, this.editable = r === void 0 ? !0 : r, this.allowUndo = v === void 0 ? !0 : v, this.currentNode = null, this.currentLink = null, this.inputDiv = null, this.scaleVal = 1, this.tempDirection = null, this.primaryLinkStyle = b || 0, this.overflowHidden = y, this.primaryNodeHorizontalGap = H, this.primaryNodeVerticalGap = D, this.uploadButton = z === void 0 ? !0 : z, this.nodeDraggable = m === void 0 ? !0 : m, this.scrollContainer = u, this.bus = new ke(), this.bus.addListener("operation", (d) => {
    if (this.isUndo) {
      this.isUndo = !1;
      return;
    }
    ...
    !d || (this.isUndo = !0, d.name === "moveNode" ? this.moveNode(
      I(d.obj.fromObj.id),
      I(d.obj.originParentId)
    ) : d.name === "removeNode" ? d.originSiblingId ? this.insertBefore(I(d.originSiblingId), d.obj) : this.addChild(I(d.originParentId), d.obj) : d.name === "addChild" || d.name === "copyNode" ? this.removeNode(I(d.obj.id)) : d.name === "finishEdit" ? this.setNodeTopic(I(d.obj.id), d.origin) : this.isUndo = !1);
  });
}
function N(e) {
...
S.prototype = {
  ...
  updateNodeTags: Yt,
  updateNodeIcons: Gt,
  updateNodeHyperLink: Jt,
  updateNodeRemark: It,
  processPrimaryNode: fn,
  setNodeTopic: an,
  createLink: un,
  removeLink: vn,
  selectLink: Pn,
  hideLinkController: hn,
  ...
  selectNode: wt,
  unselectNode: gt,
  selectNextSibling: Ht,
  selectPrevSibling: bt,
  selectFirstChild: zt,
  selectParent: Dt,
  getAllDataString: mt,
  getAllData: At,
  getAllDataWithAutoHide: yt,
  getAllDataMd: xt,
  scale: Ot,
  toCenter: Mt,
  toTopLeft: kt,
  ...
  exportSvgDom: pt,
  init: function(e, t) {
    e && (this.nodeData = e), t && (this.expandDeep = t), C(this.nodeData), console.log("ME_version " + S.version), console.log(this), this.mindElixirBox.className.indexOf("mind-elixir") === -1 && (this.mindElixirBox.className += "mind-elixir"), this.mindElixirBox.innerHTML = "", this.container = K.createElement("div"), this.container.className = "map-container", this.overflowHidden && (this.container.style.overflow = "hidden"), this.map = K.createElement("div"), this.map.className = "map-canvas", this.map.setAttribute("tabindex", "0"), this.container.appendChild(this.map), this.mindElixirBox.appendChild(this.container), this.root = K.createElement("root"), this.box = K.createElement("children"), this.box.className = "mindbox", this.svg2nd = ee("svg2nd"), this.linkController = ee("linkcontroller"), this.P2 = K.createElement("div"), this.P3 = K.createElement("div"), this.P2.className = this.P3.className = "circle", this.line1 = He(0, 0, 0, 0), this.line2 = He(0, 0, 0, 0), this.linkController.appendChild(this.line1), this.linkController.appendChild(this.line2), this.linkSvgGroup = ee("topiclinks"), this.map.appendChild(this.root), this.map.appendChild(this.box), this.map.appendChild(this.svg2nd), this.map.appendChild(this.linkController), this.map.appendChild(this.linkSvgGroup), this.map.appendChild(this.P2), this.map.appendChild(this.P3), this.toolBar && Xn(this), this.nodeMenu && di(this), this.keypress && ui(this), zn(this), Ee() && this.mobileMenu ? vi(this) : this.contextMenu && Hn(this, this.contextMenuOption), this.draggable && fi(this), he(this.nodeData, 0, this.expandDeep || 2), this.layout(), this.linkDiv(), this.toTopLeft(), gn(this);
  }
};
S.LEFT = 0;
S.RIGHT = 1;
