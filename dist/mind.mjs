...
const li = () => /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
), cn = (i) => i.replace(
...
function yi(i, e) {
  vt(i), e.children ? e.children.push(i) : e.children = [i];
}
function Pi(i, e) {
  vt(i);
...
Ke.prototype.init = function(i, e) {
...
Ke.prototype.destory = function(i) {
...
const ne = document, ie = "http://www.w3.org/2000/svg", bi = function(i) {
  const e = ne.createElementNS(ie, "path");
  ...
  const e = ne.createElementNS(ie, "svg");
  ...
  const s = ne.createElementNS(ie, "line");
  ...
  const t = ne.createElementNS(ie, "g"), n = ne.createElementNS(ie, "path"), s = ne.createElementNS(ie, "path");
...
}, Di = function(i = 10, e = 10, t) {
  const n = ne.createElementNS(ie, "svg"), s = ne.createElementNS(ie, "g"), r = ne.createElementNS(ie, "rect");
  ...
  const o = ne.createElementNS(ie, "rect");
...
const Be = function(i, e) {
  ...
  if (e.image && e.image.forEach((o) => {
    ...
    const r = W.createElement("div");
    r.className = "tags", r.innerHTML = e.tags.filter((o) => o !== "").map((o) => `<span>${kt(o)}</span>`).join(""), i.appendChild(r);
  }
};
function En(i) {
  let e = this.container.querySelector(`tpc[data-nodeid=me${i}]`);
  e || (kn(this.nodeData, i), this.layout(), this.linkDiv(), e = this.container.querySelector(`tpc[data-nodeid=me${i}]`)), e.scrollIntoView({ block: "center", behavior: "auto" }), e.className = "blink", setTimeout(() => {
...
const zi = function(i, e) {
  const t = W.createElement("GRP"), n = this.createTop(i);
  if (t.appendChild(n), !e && i.children && i.children.length > 0 && (n.appendChild(We(i.expanded)), i.expanded !== !1)) {
  ...
  return t.appendChild(n), !e && i.children && i.children.length > 0 && (n.appendChild(We(i.expanded)), i.expanded !== !1 && this.createChildren(i.children)), { smy: t, top: n };
}, Oi = function(i) {
  const e = W.createElement("t"), t = this.createTopic(i);
  return Be.call(this, t, i), e.appendChild(t), e;
}, Ti = function(i) {
...
function Ni(i) {
  ...
  i.nodeObj.icons ? t = i.childNodes[1].textContent : t = i.childNodes[0].textContent, i.appendChild(e), e.id = "input-box", e.contentEditable = "true", e.spellcheck = !1, e.textContent = t, e.draggable = !1, i.nodeObj.image && i.nodeObj.image.forEach((d) => {
    ...
    const h = Di(f.clientWidth, f.clientHeight, f);
    e.insertBefore(h, f);
  }), e.style.cssText = `min-width:${i.offsetWidth - 22}px;min-height:${i.clientHeight - 16}px`, (s = (n = i.nodeObj) == null ? void 0 : n.style) != null && s.width && (e.style.width = "auto"), (((o = (r = i.nodeObj) == null ? void 0 : r.style) == null ? void 0 : o.color) === "#ffffff" || ((a = i.nodeObj) == null ? void 0 : a.id) === "root" && !((c = (l = i.nodeObj) == null ? void 0 : l.style) != null && c.color)) && (e.style.color = "#2c3e50"), this.direction === 0 && (e.style.right = "0"), e.focus(), Xi(e), this.inputDiv = e, this.bus.fire("operation", {
    name: "beginEdit",
    obj: i.nodeObj
    ...
    u.style || (u.style = {}), u.style.controllWidth = h.style.height = g.style.height = i.clientHeight.toString() + "px", delete u.style.width, this.shapeTpc(i, u), this.linkDiv(), Vn.call(this, this.nodeData, u.id, u.topic), this.bus.fire("operation", {
      name: "finishEdit",
      obj: u,
      origin: t
    });
...
function Mi(i, e, t) {
  ...
  for (let r = 0; r < i.length; r++) {
    ...
    if (o.children && o.children.length > 0) {
      if (l.appendChild(We(o.expanded)), a.appendChild(l), o.expanded !== !1) {
...
function Bi() {
  ...
  Be.call(this, i, this.nodeData), i.draggable = !1, this.root.appendChild(i);
...
var Rn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Re = { exports: {} }, Ue = { exports: {} };
(function() {
  var i, e, t, n, s, r;
  typeof performance < "u" && performance !== null && performance.now ? Ue.exports = function() {
    return performance.now();
  } : typeof process < "u" && process !== null && process.hrtime ? (Ue.exports = function() {
    return (i() - s) / 1e6;
  }, e = process.hrtime, i = function() {
    var o;
    return o = e(), o[0] * 1e9 + o[1];
  }, n = i(), r = process.uptime() * 1e9, s = n - r) : Date.now ? (Ue.exports = function() {
    return Date.now() - t;
  }, t = Date.now()) : (Ue.exports = function() {
    return new Date().getTime() - t;
  }, t = new Date().getTime());
}).call(Rn);
var Ci = Ue.exports, me = typeof window > "u" ? Rn : window, ht = ["moz", "webkit"], Ze = "AnimationFrame", qe = me["request" + Ze], Qe = me["cancel" + Ze] || me["cancelRequest" + Ze];
for (var Ge = 0; !qe && Ge < ht.length; Ge++)
  qe = me[ht[Ge] + "Request" + Ze], Qe = me[ht[Ge] + "Cancel" + Ze] || me[ht[Ge] + "CancelRequest" + Ze];
if (!qe || !Qe) {
  var Bt = 0, fn = 0, Te = [], Si = 1e3 / 60;
  qe = function(i) {
    if (Te.length === 0) {
      var e = Ci(), t = Math.max(0, Si - (e - Bt));
      Bt = t + e, setTimeout(function() {
        var n = Te.slice(0);
        Te.length = 0;
    ...
    for (var e = 0; e < Te.length; e++)
      Te[e].handle === i && (Te[e].cancelled = !0);
  };
}
Re.exports = function(i) {
  return qe.call(me, i);
};
Re.exports.cancel = function() {
  Qe.apply(me, arguments);
};
Re.exports.polyfill = function(i) {
  i || (i = me), i.requestAnimationFrame = qe, i.cancelAnimationFrame = Qe;
};
var Zt = function(i) {
...
function Fn(i, e) {
  ...
  Zn(i, e), i.prototype = e === null ? Object.create(e) : (t.prototype = e.prototype, new t());
}
function ji(i) {
  var e = "";
  Array.isArray(i) || (i = [i]);
...
function Ct(i, e, t) {
  ...
  var a = Ft([(e - r) / 2, (t - o) / 2], -i.xRot / 180 * we), l = a[0], c = a[1], u = Math.pow(l, 2) / Math.pow(n, 2) + Math.pow(c, 2) / Math.pow(s, 2);
  1 < u && (n *= Math.sqrt(u), s *= Math.sqrt(u)), i.rX = n, i.rY = s;
  var d = Math.pow(n, 2) * Math.pow(c, 2) + Math.pow(s, 2) * Math.pow(l, 2), f = (i.lArcFlag !== i.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(n, 2) * Math.pow(s, 2) - d) / d)), h = n * c / s * f, g = -s * l / n * f, p = Ft([h, g], i.xRot / 180 * we);
  i.cX = p[0] + (e + r) / 2, i.cY = p[1] + (t + o) / 2, i.phi1 = Math.atan2((c - g) / s, (l - h) / n), i.phi2 = Math.atan2((-c - g) / s, (-l - h) / n), i.sweepFlag === 0 && i.phi2 > i.phi1 && (i.phi2 -= 2 * we), i.sweepFlag === 1 && i.phi2 < i.phi1 && (i.phi2 += 2 * we), i.phi1 *= 180 / we, i.phi2 *= 180 / we;
}
function dn(i, e, t) {
  ae(i, e, t);
  var n = i * i + e * e - t * t;
...
var I, fe = Math.PI / 180;
function gn(i, e, t) {
  return (1 - t) * i + t * e;
}
function pn(i, e, t, n) {
  return i + Math.cos(n / 180 * we) * e + Math.sin(n / 180 * we) * t;
}
function vn(i, e, t, n) {
...
(function(i) {
  ...
  i.ROUND = function(a) {
    ...
    return s(function(a, l, c) {
      return b.ARC === a.type ? function(u, d, f) {
        ...
        for (var w = Math.min(u.phi1, u.phi2), x = Math.max(u.phi1, u.phi2) - w, m = Math.ceil(x / 90), P = new Array(m), H = d, A = f, D = 0; D < m; D++) {
          var O = gn(u.phi1, u.phi2, D / m), y = gn(u.phi1, u.phi2, (D + 1) / m), L = y - O, z = 4 / 3 * Math.tan(L * fe / 4), N = [Math.cos(O * fe) - z * Math.sin(O * fe), Math.sin(O * fe) + z * Math.cos(O * fe)], B = N[0], E = N[1], S = [Math.cos(y * fe), Math.sin(y * fe)], k = S[0], F = S[1], Y = [k + z * Math.sin(y * fe), F - z * Math.cos(y * fe)], M = Y[0], j = Y[1];
          P[D] = { relative: u.relative, type: b.CURVE_TO };
          var U = function(se, he) {
            var Pe = Ft([se * u.rX, he * u.rY], u.xRot), Se = Pe[0], nt = Pe[1];
            return [u.cX + Se, u.cY + nt];
          };
    ...
    return s(function(a, l, c) {
      return a.relative && (l = 0, c = 0), b.ARC === a.type && Ct(a, l, c), a;
    });
    ...
    var a = function(f) {
      ...
      if (p.type & b.DRAWING_COMMANDS && (v(h), w(g)), p.type & b.HORIZ_LINE_TO && v(p.x), p.type & b.VERT_LINE_TO && w(p.y), p.type & b.LINE_TO && (v(p.x), w(p.y)), p.type & b.CURVE_TO) {
        v(p.x), w(p.y);
        for (var x = 0, m = vn(h, p.x1, p.x2, p.x); x < m.length; x++)
          0 < (M = m[x]) && 1 > M && v(mn(h, p.x1, p.x2, p.x, M));
        for (var P = 0, H = vn(g, p.y1, p.y2, p.y); P < H.length; P++)
          0 < (M = H[P]) && 1 > M && w(mn(g, p.y1, p.y2, p.y, M));
      }
      if (p.type & b.ARC) {
        v(p.x), w(p.y), Ct(p, h, g);
        ...
        }, S = 0, k = dn(y, -D, 0).map(E); S < k.length; S++)
          (M = k[S]) > N && M < B && v(pn(p.cX, D, y, M));
        for (var F = 0, Y = dn(L, -O, 0).map(E); F < Y.length; F++) {
          var M;
          (M = Y[F]) > N && M < B && w(pn(p.cY, O, L, M));
        }
      }
      return f;
    });
...
`;
  ...
  return Fn(e, i), e.prototype.finish = function(t) {
    ...
    for (var r = function(d) {
      ...
      var a = t[o], l = !(this.curCommandType !== b.ARC || this.curArgs.length !== 3 && this.curArgs.length !== 4 || this.curNumber.length !== 1 || this.curNumber !== "0" && this.curNumber !== "1"), c = yn(a) && (this.curNumber === "0" && a === "0" || l);
      if (!yn(a) || c)
        if (a !== "e" && a !== "E")
  ...
  return Fn(e, i), e.prototype.encode = function() {
...
}(qn), Vi = ((re = {})[b.MOVE_TO] = 2, re[b.LINE_TO] = 2, re[b.HORIZ_LINE_TO] = 1, re[b.VERT_LINE_TO] = 1, re[b.CLOSE_PATH] = 0, re[b.QUAD_TO] = 4, re[b.SMOOTH_QUAD_TO] = 2, re[b.CURVE_TO] = 6, re[b.SMOOTH_CURVE_TO] = 4, re[b.ARC] = 7, re);
function gt(i) {
...
var Zi = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259], Fi = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
function qi(i, e, t, n, s) {
  if (typeof i == "string" && (i = document.getElementById(i)), !i || gt(i) !== "object" || !("getContext" in i))
...
function Ii(i, e, t, n, s, r) {
  if (!(isNaN(r) || r < 1)) {
    r |= 0;
    var o = qi(i, e, t, n, s);
    o = Wi(o, e, t, n, s, r), i.getContext("2d").putImageData(o, e, t);
  }
}
function Wi(i, e, t, n, s, r) {
  for (var o = i.data, a = 2 * r + 1, l = n - 1, c = s - 1, u = r + 1, d = u * (u + 1) / 2, f = new Pn(), h = f, g, p = 1; p < a; p++)
    h = h.next = new Pn(), p === u && (g = h);
  h.next = f;
  for (var v = null, w = null, x = 0, m = 0, P = Zi[r], H = Fi[r], A = 0; A < s; A++) {
    h = f;
    for (var D = o[m], O = o[m + 1], y = o[m + 2], L = o[m + 3], z = 0; z < u; z++)
      h.r = D, h.g = O, h.b = y, h.a = L, h = h.next;
    for (var N = 0, B = 0, E = 0, S = 0, k = u * D, F = u * O, Y = u * y, M = u * L, j = d * D, U = d * O, se = d * y, he = d * L, Pe = 1; Pe < u; Pe++) {
      var Se = m + ((l < Pe ? l : Pe) << 2), nt = o[Se], $t = o[Se + 1], en = o[Se + 2], tn = o[Se + 3], it = u - Pe;
      j += (h.r = nt) * it, U += (h.g = $t) * it, se += (h.b = en) * it, he += (h.a = tn) * it, N += nt, B += $t, E += en, S += tn, h = h.next;
    }
    v = f, w = g;
    for (var bt = 0; bt < n; bt++) {
      ...
      if (o[m + 3] = xt, xt !== 0) {
        var Ht = 255 / xt;
        o[m] = (j * P >> H) * Ht, o[m + 1] = (U * P >> H) * Ht, o[m + 2] = (se * P >> H) * Ht;
      } else
        o[m] = o[m + 1] = o[m + 2] = 0;
      j -= k, U -= F, se -= Y, he -= M, k -= v.r, F -= v.g, Y -= v.b, M -= v.a;
      var De = bt + r + 1;
      De = x + (De < l ? De : l) << 2, N += v.r = o[De], B += v.g = o[De + 1], E += v.b = o[De + 2], S += v.a = o[De + 3], j += N, U += B, se += E, he += S, v = v.next;
      var st = w, nn = st.r, sn = st.g, rn = st.b, on = st.a;
      k += nn, F += sn, Y += rn, M += on, N -= nn, B -= sn, E -= rn, S -= on, w = w.next, m += 4;
    }
    x += n;
  }
  for (var je = 0; je < n; je++) {
    m = je << 2;
    var ze = o[m], Le = o[m + 1], Oe = o[m + 2], K = o[m + 3], At = u * ze, Dt = u * Le, zt = u * Oe, Lt = u * K, rt = d * ze, ot = d * Le, at = d * Oe, lt = d * K;
    h = f;
    for (var an = 0; an < u; an++)
      h.r = ze, h.g = Le, h.b = Oe, h.a = K, h = h.next;
    for (var ln = n, Ot = 0, Tt = 0, Xt = 0, Nt = 0, ct = 1; ct <= r; ct++) {
      m = ln + je << 2;
      var ut = u - ct;
      rt += (h.r = ze = o[m]) * ut, ot += (h.g = Le = o[m + 1]) * ut, at += (h.b = Oe = o[m + 2]) * ut, lt += (h.a = K = o[m + 3]) * ut, Nt += ze, Ot += Le, Tt += Oe, Xt += K, h = h.next, ct < c && (ln += n);
    }
    m = je, v = f, w = g;
    for (var Mt = 0; Mt < s; Mt++) {
      var Q = m << 2;
      o[Q + 3] = K = lt * P >> H, K > 0 ? (K = 255 / K, o[Q] = (rt * P >> H) * K, o[Q + 1] = (ot * P >> H) * K, o[Q + 2] = (at * P >> H) * K) : o[Q] = o[Q + 1] = o[Q + 2] = 0, rt -= At, ot -= Dt, at -= zt, lt -= Lt, At -= v.r, Dt -= v.g, zt -= v.b, Lt -= v.a, Q = je + ((Q = Mt + u) < c ? Q : c) * n << 2, rt += Nt += v.r = o[Q], ot += Ot += v.g = o[Q + 1], at += Tt += v.b = o[Q + 2], lt += Xt += v.a = o[Q + 3], v = v.next, At += ze = w.r, Dt += Le = w.g, zt += Oe = w.b, Lt += K = w.a, Nt -= ze, Ot -= Le, Tt -= Oe, Xt -= K, w = w.next, m += n;
    }
  }
  return i;
}
var Pn = function i() {
  Ri(this, i), this.r = 0, this.g = 0, this.b = 0, this.a = 0, this.next = null;
};
function Ye(i) {
...
const Ji = /^[A-Z-]+$/;
function Ki(i) {
  return Ji.test(i) ? i.toLowerCase() : i;
}
function In(i) {
  const e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(i);
...
const _i = /(\[[^\]]+\])/g, $i = /(#[^\s+>~.[:]+)/g, es = /(\.[^\s+>~.[:]+)/g, ts = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi, ns = /(:[\w-]+\([^)]*\))/gi, is = /(:[^\s+>~.[:]+)/g, ss = /([^\s+>~.[:]+)/g;
function Xe(i, e) {
  const t = e.exec(i);
  return t ? [
    i.replace(e, " "),
...
function rs(i) {
  ...
  return [t, n] = Xe(t, _i), e[1] += n, [t, n] = Xe(t, $i), e[0] += n, [t, n] = Xe(t, es), e[1] += n, [t, n] = Xe(t, ts), e[2] += n, [t, n] = Xe(t, ns), e[1] += n, [t, n] = Xe(t, is), e[1] += n, t = t.replace(/[*\s+>~]/g, " ").replace(/[#.]/g, " "), [t, n] = Xe(t, ss), e[2] += n, e.join("");
}
const Fe = 1e-8;
function wn(i) {
...
function qt(i, e) {
  return (i[0] * e[0] + i[1] * e[1]) / (wn(i) * wn(e));
}
function bn(i, e) {
...
class T {
  ...
  split() {
    ...
    return Ye(this.getString()).trim().split(e).map(
      (s) => new T(t, n, s)
    );
  }
  hasValue(e) {
  ...
  getColor(e) {
    ...
    return this.isNormalizedColor || (this.isNormalizedColor = !0, t = Qi(t), this.value = t), t;
  }
  getDpi() {
    return 96;
  }
...
_e.DEFAULT_VIEWPORT_WIDTH = 800;
_e.DEFAULT_VIEWPORT_HEIGHT = 600;
function Tn() {
  return {
    width: _e.DEFAULT_VIEWPORT_WIDTH,
    height: _e.DEFAULT_VIEWPORT_HEIGHT
  };
}
class Z {
  static parse(e) {
...
const Wn = typeof window < "u" ? window : null, Yn = typeof fetch < "u" ? fetch.bind(void 0) : void 0;
class ye {
  wait(e) {
    this.waits.push(e);
  }
  ...
  setViewBox(e) {
    ...
    const v = Ye(s).replace(/^defer\s/, ""), [w, x] = v.split(" "), m = w || "xMidYMid", P = x || "meet", H = r / o, A = a / l, D = Math.min(H, A), O = Math.max(H, A);
    let y = o, L = l;
  ...
  start(e) {
    ...
    const { mouse: f } = this, h = 1e3 / ye.FRAMERATE;
    ...
    const w = () => {
      g = Date.now(), v = g - p, v >= h && (p = g - v % h, this.shouldUpdate(s, a) && (this.render(e, r, o, l, c, u, d), f.runEvents())), this.intervalId = Re.exports(w);
    };
    n || f.start(), this.intervalId = Re.exports(w);
  }
  stop() {
    this.intervalId && (Re.exports.cancel(this.intervalId), this.intervalId = null), this.mouse.stop();
  }
  shouldUpdate(e, t) {
    if (!e) {
  ...
  render(e, t, n, s, r, o, a) {
    ...
    if (t && f.hasValue() && h.hasValue() && (g = f.getPixels("x"), p = h.getPixels("y")), l.setCurrent(g, p), typeof o == "number" && e.getAttribute("x", !0).setValue(o), typeof a == "number" && e.getAttribute("y", !0).setValue(a), typeof s == "number" || typeof r == "number") {
      const v = te(e.getAttribute("viewBox").getString());
      let w = 0, x = 0;
      if (typeof s == "number") {
  ...
  constructor(e, { fetch: t = Yn, window: n = Wn } = {}) {
    if (this.ctx = e, this.viewPort = new _e(), this.mouse = new os(this), this.animations = [], this.waits = [], this.frameDuration = 0, this.isReadyLock = !1, this.isFirstRender = !0, this.intervalId = null, this.window = n, !t)
...
ye.defaultFetch = Yn;
ye.FRAMERATE = 30;
ye.MAX_VIRTUAL_PIXELS = 3e4;
const { defaultFetch: as } = ye, ls = typeof DOMParser < "u" ? DOMParser : void 0;
class St {
  async parse(e) {
  ...
  constructor({ fetch: e = as, DOMParser: t = ls } = {}) {
    if (!e)
      throw new Error("Can't find 'fetch' in 'globalThis', please provide it via options");
    if (!t)
...
class hs {
  ...
  constructor(e, t, n) {
    ...
    (s.x === 0 || s.y === 0) && (s.x = Fe, s.y = Fe), this.scale = s, this.originX = n[0], this.originY = n[1];
  }
}
class Gn {
  apply(e) {
  ...
  constructor(e, t, n) {
    this.type = "matrix", this.matrix = Ui(t), this.originX = n[0], this.originY = n[1];
  }
}
class Un extends Gn {
  constructor(e, t, n) {
...
function gs(i) {
  return Ye(i).trim().replace(/\)([a-zA-Z])/g, ") $1").replace(/\)(\s?,\s?)/g, ") ").split(/\s(?=[a-z])/);
}
function ps(i) {
  const [e = "", t = ""] = i.split("(");
  return [
...
class Me {
  ...
  constructor(e, t, n) {
    this.document = e, this.transforms = [], gs(t).forEach((r) => {
      if (r === "none")
        return;
      const [o, a] = ps(r), l = Me.transformTypes[o];
...
class R {
  ...
  applyEffects(e) {
    const t = Me.fromElement(this.document, this);
    t && t.apply(e);
...
function ys(i) {
  return typeof process > "u" ? i : i.trim().split(",").map(ms).join(",");
}
function Ps(i) {
  if (!i)
    return "";
...
class He extends Ce {
  ...
  getTextFromNode(e) {
    ...
    return s === 0 && (o = Yi(o)), s === r && (o = Gi(o)), o;
  }
  renderChildren(e) {
    if (this.type !== "text") {
  ...
  renderTElementChildren(e) {
    ...
    if (r) {
      const { unitsPerEm: l } = r.fontFace, c = J.parse(t.ctx.font), u = n.getStyle("font-size").getNumber(c.fontSize), d = n.getStyle("font-style").getString(c.fontStyle), f = u / l, h = r.isRTL ? s.split("").reverse().join("") : s, g = te(n.getAttribute("dx").getString()), p = h.length;
      for (let v = 0; v < p; v++) {
  ...
  measureTargetText(e, t) {
    ...
    if (s) {
      const o = this.getFontSize(), a = s.isRTL ? t.split("").reverse().join("") : t, l = te(n.getAttribute("dx").getString()), c = a.length;
      let u = 0;
      for (let d = 0; d < c; d++)
  ...
  getInheritedAttribute(e) {
    let t = this;
    for (; t instanceof He && t.isFirstChild() && t.parent; ) {
  ...
  constructor(e, t, n) {
    super(e, t, new.target === He ? !0 : n), this.type = "text", this.x = 0, this.y = 0, this.leafTexts = [], this.textChunkStart = 0, this.minX = Number.POSITIVE_INFINITY, this.maxX = Number.NEGATIVE_INFINITY, this.measureCache = -1;
  }
}
class mt extends He {
  getText() {
  ...
  constructor(e, t, n) {
    super(e, t, new.target === mt ? !0 : n), this.type = "tspan", this.text = this.children.length > 0 ? "" : this.getTextFromNode();
  }
}
class bs extends mt {
  constructor(...e) {
...
class C extends Ce {
  ...
  static pathA(e) {
    ...
    isNaN(h) && (h = 0);
    const g = new Z(h * s * d.y / r, h * -r * d.x / s), p = new Z((t.x + u.x) / 2 + Math.cos(c) * g.x - Math.sin(c) * g.y, (t.y + u.y) / 2 + Math.sin(c) * g.x + Math.cos(c) * g.y), v = bn([
      1,
      0
    ], [
      (d.x - g.x) / s,
...
class tt extends Ce {
  setContext(e) {
    ...
    const c = this.getAttribute("refX"), u = this.getAttribute("refY"), d = this.getAttribute("viewBox"), f = d.hasValue() ? te(d.getString()) : null, h = !this.root && this.getStyle("overflow").getValue("hidden") !== "visible";
    let g = 0, p = 0, v = 0, w = 0;
...
class zs extends R {
  createPattern(e, t, n) {
    const s = this.getStyle("width").getPixels("x", !0), r = this.getStyle("height").getPixels("y", !0), o = new tt(this.document, null);
...
class Qn extends R {
  ...
  createGradient(e, t, n) {
    ...
    if (r.forEach((a) => {
      ...
      const { document: a } = this, { MAX_VIRTUAL_PIXELS: l } = ye, { viewPort: c } = a.screen, u = c.getRoot(), d = new Jn(a);
...
class Ms extends Gt {
  calcValue() {
    const { progress: e, from: t, to: n } = this.getProgress(), s = new Zt(t.getColor()), r = new Zt(n.getColor());
    if (s.ok && r.ok) {
...
class Bs extends Gt {
  calcValue() {
    const { progress: e, from: t, to: n } = this.getProgress(), s = te(t.getString()), r = te(n.getString());
    return s.map((a, l) => {
      const c = r[l];
      return a + (c - a) * e;
    }).join(" ");
...
class Es extends He {
  ...
  getPointOnCubicBezier(e, t, n, s, r, o, a, l, c) {
    const u = l * xn(e) + o * Hn(e) + s * An(e) + t * Dn(e), d = c * xn(e) + a * Hn(e) + r * An(e) + n * Dn(e);
    return {
      x: u,
      y: d
    };
  ...
  getPointOnQuadraticBezier(e, t, n, s, r, o, a) {
    const l = o * zn(e) + s * Ln(e) + t * On(e), c = a * zn(e) + r * Ln(e) + n * On(e);
    return {
      x: l,
      y: c
    };
...
class ei extends R {
  constructor(e, t, n) {
    super(e, t, n), this.type = "style", Ye(
      ...
      c.forEach((d) => {
        ...
        if (u.forEach((g) => {
          ...
          v && w && (h[v] = new T(e, v, w));
        }), e.styles[f] = h, e.stylesSpecificity[f] = rs(f), f === "@font-face") {
...
class Fs extends Ce {
  ...
  elementTransform() {
    ...
    return t ? Me.fromElement(e, t) : null;
  }
  get element() {
...
class ti extends R {
  apply(e, t, n, s, r) {
    ...
    for (let c = 0; c < r; c++)
      for (let u = 0; u < s; u++) {
        const d = ft(l.data, u, c, s, r, 0), f = ft(l.data, u, c, s, r, 1), h = ft(l.data, u, c, s, r, 2), g = ft(l.data, u, c, s, r, 3);
        ...
        o && (p = 0, v = 0, w = 0, x *= g / 255), dt(l.data, u, c, s, r, 0, p), dt(l.data, u, c, s, r, 1, v), dt(l.data, u, c, s, r, 2, w), dt(l.data, u, c, s, r, 3, x);
      }
    e.clearRect(0, 0, s, r), e.putImageData(l, 0, 0);
  }
  constructor(e, t, n) {
    super(e, t, n), this.type = "feColorMatrix";
    let s = te(this.getAttribute("values").getString());
    switch (this.getAttribute("type").getString("matrix")) {
      ...
      case "hueRotate": {
        ...
        s = [
          de(r, 0.213, 0.787, -0.213),
          de(r, 0.715, -0.715, -0.715),
          de(r, 0.072, -0.072, 0.928),
          0,
          0,
          de(r, 0.213, -0.213, 0.143),
          de(r, 0.715, 0.285, 0.14),
          de(r, 0.072, -0.072, -0.283),
          0,
          0,
          de(r, 0.213, -0.213, -0.787),
          de(r, 0.715, -0.715, 0.715),
          de(r, 0.072, 0.928, 0.072),
          0,
          0,
          0,
          0,
...
class yt extends R {
  apply(e, t) {
    ...
    const l = this.removeStyles(t, yt.ignoreStyles), c = n.createCanvas(s + o, r + a), u = c.getContext("2d");
    n.screen.setDefaults(u), this.renderChildren(u), new ti(n, {
      nodeType: 1,
      childNodes: [],
      attributes: [
        {
...
class qs extends R {
  apply(e) {
    ...
    n && (n.beginPath = Xn, n.closePath = Xn), Reflect.apply(s, e, []), this.children.forEach((o) => {
      if (!("path" in o))
        return;
      let a = "elementTransform" in o ? o.elementTransform() : null;
      a || (a = Me.fromElement(t, o)), a && a.apply(e), o.path(e), n && (n.closePath = r), a && a.unapply(e);
...
class Pt extends R {
  apply(e, t) {
    ...
    if (u < 1 || d < 1)
      return;
    const f = Math.floor(r.x), h = Math.floor(r.y), g = this.removeStyles(t, Pt.ignoreStyles), p = n.createCanvas(u, d), v = p.getContext("2d");
...
class Gs extends R {
  apply(e, t, n, s, r) {
    ...
    c.id = o.getUniqueId(), l && (c.style.display = "none", l.appendChild(c)), Ii(c, t, n, s, r, a), l && l.removeChild(c);
  }
  constructor(e, t, n) {
...
class xe {
  ...
  createElement(e) {
    const t = e.nodeName.replace(/^[^:]+:/, ""), n = xe.elementTypes[t];
    return n ? new n(this, e) : new vs(this, e);
  }
  createTextNode(e) {
  ...
  constructor(e, { rootEmSize: t = jt, emSize: n = jt, createCanvas: s = xe.createCanvas, createImage: r = xe.createImage, anonymousCrossOrigin: o } = {}) {
...
class Ve {
  static async from(e, t) {
    ...
    const r = await new St(n).parse(t);
    return new Ve(e, r, n);
  }
  static fromString(e, t) {
    let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    const r = new St(n).parseFromString(t);
    return new Ve(e, r, n);
  }
  fork(e, t) {
    let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
  ...
  constructor(e, t, n = {}) {
    this.parser = new St(n), this.screen = new ye(e, n), this.options = n;
    const s = new xe(this, n), r = s.createDocumentElement(t);
...
let $e = document, $ = 1e4, ge = 1e4, ee = 1e4, pe = 1e4, le = 40, ni = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
function ii() {
  $ = 1e4, ge = 1e4, ee = 1e4, pe = 1e4, le = 40;
}
function Te() {
  Be();
...
function Jt() {
  ...
  console.log($, ge, ee, pe), e += tr();
  let t = ge - $ + le * 2, n = pe - ee + le * 2, s = er(t, n);
...
function $s() {
  ...
  for (let s = 0; s < i.length; s++) {
    ...
    a < $ && ($ = a), l > ge && (ge = l), c < ee && (ee = c), u > pe && (pe = u), e += si(r);
  }
  console.log(T, F, M, R);
  let n = F - T, i = R - M;
  return console.log("svgHeight", n), [n + 5, i + 5];
  console.log($, ge, ee, pe);
  let t = ge - $, n = pe - ee;
  return console.log("svgHeight", t), [t + 5, n + 5];
}
function vt(e, t) {
...
function tr() {
  let i = document.querySelector("root"), e = document.querySelector("root > tpc"), t = e.getBoundingClientRect(), n = getComputedStyle(e), s = e.parentNode, r = 0, o = 0, a = document.querySelector("root > tpc").nodeObj, l = getComputedStyle(s), c = i.offsetTop - $, u = i.offsetLeft - ee, d = o + parseInt(l.paddingLeft) + parseInt(t.paddingLeft), f = r + parseInt(l.paddingTop) + parseInt(t.paddingTop) + parseInt(t.fontSize);
  ...
  if (a.image && a.image.length) {
    ...
    for (let P = 0; P < m.length; P++) {
      let H = m[P];
      H.getBoundingClientRect(), v += `${H.outerHTML}`;
    }
  }
  let w = `<g transform="translate(${le - ee}, ${le - $})">${h.innerHTML}</g>`;
  ...
  let x = $e.querySelector(".topiclinks");
  return x && (w += `<g transform="translate(${le - ee}, ${le - $})">${x.innerHTML}</g>`), w;
}
function si(i) {
  let e = i.querySelectorAll("tpc"), t = i.offsetTop - $, n = i.offsetLeft - ee, s = "", r = i.querySelector(".svg3rd");
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (c.image && c.image.length) {
      ...
      for (let O = 0; O < D.length; O++) {
        let y = D[O];
        y.getBoundingClientRect(), A += `${y.outerHTML}`;
      }
    }
    s += `<g id="${c.id}">
      ${x}
...
let nr = function() {
  let i = Jt(), e = URL.createObjectURL(
    new Blob([ni + i.outerHTML.replace(/&nbsp;/g, " ")])
  ), t = document.createElement("a");
  t.href = e, t.download = "me-mindmap.svg", t.click();
}, ir = function(i = this, e = "default") {
  return $e = i.container, Jt();
}, sr = async function() {
  let i = Jt();
...
const dr = function() {
  ...
  return Kt(e.nodeData, 0, i), JSON.parse(
...
const xr = function() {
  ...
  ((i = this.nodeData) == null ? void 0 : i.children.length) > 0 ? this.container.scrollTo(
    1e4 - yr(this.container) / 2 - 10,
    1e4 - Pr(this.container) / 2 - br(this.container) - 5
  ) : this.container.scrollTo(
    1e4 - this.container.offsetWidth / 2,
    1e4 - this.container.offsetHeight / 2
  );
  ...
  const t = i.nodeObj;
  typeof e == "boolean" ? t.expanded = e : t.expanded !== !1 ? t.expanded = !1 : (t.expanded = !0, Qt(t)), this.layout(), this.linkDiv(), this.bus.fire("expandNode", t);
}, Nr = function() {
...
const Ie = document, Mr = function(i) {
  if (!i.style)
    return;
  const e = G(i.id, this), t = {
    color: e.style.color && cn(e.style.color),
    background: e.style.background && cn(e.style.background),
  ...
  const n = G(i.id);
  Be.call(this, n, i), this.linkDiv(), this.bus.fire("operation", {
    name: "editTags",
    obj: i,
    origin: t
  });
  ...
  const s = G(i.id);
  Be.call(this, s, i), this.linkDiv(), this.bus.fire("operation", {
    name: "editHyperLink",
    obj: i,
    origin: t
  });
  ...
  const c = Ie.createElement("children");
  ...
  if (!((a = s.children) != null && a.smychildren)) {
    const l = Ie.createElement("smychildren");
  ...
  if (s.tagName === "T") {
    if (s.children[1])
      ...
      const a = Ie.createElement("children");
      a.appendChild(r), s.appendChild(We(!0)), s.insertAdjacentElement("afterend", a);
    }
  ...
  this.container.querySelectorAll("tpc.selected").forEach((s) => {
    ...
    if (this.currentSummaryNodeArr = s, !r || ((u = (c = (l = r == null ? void 0 : r.parentElement) == null ? void 0 : l.parentElement) == null ? void 0 : c.parentElement) == null ? void 0 : u.className) == "mindbox")
      return;
    const { newTop: o, newNodeObj: a } = Rr.call(this, r, e);
  ...
  if (!t)
    return;
  const { newTop: n, newNodeObj: s } = ri.call(this, t, e);
  ...
  Sn(t);
  const { newNodeObj: n } = ri.call(this, e, t);
  ...
  di(n), t.parentNode.insertBefore(t, t.previousSibling), this.linkDiv(), this.bus.fire("operation", {
    name: "moveUpNode",
    obj: n
  });
}, Wr = function(i) {
  ...
  if (!e)
    return;
  const t = e.parentNode.parentNode, n = e.nodeObj;
  gi(n), t.nextSibling ? t.insertAdjacentElement("beforebegin", t.nextSibling) : t.parentNode.prepend(t), this.linkDiv(), this.bus.fire("operation", {
    name: "moveDownNode",
    obj: n
  });
}, Yr = function(i) {
  ...
  const n = t.parent.children.findIndex((l) => l === t), s = t.parent.children[n + 1], r = s && s.id, o = vt(t), a = e.parentNode;
  if (a.tagName !== "ROOT") {
    if (o === 0) {
  ...
  if (n.expanded === !1 && (this.expandNode(e, !0), i = G(t.id), e = G(n.id)), !fi(t, n)) {
    console.warn("Invalid move");
    return;
  }
  console.time("moveNode"), yi(t, n), ce(this.nodeData);
  ...
  if (o.className === "mindbox" ? r.parentNode.lastChild.remove() : r.parentNode.className === "mindbox" && (r.style.cssText = ""), a.tagName === "T")
    if (o.className === "mindbox" && (r.parentNode.className = ""), a.children[1])
      ...
      const l = Ie.createElement("children");
      l.appendChild(r.parentNode), a.appendChild(We(!0)), a.parentElement.insertBefore(l, a.nextSibling);
    }
  else
...
function _r(i, e) {
  if (this.direction === 0)
    ...
    const t = Ie.querySelectorAll(".lhs").length, n = Ie.querySelectorAll(".rhs").length;
    t <= n ? (i.className = "lhs", e.direction = 0) : (i.className = "rhs", e.direction = 1);
  }
}
const $r = function(i, e, t, n) {
  ...
  const p = {
    ...
    w: o.width,
    h: o.height
  }, w = Vt(p, d, f), x = w.x, m = w.y, P = Rt(v, h, g), H = P.x, A = P.y, D = jn(h, g, H, A), O = Ai(
    `M ${x} ${m} C ${d} ${f} ${h} ${g} ${H} ${A}`,
...
function so(i) {
  ...
  this.svg2nd.appendChild(bi(h));
  for (let x = 0; x < s.length; x++) {
    const m = s[x];
    if (!(i && i !== s[x]) && m.childElementCount) {
      const P = Je("svg3rd"), H = Je("svg3rd");
      m.querySelectorAll(".svg3rd").forEach((O) => {
        O.remove();
      }), m.appendChild(P);
      const A = m.children[0];
      let D;
      ((w = (v = m.children) == null ? void 0 : v[2]) == null ? void 0 : w.tagName) === "SMYCHILDREN" ? D = [...m.children[1].children, ...m.children[2].children] : D = m.children[1].children, be = "", pt = "", oi(D, A, this.nodeData.children[x], !0), P.appendChild(Hi(be)), pt.length > 0 && (m.appendChild(H), H.appendChild(xi(pt)));
    }
  }
...
function oi(i, e, t, n) {
  ...
  for (let f = 0; f < i.length; f++) {
    ...
    if ((h == null ? void 0 : h.tagName) === "SMY") {
      ...
      typeof Y == "string" && (Y = Number(Y.replace("px", ""))), h.style.top = Y + (S + E + h.children[0].clientHeight) / 2 - F + "px", pt += `M ${B} ${E} H ${B + 10} V ${S} H${k}`;
    }
    ...
    A === "lhs" && (h == null ? void 0 : h.tagName) !== "SMY" ? (m = r + 15, H = r, P = r - g.offsetWidth, p + v < s + a / 2 + 50 && p + v > s + a / 2 - 50 ? be += `M ${m} ${w} H ${H} V ${x} H ${P}` : p + v >= s + a / 2 ? be += `M ${m} ${w} H ${H} V ${x} H ${P}` : be += `M ${m} ${w} H ${H} V ${x} H ${P}`) : A === "rhs" && (h == null ? void 0 : h.tagName) !== "SMY" && (m = r + o - 15, H = r + o, P = r + o + g.offsetWidth, l && (m += 15), p + v < s + a / 2 + 50 && p + v > s + a / 2 - 50 ? be += `M ${m} ${w} H ${H} V ${x} H ${P}` : p + v >= s + a / 2 ? be += `M ${m} ${w} H ${H} V ${x} H ${P}` : be += `M ${m} ${w} H ${H} V ${x} H ${P}`);
    ...
    if (D) {
      ...
      continue;
    let O;
    ((d = (u = h.children) == null ? void 0 : u[2]) == null ? void 0 : d.tagName) === "SMYCHILDREN" ? O = [...h.children[1].children, ...h.children[2].children] : O = [...h.children[1].children], O.length > 0 && oi(O, g, t.children[f]);
  }
}
function ro(i) {
  i.map.addEventListener("click", (e) => {
    ...
    if (!i.nodeDraggable && e && e.target.className === "selected") {
      Ne.clear(), e.target.draggable = !1;
      return;
    }
    e.target.contentEditable !== "true" && Ne.onMove(e, i.container);
  }), i.map.addEventListener("mousedown", (e) => {
    e.target.contentEditable !== "true" && (Ne.afterMoving = !1, Ne.mousedown = !0);
...
function oo(i, e) {
  const t = (m) => {
    ...
    return A.id = m, A.innerHTML = `<span>${kt(P)}</span><span>${kt(H)}</span>`, A;
...
function lo(i) {
  ...
  const t = i.nodeData;
  e.innerHTML = `${_t(t, 0)}`, i.container.append(e);
}
const ve = (i, e) => {
...
function uo(i) {
  var d;
  const e = document.createElement("toolbar"), t = ve("fullscreen", "full"), n = ve("toCenter", "living"), s = ve("zoomout", "move"), r = ve("zoomin", "add"), o = document.createElement("input");
  o.className = "numberSelection", o.type = "number", o.min = "2", o.max = "100", o.step = "1", o.value = ((d = i == null ? void 0 : i.expandDeep) == null ? void 0 : d.toString()) || "2", o.oninput = co(() => {
    const f = i.getAllDataWithAutoHide();
    Qt(f == null ? void 0 : f.nodeData), i.layout(), i.linkDiv();
  }, 300);
...
function fo(i) {
  const e = document.createElement("toolbar"), t = ve("sidebar", "menu"), n = ve("tbltl", "left"), s = ve("tbltr", "right"), r = ve("tblts", "side");
  e.appendChild(t), e.appendChild(n), e.appendChild(s), e.appendChild(r), e.className = "lt", t.onclick = () => {
    ...
    ao(i, c), c.classList.contains("selected") ? c.removeAttribute("class") : c.setAttribute("class", "selected");
  }, n.onclick = () => {
    i.initLeft();
  }, s.onclick = () => {
    i.initRight();
...
function _o(i) {
  ...
  f.className = "list", Object.keys(d).forEach((y) => {
    ...
    for (let z = 1; z <= d[y]; z++) {
      ...
      B.className = "item", N.style.width = "100%", N.style.height = "100%", N.src = new URL((/* @__PURE__ */ Object.assign({ "../iconfont/icon/flag/flag1.webp": mo, "../iconfont/icon/flag/flag2.webp": yo, "../iconfont/icon/flag/flag3.webp": Po, "../iconfont/icon/flag/flag4.webp": wo, "../iconfont/icon/number/number1.webp": bo, "../iconfont/icon/number/number2.webp": xo, "../iconfont/icon/number/number3.webp": Ho, "../iconfont/icon/number/number4.webp": Ao, "../iconfont/icon/number/number5.webp": Do, "../iconfont/icon/number/number6.webp": zo, "../iconfont/icon/number/number7.webp": Lo, "../iconfont/icon/number/number8.webp": Oo, "../iconfont/icon/other/other1.webp": To, "../iconfont/icon/other/other10.webp": Xo, "../iconfont/icon/other/other11.webp": No, "../iconfont/icon/other/other12.webp": Mo, "../iconfont/icon/other/other13.webp": Bo, "../iconfont/icon/other/other14.webp": Co, "../iconfont/icon/other/other15.webp": So, "../iconfont/icon/other/other16.webp": jo, "../iconfont/icon/other/other17.webp": Eo, "../iconfont/icon/other/other2.webp": ko, "../iconfont/icon/other/other3.webp": Vo, "../iconfont/icon/other/other4.webp": Ro, "../iconfont/icon/other/other5.webp": Zo, "../iconfont/icon/other/other6.webp": Fo, "../iconfont/icon/other/other7.webp": qo, "../iconfont/icon/other/other8.webp": Io, "../iconfont/icon/other/other9.webp": Wo, "../iconfont/icon/portrait/portrait1.webp": Yo, "../iconfont/icon/portrait/portrait2.webp": Go, "../iconfont/icon/star/star1.webp": Uo, "../iconfont/icon/star/star2.webp": Jo, "../iconfont/icon/star/star3.webp": Ko }))[`../iconfont/icon/${y}/${y + z}.webp`], self.location).href, B.appendChild(N), L.appendChild(B), f.appendChild(B.cloneNode(!0));
    }
...
const It = document, $o = function(i, e) {
  if (!e)
    return Wt(i), i;
...
function ea(i) {
  ...
  i.map.addEventListener("dragstart", function(r) {
    e = r.target, e.parentNode.parentNode.style.opacity = "0.5", Ne.clear();
  }), i.map.addEventListener("dragend", async function(r) {
    r.target.style.opacity = "", Wt(n);
    const o = e.nodeObj;
    switch (t) {
      case "before":
  ...
  }), i.map.addEventListener("dragover", ci(function(r) {
    Wt(n);
    const o = It.elementFromPoint(
      r.clientX,
      r.clientY - 12
    );
    if (Bn(o, e)) {
...
function Ae({
  ...
  !O || (this.mindElixirBox = O, this.before = d || {}, this.nodeData = e.nodeData, this.linkData = e.linkData || {}, this.expandDeep = e == null ? void 0 : e.expandDeep, this.locale = n, this.contextMenuOption = a, this.contextMenu = o === void 0 ? !0 : o, this.toolBar = l === void 0 ? !0 : l, this.nodeMenu = c === void 0 ? !0 : c, this.keypress = u === void 0 ? !0 : u, this.closeButton = m === void 0 ? !1 : m, this.widthControll = P === void 0 ? !0 : P, this.mobileMenu = x, this.direction = e.direction !== void 0 ? e.direction : typeof t == "number" ? t : 1, this.draggable = s === void 0 ? !0 : s, this.newTopicName = f, this.editable = r === void 0 ? !0 : r, this.allowUndo = h === void 0 ? !0 : h, this.currentNode = null, this.currentLink = null, this.inputDiv = null, this.scaleVal = 1, this.tempDirection = null, this.primaryLinkStyle = g || 0, this.overflowHidden = p, this.primaryNodeHorizontalGap = v, this.primaryNodeVerticalGap = w, this.uploadButton = H === void 0 ? !0 : H, this.nodeDraggable = A === void 0 ? !0 : A, this.scrollContainer = D, this.bus = new ai(), this.bus.addListener("operation", (y) => {
    ...
    !y || (this.isUndo = !0, y.name === "moveNode" ? this.moveNode(
      Ee(y.obj.fromObj.id),
      Ee(y.obj.originParentId)
    ) : y.name === "removeNode" ? y.originSiblingId ? this.insertBefore(Ee(y.originSiblingId), y.obj) : this.addChild(Ee(y.originParentId), y.obj) : y.name === "addChild" || y.name === "copyNode" ? this.removeNode(Ee(y.obj.id)) : y.name === "finishEdit" ? this.setNodeTopic(Ee(y.obj.id), y.origin) : this.isUndo = !1);
  });
}
function _(i) {
...
Ae.prototype = {
  ...
  updateNodeTags: Br,
  updateNodeIcons: Cr,
  updateNodeHyperLink: Sr,
  updateNodeRemark: jr,
  processPrimaryNode: _r,
  setNodeTopic: Qr,
  createLink: $r,
  removeLink: eo,
  selectLink: to,
  hideLinkController: no,
  showLinkController: io,
  layout: Bi,
  linkDiv: so,
  createInputDiv: Ni,
  shapeTpc: Be,
  ...
  selectNode: rr,
  unselectNode: or,
  selectNextSibling: ar,
  selectPrevSibling: lr,
  selectFirstChild: cr,
  selectParent: ur,
  getAllDataString: hr,
  getAllData: fr,
  getAllDataWithAutoHide: dr,
  getAllDataMd: gr,
  scale: mr,
  toCenter: xr,
  toTopLeft: Hr,
  ...
  exportPng: sr,
  init: function(i, e) {
    i && (this.nodeData = i), e && (this.expandDeep = e), ce(this.nodeData), console.log("ME_version " + Ae.version), console.log(this), this.mindElixirBox.className.indexOf("mind-elixir") === -1 && (this.mindElixirBox.className += "mind-elixir"), this.mindElixirBox.innerHTML = "", this.container = ke.createElement("div"), this.container.className = "map-container", this.overflowHidden && (this.container.style.overflow = "hidden"), this.map = ke.createElement("div"), this.map.className = "map-canvas", this.map.setAttribute("tabindex", "0"), this.container.appendChild(this.map), this.mindElixirBox.appendChild(this.container), this.root = ke.createElement("root"), this.box = ke.createElement("children"), this.box.className = "mindbox", this.svg2nd = Je("svg2nd"), this.linkController = Je("linkcontroller"), this.P2 = ke.createElement("div"), this.P3 = ke.createElement("div"), this.P2.className = this.P3.className = "circle", this.line1 = un(0, 0, 0, 0), this.line2 = un(0, 0, 0, 0), this.linkController.appendChild(this.line1), this.linkController.appendChild(this.line2), this.linkSvgGroup = Je("topiclinks"), this.map.appendChild(this.root), this.map.appendChild(this.box), this.map.appendChild(this.svg2nd), this.map.appendChild(this.linkController), this.map.appendChild(this.linkSvgGroup), this.map.appendChild(this.P2), this.map.appendChild(this.P3), this.toolBar && vo(this), this.nodeMenu && _o(this), this.keypress && ta(this), lo(this), li() && this.mobileMenu ? na(this) : this.contextMenu && oo(this, this.contextMenuOption), this.draggable && ea(this), Kt(this.nodeData, 0, this.expandDeep || 2), this.layout(), this.linkDiv(), this.toTopLeft(), ro(this);
  }
};
Ae.LEFT = 0;
Ae.RIGHT = 1;
