...
function Oe(e) {
  ...
  t || (Ne(this.nodeData, e), this.layout(), this.linkDiv(), t = this.container.querySelector(`tpc[data-nodeid=me${e}]`)), t.scrollIntoView({ block: "center", behavior: "smooth" }), t.className = "blink", setTimeout(() => {
...
function Pt() {
  ...
  let y = se.querySelector(".topiclinks");
  return y && (z += `<g transform="translate(${E - M}, ${E - T})">${y.innerHTML}</g>`), z;
}
function Me(e) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    if (u.root)
      continue;
    let a = c.getBoundingClientRect(), p = l.offsetTop, f = l.offsetLeft, v = getComputedStyle(c), w = getComputedStyle(l), m = f + parseInt(w.paddingLeft) + parseInt(v.paddingLeft), g = p + parseInt(w.paddingTop) + parseInt(v.paddingTop) + parseInt(v.fontSize), z = p + parseInt(w.paddingTop) + parseInt(v.paddingTop), y = "";
    v.borderWidth != "0px" && (y = `<rect x="${f + 15}" y="${p}" rx="5px" ry="5px" width="${a.width}" height="${a.height}" style="fill: rgba(0,0,0,0); stroke:#444;stroke-width:1px;"></rect>`);
    let P = "";
    ...
    if (u.tags && u.tags.length) {
      let x = c.querySelectorAll(".tags > span");
      for (let X = 0; X < x.length; X++) {
        let d = x[X], A = d.getBoundingClientRect();
        h += `<rect x="${m}" y="${g + 4}" rx="5px" ry="5px" width="${A.width}" height="${A.height}" style="fill: #d6f0f8;"></rect>
          <foreignObject x="${m}" y="${g + 4}" rx="5px" ry="5px" width="${A.width}" height="${A.height}" > 
    ...
    if (u.icons && u.icons.length) {
      let x = c.querySelectorAll(".icons > span");
      for (let X = 0; X < x.length; X++) {
        let d = x[X];
    ...
    if (u.image && u.image.length) {
      let x = c.querySelectorAll(".image");
      for (let X = 0; X < x.length; X++) {
        let d = x[X];
...
const un = function(e, t, n, i) {
  ...
  const m = {
    ...
    w: o.width,
    h: o.height
  }, z = ve(m, p, f), y = z.x, P = z.y, h = Pe(g, v, w), H = h.x, D = h.y, x = Le(v, w, H, D), X = tt(
    `M ${y} ${P} C ${p} ${f} ${v} ${w} ${H} ${D}`,
    `M ${x.x1} ${x.y1} L ${H} ${D} L ${x.x2} ${x.y2}`
  );
  let d;
  n ? (d = {
    id: i.id,
...
function wn(e) {
  ...
  if (this.direction === 2) {
    ...
    for (let D = 0; D < s.length; D++) {
      const x = s[D];
      x.className === "lhs" ? (a += x.offsetHeight + n, h += x.offsetHeight, y += 1) : (p += x.offsetHeight + n, H += x.offsetHeight, P += 1);
    }
    a > p ? (f = 1e4 - Math.max(a) / 2, o = "r", c = (a - H) / (P - 1)) : (f = 1e4 - Math.max(p) / 2, o = "l", c = (p - h) / (y - 1));
  } else {
    for (let y = 0; y < s.length; y++)
      r += s[y].offsetHeight + n;
    f = 1e4 - r / 2;
  }
  let v = "";
  ...
  for (let y = 0; y < s.length; y++) {
    let P, h;
    const H = s[y], D = H.offsetHeight;
    let x = i.offsetLeft - 10;
    if (H.className === "lhs") {
      H.style.top = f + l + "px", H.style.left = w - H.offsetWidth + "px", P = w - 15, h = f + l + D / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 - i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}`) : v += `M 10000 10000 H ${x} V ${h} H ${P}`, o === "l" ? l += D + c : l += D + n;
    } else {
      x = i.offsetLeft + i.offsetWidth + 10, H.style.top = f + u + "px", H.style.left = m + "px", P = m + 15, h = f + u + D / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 + i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}`) : v += `M 10000 10000 H ${x} V ${h} H ${P}`, o === "r" ? u += D + c : u += D + n;
    }
  ...
  for (let y = 0; y < s.length; y++) {
    const P = s[y];
    if (!(e && e !== s[y]) && P.childElementCount) {
      ...
      let x;
      ((z = (g = P.children) == null ? void 0 : g[2]) == null ? void 0 : z.tagName) === "SMYCHILDREN" ? x = [...P.children[1].children, ...P.children[2].children] : x = P.children[1].children, Y = "", ce = "", Ce(x, D, this.nodeData.children[y], !0), h.appendChild(et(Y)), ce.length > 0 && (P.appendChild(H), H.appendChild(_e(ce)));
    }
  }
  this.linkSvgGroup.innerHTML = "";
  for (const y in this.linkData) {
    const P = this.linkData[y];
...
function Hn(e, t) {
  ...
  e.container.oncontextmenu = function(P) {
    ...
    const h = P.target;
    if (h.tagName === "TPC") {
      h.parentElement.tagName === "ROOT" ? y = !0 : y = !1, y ? (u.className = "disabled", p.className = "disabled", f.className = "disabled", c.className = "disabled", l.className = "disabled") : (u.className = "", p.className = "", f.className = "", c.className = "", l.className = ""), e.selectNode(h), z.hidden = !1;
    ...
    y || (e.insertSibling(), z.hidden = !0);
  }, l.onclick = (P) => {
    y || (e.removeNode(), z.hidden = !0);
  }, u.onclick = (P) => {
    y || (e.focusNode(e.currentNode), z.hidden = !0);
  }, a.onclick = (P) => {
    e.cancelFocus(), z.hidden = !0;
  }, p.onclick = (P) => {
    y || (e.moveUpNode(), z.hidden = !0);
  }, f.onclick = (P) => {
    y || (e.moveDownNode(), z.hidden = !0);
  }, v.onclick = (P) => {
    z.hidden = !0;
...
function An(e) {
  ...
  return new IntersectionObserver((u) => {
    ...
    (u) => {
      ...
      a > v ? (t.style.position = "absolute", t.style.top = v - p + 20 + "px", t.style.left = "20px") : a >= p ? (t.style.position = "fixed", t.style.top = "20px", t.style.left = c + 20 + "px") : a < p && (t.style.position = "absolute", t.style.top = "20px", t.style.left = "20px");
    }
  ), t;
}
function yn(e) {
...
function di(e) {
  ...
  <use xlink:href="#icon-B"></use>
      ...
      <div class="nm-fontcolor-container">
        ${li.map((d) => {
    let A = d;
    return d === "#f6f6f6" && (A = ""), `<div class="split6"><div class="palette" data-color="${A}" style="background-color: ${d};"></div></div>`;
  }).join("")}
      </div>
      <div class="bof">
  ...
  ["\u5168\u90E8", "\u65D7\u6746", "\u6570\u5B57", "\u5176\u4ED6", "\u4EBA\u50CF", "\u661F\u661F"].forEach((d, A) => {
    const b = V();
    b.className = "box", A === 0 && (b.className = "box active"), b.innerText = d, b.onclick = () => {
      [...l.children[0].children].forEach((O) => {
        O.className = "box";
      }), b.className = "box active", u.style.transform = `translateX(${-(A * 275)}px)`;
  ...
  const g = w.querySelectorAll(".size"), z = w.querySelector(".bold"), y = w.querySelector(".button-container"), P = w.querySelector(".font"), h = e.container.querySelector(".nm-tag"), H = e.container.querySelector(".nm-icon"), D = e.container.querySelector(".nm-link"), x = e.container.querySelector(".nm-remark");
  w.onclick = (d) => {
    if (!e.currentNode)
      return;
    const A = e.currentNode.nodeObj, b = d.target;
    b.className === "palette" ? (A.style || (A.style = {}), m(".palette", "nmenu-selected"), b.className = "palette nmenu-selected", n === "font" ? A.style.color = b.dataset.color : n === "background" && (A.style.background = b.dataset.color), e.updateNodeStyle(A)) : b.className === "background" ? (m(".palette", "nmenu-selected"), n = "background", b.className = "background selected", b.previousElementSibling.className = "font", A.style && A.style.background && (w.querySelector(
      '.palette[data-color="' + A.style.background + '"]'
    ).className = "palette nmenu-selected")) : b.className === "font" && (m(".palette", "nmenu-selected"), n = "font", b.className = "font selected", b.nextElementSibling.className = "background", A.style && A.style.color && (w.querySelector(
    ...
    if (!!e.currentNode && (d.target.value !== null || d.target.value !== void 0)) {
      ...
      e.updateNodeHyperLink(e.currentNode.nodeObj, A);
    }
  }, x.onchange = (d) => {
    if (!!e.currentNode && (d.target.value !== null || d.target.value !== void 0)) {
      const A = d.target.value;
      e.updateNodeRemark(e.currentNode.nodeObj, A);
    }
  };
  let X = "open";
  y.onclick = (d) => {
    X === "open" ? (X = "close", w.className = "close", y.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-menu"></use></svg>') : (X = "open", w.className = "", y.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-close"></use></svg>');
  }, e.bus.addListener("unselectNode", function() {
    w.hidden = !0;
  }), e.bus.addListener("selectNode", function(d, A) {
    if (!!A) {
      ...
      d.tags ? h.value = d.tags.join(",") : h.value = "", d.icons ? H.innerHTML = d.icons : H.innerText = "", D.value = "", d.hyperLink && (D.value = d.hyperLink), d.linkJump && (D.value.length > 0 && (D.value += ","), D.value += d.linkJump.map((b) => b.title).reduce((b, O, k) => b + (k ? "," : "") + O, "")), d.remark ? x.value = d.remark : x.value = "", l.style.display = "none";
    }
  });
}
const he = document, ai = function(e, t) {
  if (!t)
    return pe(e), e;
...
function ui(e) {
  ...
  e.map.onkeydown = (n) => {
    n.preventDefault(), !!e.editable && n.target === n.currentTarget && (n.keyCode === 8 || n.keyCode === 46 ? e.currentLink ? e.removeLink() : e.removeNode() : t[n.keyCode] && t[n.keyCode](n));
  }, e.map.onkeyup = (n) => {
...
function G({
  ...
  !X || (this.mindElixirBox = X, this.before = p || {}, this.nodeData = t.nodeData, this.linkData = t.linkData || {}, this.expandDeep = t == null ? void 0 : t.expandDeep, this.locale = i, this.contextMenuOption = c, this.contextMenu = o === void 0 ? !0 : o, this.toolBar = l === void 0 ? !0 : l, this.nodeMenu = u === void 0 ? !0 : u, this.keypress = a === void 0 ? !0 : a, this.closeButton = P === void 0 ? !1 : P, this.widthControll = h === void 0 ? !0 : h, this.mobileMenu = y, this.direction = t.direction !== void 0 ? t.direction : typeof n == "number" ? n : 1, this.draggable = s === void 0 ? !0 : s, this.newTopicName = f, this.editable = r === void 0 ? !0 : r, this.allowUndo = v === void 0 ? !0 : v, this.currentNode = null, this.currentLink = null, this.inputDiv = null, this.scaleVal = 1, this.tempDirection = null, this.primaryLinkStyle = w || 0, this.overflowHidden = m, this.primaryNodeHorizontalGap = g, this.primaryNodeVerticalGap = z, this.uploadButton = H === void 0 ? !0 : H, this.nodeDraggable = D === void 0 ? !0 : D, this.scrollContainer = x, this.bus = new Ze(), this.bus.addListener("operation", (d) => {
    if (this.isUndo) {
      this.isUndo = !1;
      return;
    }
