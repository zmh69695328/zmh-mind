var Re = typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
Re.SENTRY_RELEASE = { id: "97c29705bf748a2e1d6e85b6df9ad9c5f4a57e86" };
const G = 0, ee = 1, U = 2, Pe = 15, We = 65, Ye = 25;
function pe(e) {
  return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/"/g, "&quot;");
}
const Ge = () => /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
), ye = (e) => e.replace(
  /\brgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/g,
  function(t, n, i, s) {
    return "#" + ("0" + Number(n).toString(16)).substr(-2) + ("0" + Number(i).toString(16)).substr(-2) + ("0" + Number(s).toString(16)).substr(-2);
  }
), Ne = function(e, t) {
...
const Je = (e, t) => {
  var n = Date.now();
  return function() {
    var i = this, s = arguments, r = Date.now();
    r - n >= t && (e.apply(i, s), n = Date.now());
  };
};
function Be(e, t, n, i) {
  const s = i - t, r = e - n;
  ...
  return {
    ...
    y1: i - Math.sin(Math.PI * u / 180) * c,
    x2: n + Math.cos(Math.PI * a / 180) * c,
    y2: i - Math.sin(Math.PI * a / 180) * c
  };
}
function we(e, t, n) {
  let i, s;
  const r = (e.cy - n) / (t - e.cx);
  return r > e.h / e.w || r < -e.h / e.w ? e.cy - n < 0 ? (i = e.cx - e.h / 2 / r, s = e.cy + e.h / 2) : (i = e.cx + e.h / 2 / r, s = e.cy - e.h / 2) : e.cx - t < 0 ? (i = e.cx + e.w / 2, s = e.cy - e.w * r / 2) : (i = e.cx - e.w / 2, s = e.cy + e.w * r / 2), {
    x: i,
    y: s
  };
}
...
function nt(e, t) {
  fe(e), t.children ? t.children.push(e) : t.children = [e];
}
function it(e, t) {
  fe(e);
...
oe.prototype.init = function(e, t) {
  this.handleMouseMove = (n) => {
    if (n.stopPropagation(), this.mousedown) {
      ...
      const i = this.lastX - n.pageX, s = this.lastY - n.pageY;
      t(i, s), this.lastX = n.pageX, this.lastY = n.pageY;
    }
...
oe.prototype.destory = function(e) {
...
const C = document, Z = "http://www.w3.org/2000/svg", rt = function(e) {
  const t = C.createElementNS(Z, "path");
  ...
  const t = C.createElementNS(Z, "svg");
  ...
  const s = C.createElementNS(Z, "line");
  return s.setAttribute("x1", e.toString()), s.setAttribute("y1", t.toString()), s.setAttribute("x2", n.toString()), s.setAttribute("y2", i.toString()), s.setAttribute("stroke", "#bbb"), s.setAttribute("fill", "none"), s.setAttribute("stroke-width", "2"), s;
}, ct = function(e) {
  const t = C.createElementNS(Z, "path");
  ...
  const n = C.createElementNS(Z, "g"), i = C.createElementNS(Z, "path"), s = C.createElementNS(Z, "path");
...
}, dt = function(e = 10, t = 10, n) {
  const i = C.createElementNS(Z, "svg"), s = C.createElementNS(Z, "g"), r = C.createElementNS(Z, "rect");
  r.setAttribute("width", e.toString()), r.setAttribute("height", t.toString()), r.setAttribute("stroke", "#2ebdff"), r.setAttribute("stroke-width", "2"), r.setAttribute("fill", "none"), i.setAttribute("class", "line"), r.setAttribute("x", "1"), r.setAttribute("y", "1"), s.appendChild(r);
  const o = C.createElementNS(Z, "rect");
  return o.setAttribute("width", "6"), o.setAttribute("height", "6"), o.setAttribute("stroke", "#2ebdff"), o.setAttribute("stroke-width", "2"), o.setAttribute("fill", "white"), o.setAttribute("x", (e - 3).toString()), o.setAttribute("y", (t - 3).toString()), o.setAttribute("class", "resize"), s.appendChild(o), i.appendChild(s), i.style.width = n.clientWidth + 5 + "px", i.style.height = n.clientHeight + 5 + "px", o.onpointerdown = function(c) {
    const l = Number(r.getAttribute("width")), u = Number(r.getAttribute("height"));
    let a = c.clientX, p = c.clientY;
    f(c.pageX, c.pageY);
    function f(w, m) {
      const g = l + w - a, z = u + m - p;
      r.setAttribute("width", g.toString()), r.setAttribute("height", z.toString()), o.setAttribute("x", (g - 3).toString()), o.setAttribute("y", (z - 3).toString()), i.style.width = g + 5 + "px", i.style.height = z + 5 + "px", n.style.width = g + "px", n.style.height = z + "px";
    }
    function v(w) {
      f(w.pageX, w.pageY);
    }
    o.onpointermove = v, o.onpointerup = function(w) {
      o.onpointermove = null, o.onpointerup = null, o.releasePointerCapture(w.pointerId);
    }, c.stopPropagation(), c.preventDefault(), o.setPointerCapture(c.pointerId);
  }, o.ondragstart = function() {
    return !1;
  }, i;
}, N = document, j = (e, t) => (t ? t.mindElixirBox : N).querySelector(`[data-nodeid=me${e}]`);
function Ae(e, t, n) {
  e.onpointerdown = (i) => {
    if (!t.classList.contains("selected"))
      return;
    const s = i.clientX, r = t.clientWidth - Number(getComputedStyle(t).paddingLeft.replace("px", "")) - Number(getComputedStyle(t).paddingRight.replace("px", ""));
    e.onpointermove = (o) => {
      const c = o.clientX;
      t.style.width = (r + c - s).toString() + "px", e.style.height = n.style.height = t.clientHeight.toString() + "px", t.nodeObj.style || (t.nodeObj.style = {}), t.nodeObj.style.width = t.style.width, t.nodeObj.style.controllWidth = e.style.height, o.preventDefault();
    }, e.setPointerCapture(i.pointerId), i.preventDefault();
  }, e.onpointerup = (i) => {
    var s;
    e.onpointermove = null, e.releasePointerCapture(i.pointerId), (s = this == null ? void 0 : this.linkDiv) == null || s.call(this);
  };
}
const Q = function(e, t) {
  var s;
  const n = N.createElement("widthControllRight"), i = N.createElement("widthControllLeft");
  if (e.textContent = t.topic, this != null && this.widthControll && (Ae.call(this, i, e, n), Ae.call(this, n, e, i), e.appendChild(n), e.appendChild(i)), t.style && (e.style.color = t.style.color || "#2c3e50", e.style.background = t.style.background ? t.style.background : (s = t == null ? void 0 : t.parent) != null && s.root ? "#ffffff" : "inherit", /[a-z]/i.test(t.style.fontSize) ? e.style.fontSize = t.style.fontSize : e.style.fontSize = t.style.fontSize + "px", e.style.fontWeight = t.style.fontWeight || "normal", e.style.width = t.style.width || "fit-content", setTimeout(() => {
  ...
  if (t.linkJump && t.linkJump.forEach((r) => {
    ...
    r.className = "content hidden", r.textContent = t.remark;
  ...
  if (t.image && t.image.forEach((o) => {
    const c = N.createElement("img");
    c.className = "image", c.src = o.url, c.style.width = o.width + "px", c.style.height = o.height + "px", c.style.display = "block", e.appendChild(c);
  }), t.tags) {
    const r = N.createElement("div");
    r.className = "tags", r.innerHTML = t.tags.filter((o) => o !== "").map((o) => `<span>${pe(o)}</span>`).join(""), e.appendChild(r);
  }
};
function Te(e) {
  let t = this.container.querySelector(`tpc[data-nodeid=me${e}]`);
  t || (Me(this.nodeData, e), this.layout(), this.linkDiv(), t = this.container.querySelector(`tpc[data-nodeid=me${e}]`)), t.scrollIntoView({ block: "center", behavior: "auto" }), t.className = "blink", setTimeout(() => {
...
const at = function(e, t) {
  const n = N.createElement("GRP"), i = this.createTop(e);
  if (n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(ne(e.expanded)), e.expanded !== !1)) {
    const [s, r] = this.createChildren(e.children);
    n.appendChild(s);
  }
  return { grp: n, top: i };
}, ft = function(e, t) {
  const n = N.createElement("SMY"), i = this.createTop(e);
  return n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(ne(e.expanded)), e.expanded !== !1 && this.createChildren(e.children)), { smy: n, top: i };
}, ut = function(e) {
  const t = N.createElement("t"), n = this.createTopic(e);
  return Q.call(this, n, e), t.appendChild(n), t;
}, vt = function(e) {
  const t = N.createElement("tpc");
...
function ht(e) {
  ...
  e.nodeObj.icons ? n = e.childNodes[1].textContent : n = e.childNodes[0].textContent, e.appendChild(t), t.id = "input-box", t.contentEditable = "true", t.spellcheck = !1, t.textContent = n, t.draggable = !1, e.nodeObj.image && e.nodeObj.image.forEach((p) => {
    ...
    const v = dt(f.clientWidth, f.clientHeight, f);
    t.insertBefore(v, f);
  }), t.style.cssText = `min-width:${e.offsetWidth - 22}px;min-height:${e.clientHeight - 16}px`, (s = (i = e.nodeObj) == null ? void 0 : i.style) != null && s.width && (t.style.width = "auto"), (((o = (r = e.nodeObj) == null ? void 0 : r.style) == null ? void 0 : o.color) === "#ffffff" || ((c = e.nodeObj) == null ? void 0 : c.id) === "root" && !((u = (l = e.nodeObj) == null ? void 0 : l.style) != null && u.color)) && (t.style.color = "#2c3e50"), this.direction === G && (t.style.right = "0"), t.focus(), Pt(t), this.inputDiv = t, this.bus.fire("operation", {
    name: "beginEdit",
    obj: e.nodeObj
    ...
    if (p === "Enter" || p === "Tab") {
      if (a.shiftKey)
        return;
      a.preventDefault(), this.inputDiv.blur(), this.map.focus();
    }
  }), t.addEventListener("blur", () => {
    var m, g;
    if (!t)
      return;
    const a = e.nodeObj, p = t.textContent.trim(), f = (g = (m = a.image) == null ? void 0 : m.length) != null ? g : 0;
    if (a.image = [], t.childNodes.forEach((z) => {
      z.nodeName === "IMG" && a.image.push({
        url: z.src,
        width: z.width,
        height: z.height
      });
    }), p === "" && a.image.length === 0 ? a.topic = n : a.topic = p, t.remove(), this.inputDiv = t = null, p === n && f === a.image.length && f === 0)
      return;
    a.image.length === 0 && delete a.image, e.childNodes[0].textContent = a.topic;
    const v = e.querySelector("widthControllRight"), w = e.querySelector("widthControllRight");
    a.style || (a.style = {}), a.style.controllWidth = v.style.height = w.style.height = e.clientHeight.toString() + "px", delete a.style.width, this.shapeTpc(e, a), this.linkDiv(), ke.call(this, this.nodeData, a.id, a.topic), this.bus.fire("operation", {
      name: "finishEdit",
      obj: a,
      origin: n
    });
...
function ke(e, t, n) {
  var i;
  (i = e == null ? void 0 : e.linkJump) == null || i.forEach(({ toId: s }, r) => {
    if (s === t) {
      e.linkJump[r].title = n;
      const o = this.container.querySelector(`tpc[data-nodeid=me${e.id}] .linkJump`);
      o.title = n;
    }
  });
...
const ne = function(e) {
  const t = N.createElement("epd");
  return t.innerText = e !== !1 ? "-" : "+", t.expanded = e !== !1, t.className = e !== !1 ? "minus" : "", t;
};
function pt(e, t, n) {
  let i;
  t ? i = t : i = N.createElement("children");
  let s = [];
  for (let r = 0; r < e.length; r++) {
    const o = e[r];
    if ((o == null ? void 0 : o.type) === "summary") {
      const { smy: u } = this.createSummary(o);
      if (o.children && o.children.length > 0 && o.expanded !== !1) {
        const [a, p] = this.createChildren(o.children);
        u.appendChild(a), p && p.forEach((f) => {
          u.appendChild(f);
        });
      }
      s.push(u);
    ...
    const c = N.createElement("GRP");
    n === G ? c.className = "lhs" : n === ee ? c.className = "rhs" : n === U && (o.direction === G ? c.className = "lhs" : o.direction === ee && (c.className = "rhs"));
    const l = this.createTop(o);
    if (o.children && o.children.length > 0) {
      if (l.appendChild(ne(o.expanded)), c.appendChild(l), o.expanded !== !1) {
        const [u, a] = this.createChildren(o.children);
        c.appendChild(u), a && a.forEach((p) => {
          var f;
          (f = c.children) != null && f[2] || c.appendChild(N.createElement("smychildren")), c.children[2].appendChild(p);
        });
      }
    } else
      c.appendChild(l);
...
function wt() {
  ...
  Q.call(this, e, this.nodeData), e.draggable = !1, this.root.appendChild(e);
  const t = this.nodeData.children;
  if (!(!t || t.length === 0)) {
    if (this.direction === U) {
      let n = 0, i = 0;
      t.map((s) => {
        s.direction === void 0 ? n <= i ? (s.direction = G, n += 1) : (s.direction = ee, i += 1) : s.direction === G ? n += 1 : i += 1;
      });
    }
    this.createChildren(this.nodeData.children, this.box, this.direction), console.timeEnd("layout");
  }
}
let ce = document, T = 1e4, F = 1e4, M = 1e4, S = 1e4, E = 40, gt = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
function Ce() {
  T = 1e4, F = 1e4, M = 1e4, S = 1e4, E = 40;
}
function Ze() {
  Ce();
  let e = ce.querySelectorAll(".mindbox > grp, root"), t = "";
  for (let r = 0; r < e.length; r++) {
    let o = e[r], c = o.getBoundingClientRect(), l = o.offsetTop, u = l + c.height, a = o.offsetLeft, p = a + c.width;
    l < T && (T = l), u > F && (F = u), a < M && (M = a), p > S && (S = p), t += Ve(o);
  }
  console.log(T, F, M, S), t += zt();
  let n = F - T + E * 2, i = S - M + E * 2, s = bt(n, i);
  return t = `<rect x="0" y="0" width="${i}" height="${n}" fill="#f6f6f6"></rect>` + t, s.innerHTML = t, s;
}
function Ht() {
  ce = this.container, Ce();
  let e = ce.querySelectorAll(".mindbox > grp, root"), t = "";
  for (let s = 0; s < e.length; s++) {
    let r = e[s], o = r.getBoundingClientRect(), c = r.offsetTop, l = c + o.height, u = r.offsetLeft, a = u + o.width;
    c < T && (T = c), l > F && (F = l), u < M && (M = u), a > S && (S = a), t += Ve(r);
  }
  console.log(T, F, M, S);
  let n = F - T, i = S - M;
...
function zt() {
  let e = document.querySelector("root"), t = document.querySelector("root > tpc"), n = t.getBoundingClientRect(), i = getComputedStyle(t), s = t.parentNode, r = 0, o = 0, c = document.querySelector("root > tpc").nodeObj, l = getComputedStyle(s), u = e.offsetTop - T, a = e.offsetLeft - M, p = o + parseInt(l.paddingLeft) + parseInt(n.paddingLeft), f = r + parseInt(l.paddingTop) + parseInt(n.paddingTop) + parseInt(n.fontSize);
  r + parseInt(l.paddingTop) + parseInt(n.paddingTop);
  let v = document.querySelector(".svg2nd"), w = "";
  if (c.tags && c.tags.length) {
    let P = t.querySelectorAll(".tags > span");
    for (let h = 0; h < P.length; h++) {
      let H = P[h], D = H.getBoundingClientRect();
      w += `<rect x="${p}" y="${f + 4}" rx="5px" ry="5px" width="${D.width}" height="${D.height}" style="fill: #d6f0f8;"></rect>
        <foreignObject x="${p}" y="${f + 4}" rx="5px" ry="5px" width="${D.width}" height="${D.height}" > 
  ...
  if (c.image && c.image.length) {
    ...
    for (let h = 0; h < P.length; h++) {
      let H = P[h];
      H.getBoundingClientRect(), g += `${H.outerHTML}`;
    }
  }
  let z = `<g transform="translate(${E - M}, ${E - T})">${v.innerHTML}</g>`;
  z += `<g id="root" transform="translate(${a + E}, ${u + E})">
      <rect x="${o}" y="${r}" rx="5px" ry="5px" width="${n.width}" height="${n.height}" style="fill: #00aaff;"></rect>
      <foreignObject x="${o + 15}" y="${r + 10}" width="${i.width}" height="${i.height}" ">
  ...
  let x = ce.querySelector(".topiclinks");
  return x && (z += `<g transform="translate(${E - M}, ${E - T})">${x.innerHTML}</g>`), z;
}
function Ve(e) {
  let t = e.querySelectorAll("tpc"), n = e.offsetTop - T, i = e.offsetLeft - M, s = "", r = e.querySelector(".svg3rd");
  s += `<g transform="translate(${i + E}, ${n + E})">`, s += r ? r.innerHTML : "";
  for (let o = 0; o < t.length; o++) {
    let c = t[o], l = c.parentNode, u = c.nodeObj;
    if (u.root)
      continue;
    let a = c.getBoundingClientRect(), p = l.offsetTop, f = l.offsetLeft, v = getComputedStyle(c), w = getComputedStyle(l), m = f + parseInt(w.paddingLeft) + parseInt(v.paddingLeft), g = p + parseInt(w.paddingTop) + parseInt(v.paddingTop) + parseInt(v.fontSize), z = p + parseInt(w.paddingTop) + parseInt(v.paddingTop), x = "";
    v.borderWidth != "0px" && (x = `<rect x="${f + 15}" y="${p}" rx="5px" ry="5px" width="${a.width}" height="${a.height}" style="fill: rgba(0,0,0,0); stroke:#444;stroke-width:1px;"></rect>`);
    let P = "";
    v.backgroundColor != "rgba(0, 0, 0, 0)" && (P = `<rect x="${f + 15}" y="${p}" rx="5px" ry="5px" width="${a.width}" height="${a.height}" style="fill: ${v.backgroundColor};"></rect>`);
    let h = "";
    if (u.tags && u.tags.length) {
      let A = c.querySelectorAll(".tags > span");
      for (let X = 0; X < A.length; X++) {
        let d = A[X], y = d.getBoundingClientRect();
        h += `<rect x="${m}" y="${g + 4}" rx="5px" ry="5px" width="${y.width}" height="${y.height}" style="fill: #d6f0f8;"></rect>
          <foreignObject x="${m}" y="${g + 4}" rx="5px" ry="5px" width="${y.width}" height="${y.height}" > 
            <div sytle="font-size:12px">${d.innerHTML}</div>
          </foreignObject>`;
      }
    }
    let H = "";
    if (u.icons && u.icons.length) {
      let A = c.querySelectorAll(".icons > span");
      for (let X = 0; X < A.length; X++) {
        let d = A[X];
    ...
    let D = "";
    if (u.image && u.image.length) {
      let A = c.querySelectorAll(".image");
      for (let X = 0; X < A.length; X++) {
        let d = A[X];
        d.getBoundingClientRect(), D += `${d.outerHTML}`;
      }
    }
    s += `<g id="${u.id}">
      ${x}
      ${P}
      <foreignObject  x="${m}" y="${z}" width="${v.width}" height="${v.height}">
      <div xmlns="http://www.w3.org/1999/xhtml" style="padding:0;margin:0;font-family:\u5FAE\u8F6F\u96C5\u9ED1;font-size:${v.fontSize};font-weight:${v.fontWeight};color:${v.color};word-break: break-all;line-height: 1">
        ${u.topic}
        ${H}
        ${D}
      </div>
...
let Dt = function() {
  let e = Ze(), t = URL.createObjectURL(
    new Blob([gt + e.outerHTML.replace(/&nbsp;/g, " ")])
  ), n = document.createElement("a");
  n.href = t, n.download = "me-mindmap.svg", n.click();
}, mt = function(e = this, t = "default") {
  return ce = e.container, Ze();
};
function ue(e) {
...
const yt = function(e, t, n) {
  if (!!e) {
    ...
    if (this.ctrlRepeat ? (e.className === "selected" ? e.className = "" : e.className = "selected", console.log(this.currentSummaryNodeArr)) : (this.currentNode && (this.currentNode.className = ""), e.className = "selected"), this != null && this.widthControll) {
      ...
      const s = e.querySelector("widthControllLeft");
  ...
  if (n.className === "rhs" || n.className === "lhs") {
    const i = this.mindElixirBox.querySelectorAll("." + n.className), s = Array.from(i).indexOf(n);
    if (s + 1 < i.length)
      t = i[s + 1].firstChild.firstChild;
    else
      return !1;
  } else if (e)
...
const Bt = function() {
  ...
  return ze(t.nodeData, 0, e), JSON.parse(
...
`;
  function n(i, s) {
    for (let r = 0; r < i.length; r++)
      s <= 6 ? t += "".padStart(s, "#") + " " + i[r].topic + `

` : t += "".padStart(s - 7, "	") + "- " + i[r].topic + `
`, i[r].children && n(i[r].children, s + 1);
  }
...
function Et(e, t) {
  var s, r;
  const n = ((s = e == null ? void 0 : e.getBoundingClientRect()) == null ? void 0 : s.top) || 0, i = ((r = t == null ? void 0 : t.getBoundingClientRect()) == null ? void 0 : r.top) || n;
  return Math.abs(n - i);
}
function qt(e) {
...
const Ft = function() {
  ...
  ((e = this.nodeData) == null ? void 0 : e.children.length) > 0 ? this.container.scrollTo(
    1e4 - Zt(this.container) / 2 - 10,
    1e4 - Vt(this.container) / 2 - qt(this.container) - 5
  ) : this.container.scrollTo(
    1e4 - this.container.offsetWidth / 2,
    1e4 - this.container.offsetHeight / 2
  );
...
const te = document, Qt = function(e) {
  if (!e.style)
    return;
  const t = j(e.id, this), n = {
  ...
  const i = j(e.id);
  Q.call(this, i, e), this.linkDiv(), this.bus.fire("operation", {
    name: "editTags",
    obj: e,
    origin: n
  });
  ...
  e.linkJump = (r = e.linkJump) == null ? void 0 : r.filter((l) => !!i.find((u) => u === l.title)), ((o = e.linkJump) == null ? void 0 : o.length) === 0 && delete e.linkJump, e.hyperLink = i.filter((l) => {
    var u;
    return l !== "" && !((u = e.linkJump) != null && u.find((a) => a.title === l));
  }), ((c = e.hyperLink) == null ? void 0 : c.length) === 0 && delete e.hyperLink;
  const s = j(e.id);
  Q.call(this, s, e), this.linkDiv(), this.bus.fire("operation", {
    name: "editHyperLink",
    obj: e,
    origin: n
  });
  ...
  _e(i, s), q(this.nodeData);
  const r = n.parentElement;
  console.time("insertSibling_DOM");
  const { grp: o, top: c } = this.createGroup(s), l = r.parentNode.parentNode;
  l.insertBefore(o, r.parentNode.nextSibling), l.className === "mindbox" ? (this.processPrimaryNode(o, s), this.linkDiv()) : this.linkDiv(o.offsetParent), t || this.createInputDiv(c.children[0]), this.selectNode(c.children[0], !0), console.timeEnd("insertSibling_DOM"), this.bus.fire("operation", {
    name: "insertSibling",
    obj: s
  });
}, sn = function(e, t) {
  ...
  const s = t || this.generateNewObj();
  et(i, s), q(this.nodeData);
  const r = n.parentElement;
  console.time("insertSibling_DOM");
  const { grp: o, top: c } = this.createGroup(s), l = r.parentNode.parentNode;
  l.insertBefore(o, r.parentNode), l.className === "mindbox" ? (this.processPrimaryNode(o, s), this.linkDiv()) : this.linkDiv(o.offsetParent), t || this.createInputDiv(c.children[0]), this.selectNode(c.children[0], !0), console.timeEnd("insertSibling_DOM"), this.bus.fire("operation", {
    name: "insertSibling",
    obj: s
  });
}, rn = function(e, t) {
  ...
  if (i.root === !0)
    return;
  const s = t || this.generateNewObj();
  tt(i, s), q(this.nodeData);
  const r = n.parentElement.parentElement;
  console.time("insertParent_DOM");
  const { grp: o, top: c } = this.createGroup(s, !0);
  c.appendChild(ne(!0));
  const l = r.parentNode;
  r.insertAdjacentElement("afterend", o);
  const u = te.createElement("children");
  u.appendChild(r), c.insertAdjacentElement("afterend", u), l.className === "mindbox" ? (o.className = r.className, r.className = "", r.querySelector(".svg3rd").remove(), this.linkDiv()) : this.linkDiv(o.offsetParent), t || this.createInputDiv(c.children[0]), this.selectNode(c.children[0], !0), console.timeEnd("insertParent_DOM"), this.bus.fire("operation", {
    name: "insertParent",
    obj: s
  });
}, on = function(e, t) {
  ...
  n.parent.children.push(i), q(this.nodeData);
  const s = e.parentNode.parentNode.parentNode.parentNode, { smy: r, top: o } = this.createSummary(i);
  if (!((c = s.children) != null && c.smychildren)) {
    const l = te.createElement("smychildren");
    l.setAttribute("name", "smychildren"), s.appendChild(l);
  }
  return s.children.smychildren.appendChild(r), this.layout(), this.linkDiv(), { newTop: o, newNodeObj: i };
}, Ee = function(e, t) {
  if (!e)
    return;
  const n = e.nodeObj;
  n.expanded === !1 && (this.expandNode(e, !0), e = j(n.id));
  const i = t || this.generateNewObj();
  n.children ? n.children.push(i) : n.children = [i], q(this.nodeData);
  const s = e.parentElement, { grp: r, top: o } = this.createGroup(i);
  if (s.tagName === "T") {
    if (s.children[1])
      s.nextSibling.appendChild(r);
    else {
      const c = te.createElement("children");
      c.appendChild(r), s.appendChild(ne(!0)), s.insertAdjacentElement("afterend", c);
    }
    this.layout(), this.linkDiv(r.offsetParent);
  } else
    s.tagName === "ROOT" && (this.processPrimaryNode(r, i), s.nextSibling.appendChild(r), this.linkDiv());
  return { newTop: o, newNodeObj: i };
}, cn = function(e, t) {
  console.time("addSummary");
  const n = {}, i = [];
  this.container.querySelectorAll("tpc.selected").forEach((s) => {
    var r, o;
    (r = n[s.nodeObj.parent.id]) != null || (n[s.nodeObj.parent.id] = i.length), i[n[s.nodeObj.parent.id]] = (o = i[n[s.nodeObj.parent.id]]) != null ? o : [], i[n[s.nodeObj.parent.id]].push(s);
  }), console.log(i), i.forEach((s) => {
    var l, u, a;
    const r = s[0] || this.currentNode;
    if (this.currentSummaryNodeArr = s, !r || ((a = (u = (l = r == null ? void 0 : r.parentElement) == null ? void 0 : l.parentElement) == null ? void 0 : u.parentElement) == null ? void 0 : a.className) == "mindbox")
      return;
    const { newTop: o, newNodeObj: c } = on.call(this, r, t);
    console.timeEnd("addSummary"), t || this.createInputDiv(o.children[0]), this.selectNode(o.children[0], !0), this.bus.fire("operation", {
      name: "addSummary",
      obj: c
    });
  });
  ...
  if (!n)
    return;
  const { newTop: i, newNodeObj: s } = Ee.call(this, n, t);
  ...
  const n = JSON.parse(
    JSON.stringify(e.nodeObj, (s, r) => {
      if (s !== "parent")
        return r;
    })
  );
  je(n);
  const { newNodeObj: i } = Ee.call(this, t, n);
  ...
  Qe(i), n.parentNode.insertBefore(n, n.previousSibling), this.linkDiv(), this.bus.fire("operation", {
    name: "moveUpNode",
    obj: i
  });
}, fn = function(e) {
  ...
  if (!t)
    return;
  const n = t.parentNode.parentNode, i = t.nodeObj;
  $e(i), n.nextSibling ? n.insertAdjacentElement("beforebegin", n.nextSibling) : n.parentNode.prepend(n), this.linkDiv(), this.bus.fire("operation", {
    name: "moveDownNode",
    obj: i
  });
}, un = function(e) {
  ...
  const i = n.parent.children.findIndex((l) => l === n), s = n.parent.children[i + 1], r = s && s.id, o = fe(n), c = t.parentNode;
  if (c.tagName !== "ROOT") {
    if (o === 0) {
      const l = c.parentNode.parentNode.previousSibling;
    ...
    for (const l in this.linkData) {
      const u = this.linkData[l];
      (u.from === c.firstChild || u.to === c.firstChild) && this.removeLink(
        this.mindElixirBox.querySelector(
          `[data-linkid=${this.linkData[l].id}]`
        )
      );
    }
    c.parentNode.remove(), this.linkDiv(), this.bus.fire("operation", {
      name: "removeNode",
      obj: n,
      originSiblingId: r,
  ...
  const n = e.nodeObj, i = t.nodeObj, s = n.parent.id;
  if (i.expanded === !1 && (this.expandNode(t, !0), e = j(n.id), t = j(i.id)), !Ue(n, i)) {
    console.warn("Invalid move");
    return;
  }
  console.time("moveNode"), nt(n, i), q(this.nodeData);
  const r = e.parentElement, o = r.parentNode.parentNode, c = t.parentElement;
  if (o.className === "mindbox" ? r.parentNode.lastChild.remove() : r.parentNode.className === "mindbox" && (r.style.cssText = ""), c.tagName === "T")
    if (o.className === "mindbox" && (r.parentNode.className = ""), c.children[1])
      c.nextSibling.appendChild(r.parentNode);
    else {
      const l = te.createElement("children");
      l.appendChild(r.parentNode), c.appendChild(ne(!0)), c.parentElement.insertBefore(l, c.nextSibling);
    }
  else
    c.tagName === "ROOT" && (this.processPrimaryNode(r.parentNode, n), c.nextSibling.appendChild(r.parentNode));
  this.linkDiv(), this.bus.fire("operation", {
    name: "moveNode",
    obj: { fromObj: n, toObj: i, originParentId: s }
  }), console.timeEnd("moveNode");
}, Pn = function(e, t) {
  const n = e.nodeObj, i = t.nodeObj, s = n.parent.id;
  it(n, i), q(this.nodeData);
  const r = e.parentElement, o = r.parentNode, c = t.parentElement, l = c.parentNode;
  c.parentNode.parentNode.insertBefore(o, l), this.processPrimaryNode(r.parentElement, n), this.linkDiv(), this.bus.fire("operation", {
    name: "moveNodeBefore",
    obj: { fromObj: n, toObj: i, originParentId: s }
  });
}, hn = function(e, t) {
  const n = e.nodeObj, i = t.nodeObj, s = n.parent.id;
  st(n, i), q(this.nodeData);
  const r = e.parentElement, o = r.parentNode, c = t.parentElement, l = c.parentNode;
  c.parentNode.parentNode.insertBefore(o, l.nextSibling), this.processPrimaryNode(r.parentElement, n), this.linkDiv(), this.bus.fire("operation", {
    name: "moveNodeAfter",
    obj: { fromObj: n, toObj: i, originParentId: s }
  });
}, pn = function(e) {
...
function gn(e, t) {
  if (this.direction === G)
    e.className = "lhs";
  else if (this.direction === ee)
    e.className = "rhs";
  else if (this.direction === U) {
    const n = te.querySelectorAll(".lhs").length, i = te.querySelectorAll(".rhs").length;
    n <= i ? (e.className = "lhs", t.direction = G) : (e.className = "rhs", t.direction = ee);
  }
}
const Hn = function(e, t, n, i) {
  ...
  if (!e || !t)
    return;
  const r = e.getBoundingClientRect(), o = t.getBoundingClientRect(), c = (r.x + r.width / 2 - s.x) / this.scaleVal, l = (r.y + r.height / 2 - s.y) / this.scaleVal, u = (o.x + o.width / 2 - s.x) / this.scaleVal, a = (o.y + o.height / 2 - s.y) / this.scaleVal;
  let p, f, v, w;
  n ? (p = c + i.delta1.x, f = l + i.delta1.y, v = u + i.delta2.x, w = a + i.delta2.y) : (l + a) / 2 - l <= r.height / 2 ? (p = (r.x + r.width - s.x) / this.scaleVal + 100, f = l, v = (o.x + o.width - s.x) / this.scaleVal + 100, w = a) : (p = (c + u) / 2, f = (l + a) / 2, v = (c + u) / 2, w = (l + a) / 2);
  const m = {
    cx: c,
    cy: l,
    w: r.width,
    ...
    w: o.width,
    h: o.height
  }, z = we(m, p, f), x = z.x, P = z.y, h = ge(g, v, w), H = h.x, D = h.y, A = Be(v, w, H, D), X = lt(
    `M ${x} ${P} C ${p} ${f} ${v} ${w} ${H} ${D}`,
    `M ${A.x1} ${A.y1} L ${H} ${D} L ${A.x2} ${A.y2}`
  );
  let d;
  n ? (d = {
    id: i.id,
  ...
  }, this.linkData[i.id] = d, X.linkObj = d, X.dataset.linkid = i.id) : (d = {
    id: le(),
    label: "",
    from: e,
    to: t,
  ...
  }, this.linkData[d.id] = d, X.linkObj = d, X.dataset.linkid = d.id, this.currentLink = X), this.linkSvgGroup.appendChild(X), n || this.showLinkController(p, f, v, w, d, m, g);
}, bn = function(e) {
  let t;
  ...
  this.currentLink = e;
  const t = e.linkObj, n = t.from, i = t.to, s = this.map.getBoundingClientRect(), r = n.getBoundingClientRect(), o = i.getBoundingClientRect(), c = (r.x + r.width / 2 - s.x) / this.scaleVal, l = (r.y + r.height / 2 - s.y) / this.scaleVal, u = (o.x + o.width / 2 - s.x) / this.scaleVal, a = (o.y + o.height / 2 - s.y) / this.scaleVal, p = {
    cx: c,
    cy: l,
    w: r.width,
    h: r.height
  ...
  this.P2.style.cssText = `top:${t}px;left:${e}px;`, this.P3.style.cssText = `top:${i}px;left:${n}px;`, this.line1.setAttribute("x1", l), this.line1.setAttribute("y1", u), this.line1.setAttribute("x2", e), this.line1.setAttribute("y2", t), this.line2.setAttribute("x1", n), this.line2.setAttribute("y1", i), this.line2.setAttribute("x2", p), this.line2.setAttribute("y2", f), this.helper1 && (this.helper1.destory(this.map), this.helper2.destory(this.map)), this.helper1 = new oe(this.P2), this.helper2 = new oe(this.P3), this.helper1.init(this.map, (v, w) => {
    ...
    this.P3.style.top = i + "px", this.P3.style.left = n + "px", this.currentLink.children[0].setAttribute(
      ...
      "d",
      `M ${g.x1} ${g.y1} L ${p} ${f} L ${g.x2} ${g.y2}`
    ), this.line2.setAttribute("x1", n), this.line2.setAttribute("y1", i), this.line2.setAttribute("x2", p), this.line2.setAttribute("y2", f), s.delta2.x = n - o.cx, s.delta2.y = i - o.cy;
  });
};
function yn(e) {
  var g, z;
  var t = this.primaryNodeHorizontalGap || We, n = this.primaryNodeVerticalGap || Ye;
  ...
  let r = 0, o, c = 0, l = 0, u = 0, a = 0, p = 0, f;
  if (this.direction === U) {
    let x = 0, P = 0, h = 0, H = 0;
    for (let D = 0; D < s.length; D++) {
      const A = s[D];
      A.className === "lhs" ? (a += A.offsetHeight + n, h += A.offsetHeight, x += 1) : (p += A.offsetHeight + n, H += A.offsetHeight, P += 1);
    }
    a > p ? (f = 1e4 - Math.max(a) / 2, o = "r", c = (a - H) / (P - 1)) : (f = 1e4 - Math.max(p) / 2, o = "l", c = (p - h) / (x - 1));
  } else {
    for (let x = 0; x < s.length; x++)
      r += s[x].offsetHeight + n;
    f = 1e4 - r / 2;
  }
  let v = "";
  const w = 1e4 - i.offsetWidth / 2 - t + 60, m = 1e4 + i.offsetWidth / 2 + t - 60;
  for (let x = 0; x < s.length; x++) {
    let P, h;
    const H = s[x], D = H.offsetHeight;
    let A = i.offsetLeft - 10;
    if (H.className === "lhs") {
      H.style.top = f + l + "px", H.style.left = w - H.offsetWidth + "px", P = w - 15, h = f + l + D / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === U && (d = 1e4 - i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}`) : v += `M 10000 10000 H ${A} V ${h} H ${P}`, o === "l" ? l += D + c : l += D + n;
    } else {
      A = i.offsetLeft + i.offsetWidth + 10, H.style.top = f + u + "px", H.style.left = m + "px", P = m + 15, h = f + u + D / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === U && (d = 1e4 + i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}`) : v += `M 10000 10000 H ${A} V ${h} H ${P}`, o === "r" ? u += D + c : u += D + n;
    }
    const X = H.children[0].children[1];
    X && (X.style.top = (X.parentNode.offsetHeight - X.offsetHeight) / 2 + "px", H.className === "lhs" ? X.style.left = -10 + "px" : X.style.left = X.parentNode.offsetWidth - 10 + "px");
  }
  this.svg2nd.appendChild(rt(v));
  for (let x = 0; x < s.length; x++) {
    const P = s[x];
    if (!(e && e !== s[x]) && P.childElementCount) {
      const h = re("svg3rd"), H = re("svg3rd");
      P.querySelectorAll(".svg3rd").forEach((X) => {
        X.remove();
      }), P.appendChild(h);
      const D = P.children[0];
      let A;
      ((z = (g = P.children) == null ? void 0 : g[2]) == null ? void 0 : z.tagName) === "SMYCHILDREN" ? A = [...P.children[1].children, ...P.children[2].children] : A = P.children[1].children, Y = "", ae = "", qe(A, D, this.nodeData.children[x], !0), h.appendChild(ct(Y)), ae.length > 0 && (P.appendChild(H), H.appendChild(ot(ae)));
    }
  }
  this.linkSvgGroup.innerHTML = "";
  for (const x in this.linkData) {
    const P = this.linkData[x];
    typeof P.from == "string" ? this.createLink(j(P.from), j(P.to), !0, P) : this.createLink(
      j(P.from.nodeObj.id),
      j(P.to.nodeObj.id),
      !0,
      P
...
function qe(e, t, n, i) {
  var u, a, p;
  let s = t.offsetTop, r = t.offsetLeft, o = t.offsetWidth, c = t.offsetHeight, l = !1;
  t.offsetParent.tagName === "SMY" && (l = !0, s += t.offsetParent.offsetTop, r += t.offsetParent.offsetLeft);
  for (let f = 0; f < e.length; f++) {
    const v = e[f];
    if ((v == null ? void 0 : v.tagName) === "SMY") {
      let d = e[0], y = e[f - 1];
      const b = {};
      n.children[f].summary.range.forEach((I) => {
        b[I] = !0;
      });
      let O = !0;
      for (let I = 0; I < f; I++) {
        const Se = e[I].children[0].children[0].getAttribute("data-nodeid").slice(2);
        b[Se] && (O && (O = !1, d = e[I]), y = e[I]);
      }
      const k = d.offsetLeft + d.offsetWidth + 8, ie = d.offsetTop + 15, se = y.offsetTop + y.offsetHeight - 5, W = y.offsetLeft + y.offsetWidth + 8, ve = v.offsetTop + v.children[0].offsetTop + v.children[0].offsetHeight;
      let de = (u = v.style.top) != null ? u : 0;
      typeof de == "string" && (de = Number(de.replace("px", ""))), v.style.top = de + (se + ie + v.children[0].clientHeight) / 2 - ve + "px", ae += `M ${k} ${ie} H ${k + 10} V ${se} H${W}`;
    }
    ...
    D === "lhs" && (v == null ? void 0 : v.tagName) !== "SMY" ? (P = r + Pe, H = r, h = r - w.offsetWidth, m + g < s + c / 2 + 50 && m + g > s + c / 2 - 50 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : m + g >= s + c / 2 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : Y += `M ${P} ${z} H ${H} V ${x} H ${h}`) : D === "rhs" && (v == null ? void 0 : v.tagName) !== "SMY" && (P = r + o - Pe, H = r + o, h = r + o + w.offsetWidth, l && (P += Pe), m + g < s + c / 2 + 50 && m + g > s + c / 2 - 50 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : m + g >= s + c / 2 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : Y += `M ${P} ${z} H ${H} V ${x} H ${h}`);
    const A = w.children[1];
    if (A) {
      if (A.style.top = (w.offsetHeight - A.offsetHeight) / 2 + "px", D === "lhs" ? A.style.left = -10 + "px" : D === "rhs" && (A.style.left = w.offsetWidth - 10 + "px"), !A.expanded)
        continue;
    } else
      continue;
    let X;
    ((p = (a = v.children) == null ? void 0 : a[2]) == null ? void 0 : p.tagName) === "SMYCHILDREN" ? X = [...v.children[1].children, ...v.children[2].children] : X = [...v.children[1].children], X.length > 0 && qe(X, w, n.children[f]);
  }
}
function xn(e) {
  e.map.addEventListener("click", (t) => {
    ...
    if (!e.nodeDraggable && t && t.target.className === "selected") {
      K.clear(), t.target.draggable = !1;
      return;
    }
    t.target.contentEditable !== "true" && K.onMove(t, e.container);
  }), e.map.addEventListener("mousedown", (t) => {
    t.target.contentEditable !== "true" && (K.afterMoving = !1, K.mousedown = !0);
...
function An(e, t) {
  const n = (P) => {
    ...
    return h.innerText = P, h.style.cssText = "position:absolute;bottom:20px;left:50%;transform:translateX(-50%);", h;
  }, i = (P, h, H) => {
    const D = document.createElement("li");
    return D.id = P, D.innerHTML = `<span>${pe(h)}</span><span>${pe(H)}</span>`, D;
  }, s = L[e.locale] ? e.locale : "en", r = i("cm-add_child", L[s].addChild, "tab"), o = i("cm-add_parent", L[s].addParent, ""), c = i("cm-add_sibling", L[s].addSibling, "enter"), l = i(
    "cm-remove_child",
    L[s].removeNode,
    "delete"
  ), u = i("cm-fucus", L[s].focus, ""), a = i("cm-unfucus", L[s].cancelFocus, ""), p = i("cm-up", L[s].moveUp, "PgUp"), f = i("cm-down", L[s].moveDown, "Pgdn"), v = i("cm-link", L[s].link, ""), w = i("cm-nodelink", L[s].nodeLink, ""), m = i("cm-summary", L[s].summary, ""), g = document.createElement("ul");
  if (g.className = "menu-list", g.appendChild(r), g.appendChild(o), g.appendChild(c), g.appendChild(l), (!t || t.focus) && (g.appendChild(u), g.appendChild(a)), g.appendChild(p), g.appendChild(f), (!t || t.link) && (g.appendChild(v), g.appendChild(w)), g.appendChild(m), t && t.extend)
    for (let P = 0; P < t.extend.length; P++) {
      const h = t.extend[P], H = i(h.name, h.name, h.key || "");
      g.appendChild(H), H.onclick = (D) => {
        h.onclick(D);
      };
    }
  const z = document.createElement("cmenu");
  z.appendChild(g), z.hidden = !0, e.container.append(z);
  let x = !0;
  e.container.oncontextmenu = function(P) {
    ...
    const h = P.target;
    if (h.tagName === "TPC") {
      h.parentElement.tagName === "ROOT" ? x = !0 : x = !1, x ? (u.className = "disabled", p.className = "disabled", f.className = "disabled", c.className = "disabled", l.className = "disabled") : (u.className = "", p.className = "", f.className = "", c.className = "", l.className = ""), e.selectNode(h), z.hidden = !1;
      const H = g.offsetHeight, D = g.offsetWidth;
      H + P.clientY > window.innerHeight ? (g.style.top = "", g.style.bottom = "0px") : (g.style.bottom = "", g.style.top = P.clientY + 15 + "px"), D + P.clientX > window.innerWidth ? (g.style.left = "", g.style.right = "0px") : (g.style.right = "", g.style.left = P.clientX + 10 + "px");
    }
  }, z.onclick = (P) => {
    P.target === z && (z.hidden = !0);
  }, r.onclick = (P) => {
    e.addChild(), z.hidden = !0;
  }, m.onclick = (P) => {
    e.addSummary(), z.hidden = !0;
  }, o.onclick = (P) => {
    e.insertParent(), z.hidden = !0;
  }, c.onclick = (P) => {
    x || (e.insertSibling(), z.hidden = !0);
  }, l.onclick = (P) => {
    x || (e.removeNode(), z.hidden = !0);
  }, u.onclick = (P) => {
    x || (e.focusNode(e.currentNode), z.hidden = !0);
  }, a.onclick = (P) => {
    e.cancelFocus(), z.hidden = !0;
  }, p.onclick = (P) => {
    x || (e.moveUpNode(), z.hidden = !0);
  }, f.onclick = (P) => {
    x || (e.moveDownNode(), z.hidden = !0);
  }, v.onclick = (P) => {
    z.hidden = !0;
    const h = e.currentNode, H = n(L[s].clickTips);
    e.container.appendChild(H), e.map.addEventListener(
      "click",
      (D) => {
        if (D.preventDefault(), H.remove(), D.target.parentElement.nodeName === "T" || D.target.parentElement.nodeName === "ROOT") {
    ...
    e.container.appendChild(H), e.map.addEventListener(
      ...
      (D) => {
        if (D.preventDefault(), H.remove(), D.target.parentElement.nodeName === "T" || D.target.parentElement.nodeName === "ROOT") {
          const A = e.currentNode;
          h.nodeObj.linkJump || (h.nodeObj.linkJump = []), h.nodeObj.linkJump.push(
            {
              toId: A.nodeObj.id,
              title: A.nodeObj.topic
            }
          ), e.shapeTpc(h, h.nodeObj), e.linkDiv();
        } else
          console.log("\u53D6\u6D88\u8FDE\u63A5");
      },
      {
...
function On(e, t) {
  return function() {
    const n = arguments;
    he && clearTimeout(he), he = setTimeout(function() {
      e.apply(this, n);
    }, t);
  };
}
function Nn(e) {
  var p;
  const t = document.createElement("toolbar"), n = R("fullscreen", "full"), i = R("toCenter", "living"), s = R("zoomout", "move"), r = R("zoomin", "add"), o = document.createElement("input");
  o.className = "numberSelection", o.type = "number", o.min = "2", o.max = "100", o.step = "1", o.value = ((p = e == null ? void 0 : e.expandDeep) == null ? void 0 : p.toString()) || "2", o.oninput = On(() => {
    const f = e.getAllDataWithAutoHide();
    De(f == null ? void 0 : f.nodeData), e.layout(), e.linkDiv();
  }, 300);
  const c = document.createElement("span");
  if (c.innerText = "100%", t.appendChild(o), t.appendChild(n), t.appendChild(i), t.appendChild(s), t.appendChild(r), e.uploadButton) {
    const f = Mn(e);
    t.appendChild(f);
  }
  ...
  let u = window.innerWidth - (l == null ? void 0 : l.getBoundingClientRect().right) + parseInt(l && getComputedStyle(l).paddingRight) + (l == null ? void 0 : l.offsetWidth) - (l == null ? void 0 : l.clientWidth);
  return new IntersectionObserver((f) => {
    f.forEach((v) => {
      v.isIntersecting && (u = window.innerWidth - (l == null ? void 0 : l.getBoundingClientRect().right) + parseInt(l && getComputedStyle(l).paddingRight) + (l == null ? void 0 : l.offsetWidth) - (l == null ? void 0 : l.clientWidth));
    });
  }, { root: l }).observe(t), l == null || l.addEventListener("scroll", (f) => {
    const w = l.scrollTop + l.clientHeight, m = e.mindElixirBox.offsetTop, g = e.mindElixirBox.offsetTop + e.mindElixirBox.clientHeight, z = e.mindElixirBox.clientHeight;
    w < m + t.clientHeight + 40 ? (t.style.position = "absolute", t.style.bottom = z - 20 - t.clientHeight + "px", t.style.right = "20px") : w <= g ? (t.style.position = "fixed", t.style.bottom = "20px", t.style.right = u + 20 + "px") : w > g && (t.style.position = "absolute", t.style.bottom = "20px", t.style.right = "20px");
  }), t;
}
function jn(e, t) {
  var n = !1;
...
function Bn(e) {
  const t = document.createElement("toolbar"), n = R("sidebar", "menu"), i = R("tbltl", "left"), s = R("tbltr", "right"), r = R("tblts", "side");
  t.appendChild(n), t.appendChild(i), t.appendChild(s), t.appendChild(r), t.className = "lt", n.onclick = () => {
    const u = document.querySelector("sidebar");
    Xn(e, u), u.classList.contains("selected") ? u.removeAttribute("class") : u.setAttribute("class", "selected");
  }, i.onclick = () => {
    e.initLeft();
  }, s.onclick = () => {
    e.initRight();
  ...
  const o = e.scrollContainer;
  let c = (o == null ? void 0 : o.getBoundingClientRect().left) + parseInt(o && getComputedStyle(o).paddingLeft);
...
function wi(e) {
  const t = L[e.locale] ? e.locale : "en";
  let n;
  const i = V("nm-style"), s = V("nm-tag"), r = V("nm-icon"), o = V("nm-link"), c = V("nm-remark");
  i.innerHTML = `
  ...
  <use xlink:href="#icon-B"></use>
      ...
      <div class="nm-fontcolor-container">
        ${pi.map((d) => {
    let y = d;
    return d === "#f6f6f6" && (y = ""), `<div class="split6"><div class="palette" data-color="${y}" style="background-color: ${d};"></div></div>`;
  }).join("")}
      </div>
      <div class="bof">
      <span class="font">${L[t].font}</span>
      <span class="background">${L[t].background}</span>
      </div>
  `, s.innerHTML = `${L[t].tag}<textarea class="nm-tag" tabindex="-1" placeholder="${L[t].tagsSeparate}" /><br>`, r.innerHTML = `${L[t].icon}<div class="nm-icon" contenteditable="true" spellcheck="false" placeholder="${L[t].iconsSeparate}" ></div>`, o.innerHTML = `${L[t].hyperlink}<textarea class="nm-link" tabindex="-1" placeholder="${L[t].linkSeparate}" /><br>`, c.innerHTML = `${L[t].remark}<textarea class="nm-remark" tabindex="-1" placeholder="${L[t].reamrkSeparate}" /><br>`;
  const l = V();
  l.className = "picker", l.style.display = "none", l.innerHTML = '<div class="header"></div><div class="body"><div class="container"></div></div>';
  const u = l.querySelector(".container");
  ["\u5168\u90E8", "\u65D7\u6746", "\u6570\u5B57", "\u5176\u4ED6", "\u4EBA\u50CF", "\u661F\u661F"].forEach((d, y) => {
    const b = V();
    b.className = "box", y === 0 && (b.className = "box active"), b.innerText = d, b.onclick = () => {
      [...l.children[0].children].forEach((O) => {
        O.className = "box";
      }), b.className = "box active", u.style.transform = `translateX(${-(y * 275)}px)`;
    }, l.children[0].appendChild(b);
  });
  const p = {
    flag: 4,
    number: 8,
  ...
  f.className = "list", Object.keys(p).forEach((d) => {
    const y = V();
    y.className = "list";
    for (let b = 1; b <= p[d]; b++) {
      const O = document.createElement("img"), k = V();
      k.className = "item", O.style.width = "100%", O.style.height = "100%", O.src = new URL((/* @__PURE__ */ Object.assign({ "../iconfont/icon/flag/flag1.webp": Cn, "../iconfont/icon/flag/flag2.webp": Zn, "../iconfont/icon/flag/flag3.webp": Vn, "../iconfont/icon/flag/flag4.webp": En, "../iconfont/icon/number/number1.webp": qn, "../iconfont/icon/number/number2.webp": Fn, "../iconfont/icon/number/number3.webp": Sn, "../iconfont/icon/number/number4.webp": Rn, "../iconfont/icon/number/number5.webp": Wn, "../iconfont/icon/number/number6.webp": Yn, "../iconfont/icon/number/number7.webp": Gn, "../iconfont/icon/number/number8.webp": Jn, "../iconfont/icon/other/other1.webp": In, "../iconfont/icon/other/other10.webp": Kn, "../iconfont/icon/other/other11.webp": Un, "../iconfont/icon/other/other12.webp": Qn, "../iconfont/icon/other/other13.webp": $n, "../iconfont/icon/other/other14.webp": _n, "../iconfont/icon/other/other15.webp": ei, "../iconfont/icon/other/other16.webp": ti, "../iconfont/icon/other/other17.webp": ni, "../iconfont/icon/other/other2.webp": ii, "../iconfont/icon/other/other3.webp": si, "../iconfont/icon/other/other4.webp": ri, "../iconfont/icon/other/other5.webp": oi, "../iconfont/icon/other/other6.webp": ci, "../iconfont/icon/other/other7.webp": li, "../iconfont/icon/other/other8.webp": di, "../iconfont/icon/other/other9.webp": ai, "../iconfont/icon/portrait/portrait1.webp": fi, "../iconfont/icon/portrait/portrait2.webp": ui, "../iconfont/icon/star/star1.webp": vi, "../iconfont/icon/star/star2.webp": Pi, "../iconfont/icon/star/star3.webp": hi }))[`../iconfont/icon/${d}/${d + b}.webp`], self.location).href, k.appendChild(O), y.appendChild(k), f.appendChild(k.cloneNode(!0));
    }
    l.children[1].children[0].appendChild(y), l.children[1].children[0].insertBefore(f, l.children[1].children[0].children[0]);
  }), l.onclick = (d) => {
    if (d.target.nodeName === "IMG") {
      const y = V();
      y.className = "divItem", y.appendChild(d.target.cloneNode()), H.appendChild(y), e.updateNodeIcons(e.currentNode.nodeObj, H.innerHTML), d.stopPropagation();
    }
  }, r.appendChild(l);
  function v(d) {
    d.ondblclick = (y) => {
      const b = document.createElement("textarea"), O = d.children[0], k = e.container.offsetHeight - d.offsetTop - 60, ie = 30, se = (W) => W < ie ? ie : W > k ? k : W;
      b.value = O.value, b.style.position = "absolute", b.style.left = O.offsetLeft + "px", b.style.top = O.offsetTop - 10 + "px", b.style.height = se(O.scrollHeight) + "px", b.style.width = O.offsetWidth + "px", b.oninput = (W) => {
        let ve = W.target.scrollHeight;
        b.style.height = se(ve) + "px";
      }, b.onblur = (W) => {
        O.value = b.value, O.dispatchEvent(new CustomEvent("change")), b.remove();
      }, d.appendChild(b), b.focus();
    };
  }
  v(s), v(o), v(c);
  const w = document.createElement("nmenu");
  w.innerHTML = `
  <div class="button-container"><svg class="icon" aria-hidden="true">
  <use xlink:href="#icon-close"></use>
  </svg></div>
  `, w.appendChild(i), w.appendChild(s), w.appendChild(r), w.appendChild(o), w.appendChild(c), w.hidden = !0;
  function m(d, y) {
    var b = e.container.querySelectorAll(d);
    [].forEach.call(b, function(O) {
      O.classList.remove(y);
    });
  }
  e.container.append(w);
  const g = w.querySelectorAll(".size"), z = w.querySelector(".bold"), x = w.querySelector(".button-container"), P = w.querySelector(".font"), h = e.container.querySelector(".nm-tag"), H = e.container.querySelector(".nm-icon"), D = e.container.querySelector(".nm-link"), A = e.container.querySelector(".nm-remark");
  w.onclick = (d) => {
    if (!e.currentNode)
      return;
    const y = e.currentNode.nodeObj, b = d.target;
    b.className === "palette" ? (y.style || (y.style = {}), m(".palette", "nmenu-selected"), b.className = "palette nmenu-selected", n === "font" ? y.style.color = b.dataset.color : n === "background" && (y.style.background = b.dataset.color), e.updateNodeStyle(y)) : b.className === "background" ? (m(".palette", "nmenu-selected"), n = "background", b.className = "background selected", b.previousElementSibling.className = "font", y.style && y.style.background && (w.querySelector(
      '.palette[data-color="' + y.style.background + '"]'
    ).className = "palette nmenu-selected")) : b.className === "font" && (m(".palette", "nmenu-selected"), n = "font", b.className = "font selected", b.nextElementSibling.className = "background", y.style && y.style.color && (w.querySelector(
      '.palette[data-color="' + y.style.color + '"]'
    ).className = "palette nmenu-selected")), b.className !== "picker" && b.className !== "header" && b.className !== "item" && b.className !== "list" && b.className !== "box" && b.className !== "box active" && (l.style.display = "none");
  }, Array.from(g).map(
    (d) => {
      d.onclick = (y) => {
        e.currentNode.nodeObj.style || (e.currentNode.nodeObj.style = {}), m(".size", "size-selected");
        const b = y.currentTarget;
        e.currentNode.nodeObj.style.fontSize = b.dataset.size, b.className = "size size-selected", e.updateNodeStyle(e.currentNode.nodeObj);
      };
    }
  ), z.onclick = (d) => {
    e.currentNode.nodeObj.style || (e.currentNode.nodeObj.style = {}), e.currentNode.nodeObj.style.fontWeight === "bold" ? (delete e.currentNode.nodeObj.style.fontWeight, d.currentTarget.className = "bold", e.updateNodeStyle(e.currentNode.nodeObj)) : (e.currentNode.nodeObj.style.fontWeight = "bold", d.currentTarget.className = "bold size-selected", e.updateNodeStyle(e.currentNode.nodeObj));
  }, h.onchange = (d) => {
    if (!!e.currentNode && (d.target.value !== null || d.target.value !== void 0)) {
      let y;
      d.target.value === "" ? y = [] : y = d.target.value.split(","), e.updateNodeTags(e.currentNode.nodeObj, y);
    }
    ...
    if (!!e.currentNode && (d.target.value !== null || d.target.value !== void 0)) {
      ...
      e.updateNodeHyperLink(e.currentNode.nodeObj, y);
    }
  }, A.onchange = (d) => {
    if (!!e.currentNode && (d.target.value !== null || d.target.value !== void 0)) {
      const y = d.target.value;
      e.updateNodeRemark(e.currentNode.nodeObj, y);
    }
  };
  let X = "open";
  x.onclick = (d) => {
    X === "open" ? (X = "close", w.className = "close", x.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-menu"></use></svg>') : (X = "open", w.className = "", x.innerHTML = '<svg class="icon" aria-hidden="true"><use xlink:href="#icon-close"></use></svg>');
  }, e.bus.addListener("unselectNode", function() {
    w.hidden = !0;
  }), e.bus.addListener("selectNode", function(d, y) {
    if (!!y) {
      if (w.hidden = !1, m(".palette", "nmenu-selected"), m(".size", "size-selected"), m(".bold", "size-selected"), n = "font", P.className = "font selected", P.nextElementSibling.className = "background", d.style) {
        if (d.style.fontSize) {
          const b = w.querySelector(
            '.size[data-size="' + d.style.fontSize + '"]'
          );
          b && (b.className = "size size-selected");
        }
        if (d.style.fontWeight) {
          const b = w.querySelector(".bold");
          b && (b.className = "bold size-selected");
        }
        if (d.style.color) {
          const b = w.querySelector(
            '.palette[data-color="' + d.style.color + '"]'
          );
          b && (b.className = "palette nmenu-selected");
        }
      }
      d.tags ? h.value = d.tags.join(",") : h.value = "", d.icons ? H.innerHTML = d.icons : H.innerText = "", D.value = "", d.hyperLink && (D.value = d.hyperLink), d.linkJump && (D.value.length > 0 && (D.value += ","), D.value += d.linkJump.map((b) => b.title).reduce((b, O, k) => b + (k ? "," : "") + O, "")), d.remark ? A.value = d.remark : A.value = "", l.style.display = "none";
    }
  });
}
const He = document, gi = function(e, t) {
  if (!t)
    return be(e), e;
...
function Hi(e) {
  ...
  e.map.addEventListener("dragstart", function(r) {
    t = r.target, t.parentNode.parentNode.style.opacity = "0.5", K.clear();
  }), e.map.addEventListener("dragend", async function(r) {
    r.target.style.opacity = "", be(i);
    const o = t.nodeObj;
    switch (n) {
      case "before":
        e.moveNodeBefore(t, i), e.selectNode(j(o.id));
        break;
      case "after":
        e.moveNodeAfter(t, i), e.selectNode(j(o.id));
        break;
      case "in":
        e.moveNode(t, i);
        break;
  ...
  }), e.map.addEventListener("dragover", Je(function(r) {
    be(i);
    const o = He.elementFromPoint(
      r.clientX,
      r.clientY - 12
    );
    if (Oe(o, t)) {
      i = o;
      const c = o.getBoundingClientRect().y;
      r.clientY > c + o.clientHeight ? n = "after" : r.clientY > c + o.clientHeight / 2 && (n = "in");
    } else {
      const c = He.elementFromPoint(
        r.clientX,
        r.clientY + 12
      );
      if (Oe(c, t)) {
        ...
        r.clientY < l ? n = "before" : r.clientY < l + c.clientHeight / 2 && (n = "in");
      } else
        n = i = null;
    }
    i && gi(i, n);
...
function bi(e) {
  const t = {
    13: (n) => {
      n.preventDefault(), e.insertSibling();
    },
    9: () => {
      e.addChild();
    },
...
function zi(e, t) {
  const n = (f, v) => {
    ...
    return w.id = f, w.innerHTML = `<svg class="icon" aria-hidden="true">
    <use xlink:href="#icon-${v}"></use>
  </svg>`, w;
  }, i = n("cm-add_child", "zijiedian"), s = n("cm-add_sibling", "tongjijiedian-"), r = n("cm-remove_child", "shanchu2"), o = n("cm-up", "rising"), c = n("cm-down", "falling"), l = n("cm-edit", "edit"), u = document.createElement("ul");
  if (u.className = "menu-list", t && t.extend)
    for (let f = 0; f < t.extend.length; f++) {
      const v = t.extend[f], w = n(v.name, v.name);
      u.appendChild(w), w.onclick = (m) => {
        v.onclick(m);
      };
    }
  const a = document.createElement("mmenu");
  a.appendChild(i), a.appendChild(s), a.appendChild(r), a.appendChild(o), a.appendChild(c), a.appendChild(l), a.hidden = !0, e.container.append(a);
  let p = !0;
  e.bus.addListener("unselectNode", function() {
    a.hidden = !0;
  }), e.bus.addListener("selectNode", function(f) {
    a.hidden = !1, f.root ? p = !0 : p = !1;
  }), a.onclick = (f) => {
    f.target === a && (a.hidden = !0);
  }, i.onclick = (f) => {
    e.addChild();
  }, s.onclick = (f) => {
    p || e.insertSibling();
...
(function(e) {
  ...
  t = function() {
    var a, p, f, v;
    (v = document.createElement("div")).innerHTML = c, c = null, (f = v.getElementsByTagName("svg")[0]) && (f.setAttribute("aria-hidden", "true"), f.style.position = "absolute", f.style.width = 0, f.style.height = 0, f.style.overflow = "hidden", a = f, (p = document.body).firstChild ? (v = a, (f = p.firstChild).parentNode.insertBefore(v, f)) : p.appendChild(a));
  }, document.addEventListener ? ~["complete", "loaded", "interactive"].indexOf(document.readyState) ? setTimeout(t, 0) : (n = function() {
    document.removeEventListener("DOMContentLoaded", n, !1), t();
  }, document.addEventListener("DOMContentLoaded", n, !1)) : document.attachEvent && (i = t, s = e.document, r = !1, (o = function() {
    try {
...
function J({
  ...
  !X || (this.mindElixirBox = X, this.before = p || {}, this.nodeData = t.nodeData, this.linkData = t.linkData || {}, this.expandDeep = t == null ? void 0 : t.expandDeep, this.locale = i, this.contextMenuOption = c, this.contextMenu = o === void 0 ? !0 : o, this.toolBar = l === void 0 ? !0 : l, this.nodeMenu = u === void 0 ? !0 : u, this.keypress = a === void 0 ? !0 : a, this.closeButton = P === void 0 ? !1 : P, this.widthControll = h === void 0 ? !0 : h, this.mobileMenu = x, this.direction = t.direction !== void 0 ? t.direction : typeof n == "number" ? n : 1, this.draggable = s === void 0 ? !0 : s, this.newTopicName = f, this.editable = r === void 0 ? !0 : r, this.allowUndo = v === void 0 ? !0 : v, this.currentNode = null, this.currentLink = null, this.inputDiv = null, this.scaleVal = 1, this.tempDirection = null, this.primaryLinkStyle = w || 0, this.overflowHidden = m, this.primaryNodeHorizontalGap = g, this.primaryNodeVerticalGap = z, this.uploadButton = H === void 0 ? !0 : H, this.nodeDraggable = D === void 0 ? !0 : D, this.scrollContainer = A, this.bus = new Fe(), this.bus.addListener("operation", (d) => {
    if (this.isUndo) {
      this.isUndo = !1;
      return;
    }
    ...
    !d || (this.isUndo = !0, d.name === "moveNode" ? this.moveNode(
      $(d.obj.fromObj.id),
      $(d.obj.originParentId)
    ) : d.name === "removeNode" ? d.originSiblingId ? this.insertBefore($(d.originSiblingId), d.obj) : this.addChild($(d.originParentId), d.obj) : d.name === "addChild" || d.name === "copyNode" ? this.removeNode($(d.obj.id)) : d.name === "finishEdit" ? this.setNodeTopic($(d.obj.id), d.origin) : this.isUndo = !1);
  });
}
function B(e) {
...
J.prototype = {
  ...
  updateNodeTags: $t,
  updateNodeIcons: _t,
  updateNodeHyperLink: en,
  updateNodeRemark: tn,
  processPrimaryNode: gn,
  setNodeTopic: wn,
  createLink: Hn,
  removeLink: bn,
  selectLink: zn,
  hideLinkController: Dn,
  ...
  exportSvgDom: mt,
  init: function(e, t) {
    e && (this.nodeData = e), t && (this.expandDeep = t), q(this.nodeData), console.log("ME_version " + J.version), console.log(this), this.mindElixirBox.className.indexOf("mind-elixir") === -1 && (this.mindElixirBox.className += "mind-elixir"), this.mindElixirBox.innerHTML = "", this.container = _.createElement("div"), this.container.className = "map-container", this.overflowHidden && (this.container.style.overflow = "hidden"), this.map = _.createElement("div"), this.map.className = "map-canvas", this.map.setAttribute("tabindex", "0"), this.container.appendChild(this.map), this.mindElixirBox.appendChild(this.container), this.root = _.createElement("root"), this.box = _.createElement("children"), this.box.className = "mindbox", this.svg2nd = re("svg2nd"), this.linkController = re("linkcontroller"), this.P2 = _.createElement("div"), this.P3 = _.createElement("div"), this.P2.className = this.P3.className = "circle", this.line1 = xe(0, 0, 0, 0), this.line2 = xe(0, 0, 0, 0), this.linkController.appendChild(this.line1), this.linkController.appendChild(this.line2), this.linkSvgGroup = re("topiclinks"), this.map.appendChild(this.root), this.map.appendChild(this.box), this.map.appendChild(this.svg2nd), this.map.appendChild(this.linkController), this.map.appendChild(this.linkSvgGroup), this.map.appendChild(this.P2), this.map.appendChild(this.P3), this.toolBar && kn(this), this.nodeMenu && wi(this), this.keypress && bi(this), Ln(this), Ge() && this.mobileMenu ? zi(this) : this.contextMenu && An(this, this.contextMenuOption), this.draggable && Hi(this), ze(this.nodeData, 0, this.expandDeep || 2), this.layout(), this.linkDiv(), this.toTopLeft(), xn(this);
  }
};
J.LEFT = G;
J.RIGHT = ee;
