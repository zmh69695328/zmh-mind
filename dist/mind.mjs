...
function Ke(e, t) {
  le(e), t.children ? t.children.push(e) : t.children = [e];
}
function Ue(e, t) {
  le(e);
...
ie.prototype.destory = function(e) {
...
const C = document, Z = "http://www.w3.org/2000/svg", $e = function(e) {
...
const K = function(e, t) {
  ...
  if (t.image && t.image.forEach((o) => {
    ...
    const r = N.createElement("div");
    r.className = "tags", r.innerHTML = t.tags.filter((o) => o !== "").map((o) => `<span>${ue(o)}</span>`).join(""), e.appendChild(r);
  }
};
function Oe(e) {
...
const it = function(e, t) {
  ...
  if (n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(_(e.expanded)), e.expanded !== !1)) {
  ...
  return n.appendChild(i), !t && e.children && e.children.length > 0 && (i.appendChild(_(e.expanded)), e.expanded !== !1 && this.createChildren(e.children)), { smy: n, top: i };
}, rt = function(e) {
  const t = N.createElement("t"), n = this.createTopic(e);
  return K.call(this, n, e), t.appendChild(n), t;
}, ot = function(e) {
...
function lt(e) {
  ...
  e.nodeObj.icons ? n = e.childNodes[1].textContent : n = e.childNodes[0].textContent, e.appendChild(t), t.id = "input-box", t.contentEditable = "true", t.spellcheck = !1, t.textContent = n, t.draggable = !1, e.nodeObj.image && e.nodeObj.image.forEach((p) => {
    ...
    a.style || (a.style = {}), a.style.controllWidth = v.style.height = w.style.height = e.clientHeight.toString() + "px", delete a.style.width, this.shapeTpc(e, a), this.linkDiv(), je.call(this, this.nodeData, a.id, a.topic), this.bus.fire("operation", {
      name: "finishEdit",
      obj: a,
      origin: n
    });
...
function dt(e, t, n) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (o.children && o.children.length > 0) {
      if (l.appendChild(_(o.expanded)), c.appendChild(l), o.expanded !== !1) {
...
function at() {
  ...
  K.call(this, e, this.nodeData), e.draggable = !1, this.root.appendChild(e);
...
let se = document, T = 1e4, F = 1e4, M = 1e4, R = 1e4, E = 40, ft = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">';
function Be() {
  T = 1e4, F = 1e4, M = 1e4, R = 1e4, E = 40;
}
function Te() {
  Be();
  let e = se.querySelectorAll(".mindbox > grp, root"), t = "";
  for (let r = 0; r < e.length; r++) {
    let o = e[r], c = o.getBoundingClientRect(), l = o.offsetTop, u = l + c.height, a = o.offsetLeft, p = a + c.width;
    l < T && (T = l), u > F && (F = u), a < M && (M = a), p > R && (R = p), t += Me(o);
  }
  console.log(T, F, M, R), t += Pt();
  let n = F - T + E * 2, i = R - M + E * 2, s = vt(n, i);
  return t = `<rect x="0" y="0" width="${i}" height="${n}" fill="#f6f6f6"></rect>` + t, s.innerHTML = t, s;
}
function ut() {
  se = this.container, Be();
  let e = se.querySelectorAll(".mindbox > grp, root"), t = "";
  for (let s = 0; s < e.length; s++) {
    let r = e[s], o = r.getBoundingClientRect(), c = r.offsetTop, l = c + o.height, u = r.offsetLeft, a = u + o.width;
    c < T && (T = c), l > F && (F = l), u < M && (M = u), a > R && (R = a), t += Me(r);
  }
  console.log(T, F, M, R);
  let n = F - T, i = R - M;
...
function Pt() {
  ...
  let x = se.querySelector(".topiclinks");
...
const xt = function() {
  ...
  return we(t.nodeData, 0, e), JSON.parse(
...
const Mt = function() {
  ...
  const n = e.nodeObj;
  typeof t == "boolean" ? n.expanded = t : n.expanded !== !1 ? n.expanded = !1 : (n.expanded = !0, ge(n)), this.layout(), this.linkDiv(), this.bus.fire("expandNode", n);
}, St = function() {
...
const $ = document, Wt = function(e) {
  if (!e.style)
    return;
  const t = j(e.id, this), n = {
    color: t.style.color && be(t.style.color),
    background: t.style.background && be(t.style.background),
  ...
  const s = j(e.id);
  K.call(this, s, e), this.linkDiv(), this.bus.fire("operation", {
    name: "editHyperLink",
    obj: e,
    origin: n
  });
  ...
  const u = $.createElement("children");
  ...
  if (!((c = s.children) != null && c.smychildren)) {
    const l = $.createElement("smychildren");
  ...
  if (s.tagName === "T") {
    if (s.children[1])
      ...
      const c = $.createElement("children");
      c.appendChild(r), s.appendChild(_(!0)), s.insertAdjacentElement("afterend", c);
    }
  ...
  if (!n)
    return;
  const { newTop: i, newNodeObj: s } = ke.call(this, n, t);
  ...
  Xe(n);
  const { newNodeObj: i } = ke.call(this, t, n);
  ...
  const i = n.parent.children.findIndex((l) => l === n), s = n.parent.children[i + 1], r = s && s.id, o = le(n), c = t.parentNode;
  if (c.tagName !== "ROOT") {
    if (o === 0) {
  ...
  if (i.expanded === !1 && (this.expandNode(t, !0), e = j(n.id), t = j(i.id)), !Se(n, i)) {
    console.warn("Invalid move");
    return;
  }
  console.time("moveNode"), Ke(n, i), q(this.nodeData);
  ...
  if (o.className === "mindbox" ? r.parentNode.lastChild.remove() : r.parentNode.className === "mindbox" && (r.style.cssText = ""), c.tagName === "T")
    if (o.className === "mindbox" && (r.parentNode.className = ""), c.children[1])
      ...
      const l = $.createElement("children");
      l.appendChild(r.parentNode), c.appendChild(_(!0)), c.parentElement.insertBefore(l, c.nextSibling);
    }
  else
...
function fn(e, t) {
  if (this.direction === 0)
    ...
    const n = $.querySelectorAll(".lhs").length, i = $.querySelectorAll(".rhs").length;
...
const un = function(e, t, n, i) {
  ...
  const m = {
    ...
    w: o.width,
    h: o.height
  }, z = ve(m, p, f), x = z.x, P = z.y, h = Pe(g, v, w), H = h.x, D = h.y, A = Le(v, w, H, D), X = tt(
    `M ${x} ${P} C ${p} ${f} ${v} ${w} ${H} ${D}`,
...
function wn(e) {
  ...
  for (let x = 0; x < s.length; x++) {
    ...
    if (H.className === "lhs") {
      ...
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 - i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d - 20} ${h} H ${P}`) : v += `M 10000 10000 H ${A} V ${h} H ${P}`, o === "l" ? l += D + c : l += D + n;
    } else {
      A = i.offsetLeft + i.offsetWidth + 10, H.style.top = f + u + "px", H.style.left = m + "px", P = m + 15, h = f + u + D / 2;
      let d = 1e4;
      this.primaryLinkStyle === 2 ? (this.direction === 2 && (d = 1e4 + i.offsetWidth / 6), h < 1e4 ? v += `M ${d} 10000 V ${h + 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}` : v += `M ${d} 10000 V ${h - 20} C ${d} ${h} ${d} ${h} ${d + 20} ${h} H ${P}`) : v += `M 10000 10000 H ${A} V ${h} H ${P}`, o === "r" ? u += D + c : u += D + n;
    }
  ...
  for (let x = 0; x < s.length; x++) {
    ...
    if (!(e && e !== s[x]) && P.childElementCount) {
      const h = ne("svg3rd"), H = ne("svg3rd");
      P.querySelectorAll(".svg3rd").forEach((X) => {
        X.remove();
      }), P.appendChild(h);
      const D = P.children[0];
      let A;
      ((z = (g = P.children) == null ? void 0 : g[2]) == null ? void 0 : z.tagName) === "SMYCHILDREN" ? A = [...P.children[1].children, ...P.children[2].children] : A = P.children[1].children, Y = "", ce = "", Ce(A, D, this.nodeData.children[x], !0), h.appendChild(et(Y)), ce.length > 0 && (P.appendChild(H), H.appendChild(_e(ce)));
    }
  }
...
function Ce(e, t, n, i) {
  ...
  for (let f = 0; f < e.length; f++) {
    ...
    if ((v == null ? void 0 : v.tagName) === "SMY") {
      ...
      let O = !0;
      for (let I = 0; I < f; I++) {
        const Ve = e[I].children[0].children[0].getAttribute("data-nodeid").slice(2);
        b[Ve] && (O && (O = !1, d = e[I]), y = e[I]);
      }
      const k = d.offsetLeft + d.offsetWidth + 8, ee = d.offsetTop + 15, te = y.offsetTop + y.offsetHeight - 5, W = y.offsetLeft + y.offsetWidth + 8, ae = v.offsetTop + v.children[0].offsetTop + v.children[0].offsetHeight;
    ...
    D === "lhs" && (v == null ? void 0 : v.tagName) !== "SMY" ? (P = r + 15, H = r, h = r - w.offsetWidth, m + g < s + c / 2 + 50 && m + g > s + c / 2 - 50 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : m + g >= s + c / 2 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : Y += `M ${P} ${z} H ${H} V ${x} H ${h}`) : D === "rhs" && (v == null ? void 0 : v.tagName) !== "SMY" && (P = r + o - 15, H = r + o, h = r + o + w.offsetWidth, l && (P += 15), m + g < s + c / 2 + 50 && m + g > s + c / 2 - 50 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : m + g >= s + c / 2 ? Y += `M ${P} ${z} H ${H} V ${x} H ${h}` : Y += `M ${P} ${z} H ${H} V ${x} H ${h}`);
    ...
    if (A) {
      ...
      continue;
    let X;
    ((p = (a = v.children) == null ? void 0 : a[2]) == null ? void 0 : p.tagName) === "SMYCHILDREN" ? X = [...v.children[1].children, ...v.children[2].children] : X = [...v.children[1].children], X.length > 0 && Ce(X, w, n.children[f]);
  }
}
function gn(e) {
...
function Hn(e, t) {
  const n = (P) => {
    ...
    return D.id = P, D.innerHTML = `<span>${ue(h)}</span><span>${ue(H)}</span>`, D;
...
function bn(e, t) {
  ...
  t.innerHTML = `${He(n, 0)}`, t.querySelectorAll(".sidebar-title").forEach((i) => {
    i.onclick = () => {
      ...
      o == null || o.classList.remove("active"), s ? (i.parentElement.querySelector("ul").classList.add("hidden"), s.classList.replace("down", "right")) : r && (i.parentElement.querySelector("ul").classList.remove("hidden"), r.classList.replace("right", "down")), i.classList.add("active"), Oe.call(e, i.id.replace("sidebar", ""));
    };
  });
}
function zn(e) {
...
function mn(e) {
  var p;
  const t = document.createElement("toolbar"), n = S("fullscreen", "full"), i = S("toCenter", "living"), s = S("zoomout", "move"), r = S("zoomin", "add"), o = document.createElement("input");
  o.className = "numberSelection", o.type = "number", o.min = "2", o.max = "100", o.step = "1", o.value = ((p = e == null ? void 0 : e.expandDeep) == null ? void 0 : p.toString()) || "2", o.oninput = Dn(() => {
    const f = e.getAllDataWithAutoHide();
    ge(f == null ? void 0 : f.nodeData), e.layout(), e.linkDiv();
  }, 300);
...
function xn(e) {
  const t = document.createElement("toolbar"), n = S("sidebar", "menu"), i = S("tbltl", "left"), s = S("tbltr", "right"), r = S("tblts", "side");
  t.appendChild(n), t.appendChild(i), t.appendChild(s), t.appendChild(r), t.className = "lt", n.onclick = () => {
    ...
    bn(e, u), u.classList.contains("selected") ? u.removeAttribute("class") : u.setAttribute("class", "selected");
  }, i.onclick = () => {
    e.initLeft();
  }, s.onclick = () => {
    e.initRight();
...
function ai(e) {
  ...
  f.className = "list", Object.keys(p).forEach((d) => {
    ...
    for (let b = 1; b <= p[d]; b++) {
      ...
      k.className = "item", O.style.width = "100%", O.style.height = "100%", O.src = new URL((/* @__PURE__ */ Object.assign({ "../iconfont/icon/flag/flag1.webp": On, "../iconfont/icon/flag/flag2.webp": Nn, "../iconfont/icon/flag/flag3.webp": jn, "../iconfont/icon/flag/flag4.webp": Bn, "../iconfont/icon/number/number1.webp": Tn, "../iconfont/icon/number/number2.webp": Mn, "../iconfont/icon/number/number3.webp": kn, "../iconfont/icon/number/number4.webp": Cn, "../iconfont/icon/number/number5.webp": Zn, "../iconfont/icon/number/number6.webp": Vn, "../iconfont/icon/number/number7.webp": En, "../iconfont/icon/number/number8.webp": qn, "../iconfont/icon/other/other1.webp": Fn, "../iconfont/icon/other/other10.webp": Rn, "../iconfont/icon/other/other11.webp": Sn, "../iconfont/icon/other/other12.webp": Wn, "../iconfont/icon/other/other13.webp": Yn, "../iconfont/icon/other/other14.webp": Gn, "../iconfont/icon/other/other15.webp": In, "../iconfont/icon/other/other16.webp": Jn, "../iconfont/icon/other/other17.webp": Kn, "../iconfont/icon/other/other2.webp": Un, "../iconfont/icon/other/other3.webp": Qn, "../iconfont/icon/other/other4.webp": $n, "../iconfont/icon/other/other5.webp": _n, "../iconfont/icon/other/other6.webp": ei, "../iconfont/icon/other/other7.webp": ti, "../iconfont/icon/other/other8.webp": ni, "../iconfont/icon/other/other9.webp": ii, "../iconfont/icon/portrait/portrait1.webp": si, "../iconfont/icon/portrait/portrait2.webp": ri, "../iconfont/icon/star/star1.webp": oi, "../iconfont/icon/star/star2.webp": ci, "../iconfont/icon/star/star3.webp": li }))[`../iconfont/icon/${d}/${d + b}.webp`], self.location).href, k.appendChild(O), y.appendChild(k), f.appendChild(k.cloneNode(!0));
    }
  ...
  function v(d) {
    d.ondblclick = (y) => {
      const b = document.createElement("textarea"), O = d.children[0], k = e.container.offsetHeight - d.offsetTop - 60, ee = 30, te = (W) => W < ee ? ee : W > k ? k : W;
      b.value = O.value, b.style.position = "absolute", b.style.left = O.offsetLeft + "px", b.style.top = O.offsetTop - 10 + "px", b.style.height = te(O.scrollHeight) + "px", b.style.width = O.offsetWidth + "px", b.oninput = (W) => {
        let ae = W.target.scrollHeight;
        b.style.height = te(ae) + "px";
      }, b.onblur = (W) => {
...
const he = document, fi = function(e, t) {
  if (!t)
    return pe(e), e;
...
function ui(e) {
  ...
  e.map.addEventListener("dragstart", function(r) {
    t = r.target, t.parentNode.parentNode.style.opacity = "0.5", J.clear();
...
function G({
  ...
  !X || (this.mindElixirBox = X, this.before = p || {}, this.nodeData = t.nodeData, this.linkData = t.linkData || {}, this.expandDeep = t == null ? void 0 : t.expandDeep, this.locale = i, this.contextMenuOption = c, this.contextMenu = o === void 0 ? !0 : o, this.toolBar = l === void 0 ? !0 : l, this.nodeMenu = u === void 0 ? !0 : u, this.keypress = a === void 0 ? !0 : a, this.closeButton = P === void 0 ? !1 : P, this.widthControll = h === void 0 ? !0 : h, this.mobileMenu = x, this.direction = t.direction !== void 0 ? t.direction : typeof n == "number" ? n : 1, this.draggable = s === void 0 ? !0 : s, this.newTopicName = f, this.editable = r === void 0 ? !0 : r, this.allowUndo = v === void 0 ? !0 : v, this.currentNode = null, this.currentLink = null, this.inputDiv = null, this.scaleVal = 1, this.tempDirection = null, this.primaryLinkStyle = w || 0, this.overflowHidden = m, this.primaryNodeHorizontalGap = g, this.primaryNodeVerticalGap = z, this.uploadButton = H === void 0 ? !0 : H, this.nodeDraggable = D === void 0 ? !0 : D, this.scrollContainer = A, this.bus = new Ze(), this.bus.addListener("operation", (d) => {
    ...
    !d || (this.isUndo = !0, d.name === "moveNode" ? this.moveNode(
      U(d.obj.fromObj.id),
      U(d.obj.originParentId)
    ) : d.name === "removeNode" ? d.originSiblingId ? this.insertBefore(U(d.originSiblingId), d.obj) : this.addChild(U(d.originParentId), d.obj) : d.name === "addChild" || d.name === "copyNode" ? this.removeNode(U(d.obj.id)) : d.name === "finishEdit" ? this.setNodeTopic(U(d.obj.id), d.origin) : this.isUndo = !1);
  });
}
function B(e) {
...
G.prototype = {
  ...
  exportSvgDom: pt,
  init: function(e, t) {
    e && (this.nodeData = e), t && (this.expandDeep = t), q(this.nodeData), console.log("ME_version " + G.version), console.log(this), this.mindElixirBox.className.indexOf("mind-elixir") === -1 && (this.mindElixirBox.className += "mind-elixir"), this.mindElixirBox.innerHTML = "", this.container = Q.createElement("div"), this.container.className = "map-container", this.overflowHidden && (this.container.style.overflow = "hidden"), this.map = Q.createElement("div"), this.map.className = "map-canvas", this.map.setAttribute("tabindex", "0"), this.container.appendChild(this.map), this.mindElixirBox.appendChild(this.container), this.root = Q.createElement("root"), this.box = Q.createElement("children"), this.box.className = "mindbox", this.svg2nd = ne("svg2nd"), this.linkController = ne("linkcontroller"), this.P2 = Q.createElement("div"), this.P3 = Q.createElement("div"), this.P2.className = this.P3.className = "circle", this.line1 = ze(0, 0, 0, 0), this.line2 = ze(0, 0, 0, 0), this.linkController.appendChild(this.line1), this.linkController.appendChild(this.line2), this.linkSvgGroup = ne("topiclinks"), this.map.appendChild(this.root), this.map.appendChild(this.box), this.map.appendChild(this.svg2nd), this.map.appendChild(this.linkController), this.map.appendChild(this.linkSvgGroup), this.map.appendChild(this.P2), this.map.appendChild(this.P3), this.toolBar && Ln(this), this.nodeMenu && ai(this), this.keypress && vi(this), zn(this), Ee() && this.mobileMenu ? Pi(this) : this.contextMenu && Hn(this, this.contextMenuOption), this.draggable && ui(this), we(this.nodeData, 0, this.expandDeep || 2), this.layout(), this.linkDiv(), this.toTopLeft(), gn(this);
  }
};
G.LEFT = 0;
G.RIGHT = 1;
