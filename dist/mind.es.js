...
function linkDiv(primaryNode) {
  ...
  for (let i = 0; i < primaryNodeList.length; i++) {
    ...
    if (el.childElementCount) {
      ...
      let children;
      if (((_a = el.children[3]) == null ? void 0 : _a.tagName) === "SMY")
